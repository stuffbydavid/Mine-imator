...
namespace CppProject
{
	...
	RealType res_load_pack(ScopeAny self)
	{
		...
		switch (StringType(sStr(load_stage)).id)
		{
			case 1266: // unzip
			{
				debug({ /*"res_load_pack"*/ STR(2483), /*"unzip"*/ STR(1266) });
				...
				sStr(load_stage) = /*"modeltextures"*/ STR(1348);
			...
			{
				debug({ /*"res_load_pack"*/ STR(2483), /*"modeltextures"*/ STR(1348) });
			...
			case 2487: // blocktextures
			{
				...
				file_rename_lib(global::load_assets_dir + mc_textures_directory + /*"blocks"*/ STR(981), global::load_assets_dir + mc_textures_directory + /*"block"*/ STR(508));
