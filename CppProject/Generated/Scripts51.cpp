...
namespace CppProject
{
	...
	RealType res_load_pack(ScopeAny self)
	{
		...
		switch (StringType(sStr(load_stage)).id)
		{
			case 1265: // unzip
			{
				debug({ /*"res_load_pack"*/ STR(2481), /*"unzip"*/ STR(1265) });
			...
			{
				debug({ /*"res_load_pack"*/ STR(2481), /*"modeltextures"*/ STR(1347) });
			...
			case 2487: // itemtextures
			{
				...
				file_rename_lib(global::load_assets_dir + mc_textures_directory + /*"items"*/ STR(2489), global::load_assets_dir + mc_textures_directory + /*"item"*/ STR(506));
				res_load_pack_item_textures(self, /*"diffuse"*/ STR(606), /*""*/ STR(0));
				res_load_pack_item_textures(self, /*"material"*/ STR(611), /*"_s"*/ STR(2490));
				res_load_pack_item_textures(self, /*"normal"*/ STR(600), /*"_n"*/ STR(2491));
