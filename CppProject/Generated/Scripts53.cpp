...
namespace CppProject
{
		...
		surface_set_target(surf);
	{
		...
		log({ /*"Block textures"*/ STR(2574), type, /*"done"*/ STR(1725) });
	...
	void res_load_pack_block_textures(ScopeAny self)
	{
		...
		log({ /*"Block textures all"*/ STR(2593), /*"done"*/ STR(1725) });
	}
		...
		surface_set_target(surf);
	{
		...
		surface_free(surf);
		ds_list_destroy(texlist);
		log({ /*"Item textures"*/ STR(2594), type, /*"done"*/ STR(1725) });
	...
	void res_load_pack_model_textures(ScopeAny self)
	{
		...
		log({ /*"Model textures"*/ STR(2599), /*"done"*/ STR(1725) });
	...
	void res_load_pack_particle_textures(ScopeAny self)
	{
		...
		log({ /*"Particle textures"*/ STR(2606), /*"done"*/ STR(1725) });
