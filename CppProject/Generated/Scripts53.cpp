...
namespace CppProject
{
		...
		surface_set_target(surf);
	{
		...
		log({ /*"Block textures"*/ STR(2575), type, /*"done"*/ STR(1725) });
	...
	void res_load_pack_block_textures(ScopeAny self)
	{
		...
		log({ /*"Block textures all"*/ STR(2594), /*"done"*/ STR(1725) });
	}
		...
		surface_set_target(surf);
	{
		...
		surface_free(surf);
		ds_list_destroy(texlist);
		log({ /*"Item textures"*/ STR(2595), type, /*"done"*/ STR(1725) });
	...
	void res_load_pack_model_textures(ScopeAny self)
	{
		...
		log({ /*"Model textures"*/ STR(2600), /*"done"*/ STR(1725) });
	...
	void res_load_pack_particle_textures(ScopeAny self)
	{
		...
		log({ /*"Particle textures"*/ STR(2607), /*"done"*/ STR(1725) });
