...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3899) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3900) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3901))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3902) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3901))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3901))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3903))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3904))
		{
			sInt(mouse_cursor) = cr_size_ns;
