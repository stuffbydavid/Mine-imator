...
namespace CppProject
{
	...
	{
		return font_add_sprite_ext(ID_spr_font, /*" !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~£ƒªº¬«»±≥≤÷≈°√ⁿ²ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖÙÚÛÜÝàáâãäåæçìíîïñòóôõöùúûüýÿĀāĂăĄąĆćĈĉĊċČčĎďĐđĒēĔĕĖėĘęĚěĜĝĞğĠġĢģĤĥĦħĨĩĪīĬĭĮįİıĴĵĶķĹĺĻļĽľĿŀŁłŃńŅņŇňŊŋŌōŎŏŐőŒœŔŕŖŗŘřŚśŜŝŞşŠšŢţŤťŦŧŨũŪūŬŭŮůŰűŲųŴŵŶŷŸŹźŻżŽžǼǽǾǿȘșȚțΆΈΉΊΌΎΏΐΪΫάέήίΰϊϋόύώЀЁЃЇЌЍЎЙйѐёђѓїћќѝўџҐґẀẁẂẃẄẅỲỳèéêëŉЏỊịỌọỤụ№ﬄƠơƯưẮắẤấẾếốỚớỨứẰằẦầỀềồỜờỪừẢảẲẳẨẩẺẻổỞỂểỈỉỎỏỔởỦủỬửỶỷẠạẶặẬậẸẹỆệỘộỢợỰựỴỵỐẪẫỖỗữẴẵẼẽỄễỒỠỡỮỸỹҘҙҠҡҪҫǺǻḀḁǰȷḾḿ₧ӐӑӒӓӶӷҔҕӖӗҼҽҾҿӚӛӜӝӁӂӞӟӢӣӤӥӦӧӪӫӰӱӮӯӲӳӴӵӸӹӬӭѶѷӔӺԂԄԐӠԆҊӃҞҜӅԒԈӍӉӇҤԊҨҦҎԌҬԎҲӼӾҴҶӋҸҌӕӻԃԅԑӡԇҋӄҟҝӆԓԉӎӊӈҥԋҩҧҏԍҭԏҳӽӿҵҷӌҹҍὍ¡‰­·≠¿×ØÞһðøþΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩαβγδεζηθικλμνξοπρςστυφχψωЂЅІЈЉЊЋАБВГДЕЖЗИКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзиклмнопрстуфхцчшщъыьэюяєѕіјљњ–—‘’“”„…ҮүӨөĸß€ѢѣѴѵӀѲѳ⁰¹³⁴⁵⁶⁷⁸⁹™ҚқҒғҰұӘәҖҗҢңҺ¢¤¥©®µ¶¼½¾·‚†‡•′″‹›‼−∞ЄԀ¯ſ˙Ĳĳﬀﬁﬂﬃ�¦´¨§⅛⅜⅝⅞∑∂∫₣₤₫"*/ STR(1867), true, IntType(1));
	}
	...
	IntType new_res(ScopeAny self, VarType fn, VarType type)
	{
		...
		log({ /*"filename"*/ STR(1222), ObjType(obj_resource, res)->filename });
		return res;
	}
	...
	{
		return new_textbox(true, IntType(64), /*"0123456789"*/ STR(1008) + /*"+-/*^()"*/ STR(1894));
	}
