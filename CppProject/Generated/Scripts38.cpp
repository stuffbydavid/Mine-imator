...
namespace CppProject
{
		...
		for (IntType _it = 0, _it_max = listlen; _it < _it_max; _it++)
		{
			switch ((IntType)listtype)
			{
				...
				case e_nbt_TAG_LIST:
				{
					...
					{
						log({ /*"TAG_List error"*/ STR(1912), /*"Invalid tag"*/ STR(1911) });
	...
	IntType new_res(ScopeAny self, VarType fn, VarType type)
	{
		...
		if (res != null_)
		{
			if (question(text_get({ /*"questionreplace"*/ STR(1916) })))
				replaced = true;
			else
			{
				res = null_;
		...
		log({ /*"Add resource"*/ STR(1917), DsList(global::res_type_name_list).Value(type) });
		log({ /*"filename"*/ STR(1268), ObjType(obj_resource, res)->filename });
		return res;
	}
	...
	IntType new_shader(StringType name)
	{
		withOne (obj_shader, (new obj_shader)->id, noone)
		{
			...
			self->script = asset_get_index(name + /*"_set"*/ STR(1918));
			self->uniform_map = ds_string_map_create();
			self->sampler_map = ds_string_map_create();
			new_shader_sampler(self, /*"uTexture"*/ STR(1919));
			new_shader_uniform(self, /*"uBlendColor"*/ STR(1920));
			new_shader_uniform(self, /*"uTime"*/ STR(1921));
			new_shader_uniform(self, /*"uWindEnable"*/ STR(1922));
			new_shader_uniform(self, /*"uWindTerrain"*/ STR(1923));
			new_shader_uniform(self, /*"uWindSpeed"*/ STR(1924));
			new_shader_uniform(self, /*"uWindStrength"*/ STR(1925));
			new_shader_uniform(self, /*"uWindDirection"*/ STR(1926));
			new_shader_uniform(self, /*"uWindDirectionalSpeed"*/ STR(1927));
			new_shader_uniform(self, /*"uWindDirectionalStrength"*/ STR(1928));
			new_shader_uniform(self, /*"uFogShow"*/ STR(1929));
			new_shader_uniform(self, /*"uFogColor"*/ STR(1930));
			new_shader_uniform(self, /*"uFogDistance"*/ STR(1931));
			new_shader_uniform(self, /*"uFogSize"*/ STR(1932));
			new_shader_uniform(self, /*"uFogHeight"*/ STR(1933));
			new_shader_uniform(self, /*"uCameraPosition"*/ STR(1934));
			new_shader_uniform(self, /*"uTAAMatrix"*/ STR(1935));
			new_shader_uniform(self, /*"uSampleIndex"*/ STR(1936));
			new_shader_uniform(self, /*"uAlphaHash"*/ STR(1937));
	...
	IntType new_tab(StringType location, BoolType show, IntType header, IntType window)
	{
		...
		location = string_replace(location, /*"_top"*/ STR(1938), /*""*/ STR(0));
		location = string_replace(location, /*"_bottom"*/ STR(1939), /*"_secondary"*/ STR(1940));
		if (!ds_map_exists(global::_app->panel_map, location))
			location = /*"right"*/ STR(190);
	...
	{
		return new_textbox(true, IntType(64), /*".0123456789"*/ STR(1941) + /*"+-/*^()"*/ STR(1942));
	}
	
	IntType new_textbox_hex()
	{
		return new_textbox(true, IntType(6), /*"0123456789ABCDEFabcdef"*/ STR(1943));
	}
	
	IntType new_textbox_integer()
	{
		return new_textbox(true, IntType(64), /*"0123456789"*/ STR(1054) + /*"+-/*^()"*/ STR(1942));
	}
	
	IntType new_textbox_ndecimals()
	{
		return new_textbox(true, IntType(64), /*"-.0123456789"*/ STR(1944) + /*"+-/*^()"*/ STR(1942));
	}
	
	IntType new_textbox_ninteger()
	{
		return new_textbox(true, IntType(64), /*" - 0123456789"*/ STR(1945) + /*"+-/*^()"*/ STR(1942));
	}
	...
	IntType new_transition_texture_map(RealType w, RealType h, RealType padding, BoolType center)
	{
			...
			surface_set_target(surf);
		{
			...
			for (RealType d = IntType(0); d <= quality; d++)
			{
				...
				if (DsList(global::transition_list).Value(t) == /*"bezier"*/ STR(544))
				{
	...
	RealType object_save(ScopeAny self)
	{
		...
		if (fn == /*""*/ STR(0))
			return IntType(0);
		fn = filename_new_ext(fn, /*".miobject"*/ STR(722));
		log({ /*"Saving object"*/ STR(1946), fn });
		...
		project_save_done();
		log({ /*"Object saved"*/ STR(1947) });
		return 0.0;
	}
	
	void open_url(StringType url)
	{
		log({ /*"Open URL"*/ STR(1948), url });
		lib_open_url(url);
	}
	...
	void panel_area_draw(ScopeAny self)
	{
		...
		withAll (obj_panel, global::_app->id)
		{
			...
			self->size_real_ani = ceil((self->size_real - IntType(16)) + (IntType(16) * ease(/*"easeoutcirc"*/ STR(564), self->size_ani)));
			self->glow_ani += test_reduced_motion(IntType(1), 0.035 * global::delta);
			self->glow_ani = clamp(self->glow_ani, IntType(0), IntType(1));
			self->size_glow = (self->size - IntType(16)) + (IntType(16) * ease(/*"easeoutcirc"*/ STR(564), self->glow_ani));
			self->size_real = self->size * (self->tab_list_amount > IntType(0));
		}
		
		ObjType(obj_panel, DsMap(sInt(panel_map))[/*"left_secondary"*/ STR(185)])->size_real -= max({ IntType(0), ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"left"*/ STR(189)))->size_real + ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"left_secondary"*/ STR(185)))->size_real + ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"right_secondary"*/ STR(186)))->size_real + ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"right"*/ STR(190)))->size_real - sReal(panel_area_width) });
		ObjType(obj_panel, DsMap(sInt(panel_map))[/*"left"*/ STR(189)])->size_real -= max({ IntType(0), ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"left"*/ STR(189)))->size_real + ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"right"*/ STR(190)))->size_real + ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"right_secondary"*/ STR(186)))->size_real - sReal(panel_area_width) });
		ObjType(obj_panel, DsMap(sInt(panel_map))[/*"bottom"*/ STR(187)])->size_real -= max({ IntType(0), ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"top"*/ STR(188)))->size_real + ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"bottom"*/ STR(187)))->size_real - sReal(panel_area_height) });
		ObjType(obj_panel, DsMap(sInt(panel_map))[/*"left"*/ STR(189)])->size_real = min({ ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"left"*/ STR(189)))->size_real, sReal(panel_area_width) });
		ObjType(obj_panel, DsMap(sInt(panel_map))[/*"right"*/ STR(190)])->size_real = min({ ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"right"*/ STR(190)))->size_real, sReal(panel_area_width) });
		ObjType(obj_panel, DsMap(sInt(panel_map))[/*"top"*/ STR(188)])->size_real = min({ ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"top"*/ STR(188)))->size_real, sReal(panel_area_height) });
		ObjType(obj_panel, DsMap(sInt(panel_map))[/*"bottom"*/ STR(187)])->size_real = min({ ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"bottom"*/ STR(187)))->size_real, sReal(panel_area_height) });
		view_area_draw(self);
		panel_draw(self, DsMap(sInt(panel_map)).Value(/*"left_secondary"*/ STR(185)));
		panel_draw(self, DsMap(sInt(panel_map)).Value(/*"right_secondary"*/ STR(186)));
		panel_draw(self, DsMap(sInt(panel_map)).Value(/*"bottom"*/ STR(187)));
		panel_draw(self, DsMap(sInt(panel_map)).Value(/*"top"*/ STR(188)));
		panel_draw(self, DsMap(sInt(panel_map)).Value(/*"left"*/ STR(189)));
		panel_draw(self, DsMap(sInt(panel_map)).Value(/*"right"*/ STR(190)));
		if (sVar(window_busy) == /*"panelresize"*/ STR(1949))
		{
			if (sInt(panel_resize) == DsMap(sInt(panel_map)).Value(/*"left"*/ STR(189)) || sInt(panel_resize) == DsMap(sInt(panel_map)).Value(/*"left_secondary"*/ STR(185)))
			{
				...
				if (sInt(panel_resize) == DsMap(sInt(panel_map)).Value(/*"right"*/ STR(190)) || sInt(panel_resize) == DsMap(sInt(panel_map)).Value(/*"right_secondary"*/ STR(186)))
				{
					sInt(mouse_cursor) = cr_size_we;
					idVar(sInt(panel_resize), size) = max({ IntType(200), sReal(panel_resize_size) - (gmlGlobal::mouse_x - sInt(mouse_click_x)) });
				}
				else
					if (sInt(panel_resize) == DsMap(sInt(panel_map)).Value(/*"bottom"*/ STR(187)))
					{
						...
						if (sInt(panel_resize) == DsMap(sInt(panel_map)).Value(/*"top"*/ STR(188)))
						{
							sInt(mouse_cursor) = cr_size_ns;
		...
		if (sVar(window_busy) == /*"tabmove"*/ STR(1950))
		{
			...
			if (sInt(tab_move_mouseon_panel) == null_)
			{
				...
				if (!(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"left"*/ STR(189)))->size_real > 0) || !(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"left_secondary"*/ STR(185)))->size_real > 0) || !(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"right"*/ STR(190)))->size_real > 0) || !(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"right_secondary"*/ STR(186)))->size_real > 0))
					toph *= 0.33;
				else
					if (!(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"bottom"*/ STR(187)))->size_real > 0))
						toph *= 0.5;
				
				if (!(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"left"*/ STR(189)))->size_real > 0) || !(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"left_secondary"*/ STR(185)))->size_real > 0) || !(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"right"*/ STR(190)))->size_real > 0) || !(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"right_secondary"*/ STR(186)))->size_real > 0))
					bottomh *= 0.33;
				else
					if (!(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"top"*/ STR(188)))->size_real > 0))
						bottomh *= 0.5;
				
				if (!(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"right"*/ STR(190)))->size_real > 0) || !(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"right_secondary"*/ STR(186)))->size_real > 0))
					lefttopw *= 0.5;
				if (!(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"left_secondary"*/ STR(185)))->size_real > 0))
					lefttopw *= 0.5;
				if (!(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"right"*/ STR(190)))->size_real > 0) || !(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"right_secondary"*/ STR(186)))->size_real > 0))
					leftbottomw *= 0.5;
				if (!(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"left"*/ STR(189)))->size_real > 0) || !(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"left_secondary"*/ STR(185)))->size_real > 0))
					righttopw *= 0.5;
				if (!(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"right_secondary"*/ STR(186)))->size_real > 0))
					righttopw *= 0.5;
				if (gmlGlobal::mouse_y >= sReal(view_area_y) + sReal(view_area_height) - bottomh && !(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"bottom"*/ STR(187)))->size_real > 0))
					sInt(tab_move_mouseon_panel) = DsMap(sInt(panel_map)).Value(/*"bottom"*/ STR(187));
				else
					if (gmlGlobal::mouse_x <= sReal(view_area_x) + lefttopw && !(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"left"*/ STR(189)))->size_real > 0))
						sInt(tab_move_mouseon_panel) = DsMap(sInt(panel_map)).Value(/*"left"*/ STR(189));
					else
						if (gmlGlobal::mouse_x <= sReal(view_area_x) + leftbottomw && !(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"left_secondary"*/ STR(185)))->size_real > 0))
							sInt(tab_move_mouseon_panel) = DsMap(sInt(panel_map)).Value(/*"left_secondary"*/ STR(185));
						else
							if (gmlGlobal::mouse_x >= sReal(view_area_x) + sReal(view_area_width) - righttopw && !(ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"right"*/ STR(190)))->size_real > 0))
								sInt(tab_move_mouseon_panel) = DsMap(sInt(panel_map)).Value(/*"right"*/ STR(190));
							else
								sInt(tab_move_mouseon_panel) = DsMap(sInt(panel_map)).Value(/*"right_secondary"*/ STR(186));
	...
	RealType panel_draw(ScopeAny self, IntType panel)
	{
		...
		if (ObjType(obj_panel, panel)->size_real < IntType(1) && !(ObjType(obj_panel, panel)->glow > 0) && panel != sInt(panel_window_obj))
			return IntType(0);
		if (panel == DsMap(sInt(panel_map)).Value(/*"bottom"*/ STR(187)))
		{
			boxx = sReal(panel_area_x) + ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"left"*/ STR(189)))->size_real_ani;
			boxy = sReal(panel_area_y) + sReal(panel_area_height) - ObjType(obj_panel, panel)->size_real_ani;
			boxw = sReal(panel_area_width) - ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"left"*/ STR(189)))->size_real_ani - ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"right"*/ STR(190)))->size_real_ani;
			...
			if (panel == DsMap(sInt(panel_map)).Value(/*"top"*/ STR(188)))
			{
				boxx = sReal(panel_area_x) + ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"left"*/ STR(189)))->size_real_ani;
				...
				if (panel == DsMap(sInt(panel_map)).Value(/*"left"*/ STR(189)))
				{
					boxx = sReal(panel_area_x);
					boxy = sReal(panel_area_y) + ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"top"*/ STR(188)))->size_real_ani;
					boxw = ObjType(obj_panel, panel)->size_real_ani;
					boxh = sReal(panel_area_height) - ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"top"*/ STR(188)))->size_real_ani;
					...
					if (panel == DsMap(sInt(panel_map)).Value(/*"left_secondary"*/ STR(185)))
					{
						boxx = sReal(panel_area_x) + ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"left"*/ STR(189)))->size_real_ani;
						boxy = sReal(panel_area_y) + ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"top"*/ STR(188)))->size_real_ani;
						boxw = ObjType(obj_panel, panel)->size_real_ani;
						boxh = sReal(panel_area_height) - ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"top"*/ STR(188)))->size_real_ani - ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"bottom"*/ STR(187)))->size_real_ani;
						sInt(content_direction) = e_scroll_VERTICAL;
						if (ObjType(obj_panel, panel)->glow > 0)
							draw_box(boxx, boxy, ObjType(obj_panel, panel)->size_glow, boxh, false, global::c_accent, glow_alpha);
					}
					else
						if (panel == DsMap(sInt(panel_map)).Value(/*"right"*/ STR(190)))
						{
							...
							if (panel == DsMap(sInt(panel_map)).Value(/*"right_secondary"*/ STR(186)))
							{
								boxx = sReal(panel_area_x) + sReal(panel_area_width) - ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"right"*/ STR(190)))->size_real_ani - ObjType(obj_panel, panel)->size_real_ani;
								boxy = sReal(panel_area_y) + ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"top"*/ STR(188)))->size_real_ani;
								boxw = ObjType(obj_panel, panel)->size_real_ani;
								boxh = sReal(panel_area_height) - ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"top"*/ STR(188)))->size_real_ani - ObjType(obj_panel, DsMap(sInt(panel_map)).Value(/*"bottom"*/ STR(187)))->size_real_ani;
								sInt(content_direction) = e_scroll_VERTICAL;
		...
		if (idBool(sVar(content_tab), movable))
		{
			...
			for (IntType t = IntType(0); t < ObjType(obj_panel, panel)->tab_list_amount; t++)
			{
				...
				if (idBool(tab, closeable) && (hover > 0 || sel > 0))
				{
					...
					if (draw_button_icon(self, { /*"tabclose"*/ STR(1951) + string(tab), floor(dx + dw - IntType(20)), dy + IntType(4), IntType(16), IntType(16), false, icons_CLOSE_SMALL }))
					{
						tab_close(self, tab);
						return IntType(0);
					}
				...
				if (sVar(window_busy) == /*"tabmove"*/ STR(1950))
				{
					...
					sVar(window_busy) = /*"tabmove"*/ STR(1950);
				}
				if (idVar(tab, glow) > IntType(0))
					draw_box(dx, dy, dw, dh, false, global::c_accent, idVar(tab, glow) * glow_alpha);
				dx += tabw.Value(t);
			}
			if (panel == DsMap(sInt(panel_map)).Value(/*"right"*/ STR(190)) || panel == DsMap(sInt(panel_map)).Value(/*"right_secondary"*/ STR(186)))
		...
		resizemouseon = false;
		if (panel == DsMap(sInt(panel_map)).Value(/*"left"*/ STR(189)) || panel == DsMap(sInt(panel_map)).Value(/*"left_secondary"*/ STR(185)))
		{
		...
		{
			sVar(window_busy) = /*"panelresize"*/ STR(1949);
		...
		{
			sVar(window_busy) = /*"tabclick"*/ STR(1952);
			sVar(tab_move) = sVar(content_tab);
		}
		if (sVar(window_busy) == /*"tabclick"*/ STR(1952))
		{
