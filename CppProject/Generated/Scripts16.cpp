...
namespace CppProject
{
	...
	void app_startup_interface_tabs()
	{
		...
		{
			self->project = tab_add_category(self, /*"project"*/ STR(204), icons_CLAPPERBOARD_SMALL, ID_tab_properties_project, false);
			...
			withOne (obj_category, self->render, self->id)
			{
				...
				ObjType(obj_textbox, self->tbx_ssao_power)->suffix = /*"%"*/ STR(205);
				...
				ObjType(obj_textbox, self->tbx_subsurface_highlight)->suffix = /*"%"*/ STR(205);
				self->tbx_subsurface_highlight_strength = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_subsurface_highlight_strength)->suffix = /*"%"*/ STR(205);
				self->tbx_indirect_precision = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_indirect_precision)->suffix = /*"%"*/ STR(205);
				self->tbx_indirect_blur_radius = new_textbox_decimals();
				ObjType(obj_textbox, self->tbx_indirect_blur_radius)->suffix = /*"%"*/ STR(205);
				self->tbx_indirect_strength = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_indirect_strength)->suffix = /*"%"*/ STR(205);
				self->tbx_reflections_precision = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_reflections_precision)->suffix = /*"%"*/ STR(205);
				self->tbx_reflections_thickness = new_textbox_decimals();
				self->tbx_reflections_fade_amount = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_reflections_fade_amount)->suffix = /*"%"*/ STR(205);
				self->tbx_glow_radius = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_glow_radius)->suffix = /*"%"*/ STR(205);
				self->tbx_glow_intensity = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_glow_intensity)->suffix = /*"%"*/ STR(205);
				self->tbx_glow_falloff_radius = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_glow_falloff_radius)->suffix = /*"%"*/ STR(205);
				self->tbx_glow_falloff_intensity = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_glow_falloff_intensity)->suffix = /*"%"*/ STR(205);
				self->tbx_aa_power = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_aa_power)->suffix = /*"%"*/ STR(205);
				self->tbx_block_emissive = new_textbox_decimals();
				ObjType(obj_textbox, self->tbx_block_emissive)->suffix = /*"%"*/ STR(205);
			...
			self->library = tab_add_category(self, /*"library"*/ STR(206), icons_LIBRARY_SMALL, ID_tab_properties_library, false);
			withOne (obj_category, self->library, self->id)
			{
				...
				sortlist_column_add(self->list, /*"libname"*/ STR(207), IntType(0));
				sortlist_column_add(self->list, /*"libtype"*/ STR(208), 0.35);
				sortlist_column_add(self->list, /*"libinstances"*/ STR(209), 0.65);
			...
			self->background = tab_add_category(self, /*"background"*/ STR(210), icons_WORLD_SMALL, ID_tab_properties_background, false);
			withOne (obj_category, self->background, self->id)
			{
				self->tbx_background_rotation = new_textbox_decimals();
				ObjType(obj_textbox, self->tbx_background_rotation)->suffix = /*"°"*/ STR(211);
				self->tbx_sky_time = new_textbox(true, IntType(10), /*"-:0123456789"*/ STR(212));
				self->tbx_sky_rotation = new_textbox_ndecimals();
				ObjType(obj_textbox, self->tbx_sky_rotation)->suffix = /*"°"*/ STR(211);
				self->tbx_sky_sun_angle = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_sky_sun_angle)->suffix = /*"°"*/ STR(211);
				self->tbx_sky_sun_scale = new_textbox_decimals();
				self->tbx_sky_moon_angle = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_sky_moon_angle)->suffix = /*"°"*/ STR(211);
				self->tbx_sky_moon_scale = new_textbox_decimals();
				self->tbx_sunlight_strength = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_sunlight_strength)->suffix = /*"%"*/ STR(205);
				self->tbx_sunlight_angle = new_textbox_decimals();
				ObjType(obj_textbox, self->tbx_sunlight_angle)->suffix = /*"°"*/ STR(211);
				...
				ObjType(obj_textbox, self->tbx_sky_clouds_speed)->suffix = /*"%"*/ STR(205);
				...
				ObjType(obj_textbox, self->tbx_wind_speed)->suffix = /*"%"*/ STR(205);
				self->tbx_wind_strength = new_textbox_decimals();
				self->tbx_wind_direction = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_wind_direction)->suffix = /*"°"*/ STR(211);
				self->tbx_wind_directional_speed = new_textbox_decimals();
				ObjType(obj_textbox, self->tbx_wind_directional_speed)->suffix = /*"%"*/ STR(205);
				self->tbx_wind_directional_strength = new_textbox_decimals();
				self->tbx_texture_animation_speed = new_textbox_ndecimals();
			}
			
			self->resources = tab_add_category(self, /*"resources"*/ STR(213), icons_FILE_SMALL, ID_tab_properties_resources, false);
			withOne (obj_category, self->resources, self->id)
			{
				...
				sortlist_column_add(self->list, /*"resname"*/ STR(214), IntType(0));
				sortlist_column_add(self->list, /*"restype"*/ STR(215), 0.35);
				sortlist_column_add(self->list, /*"rescount"*/ STR(216), 0.65);
				...
				ObjType(obj_textbox, self->tbx_scenery_integrity)->suffix = /*"%"*/ STR(205);
			}
		...
		withOne (obj_tab, global::_app->template_editor, global::_app->id)
		{
			...
			sortlist_column_add(self->type_list, /*"particleeditortypename"*/ STR(217), IntType(0));
			sortlist_column_add(self->type_list, /*"particleeditortypekind"*/ STR(218), 0.4);
			sortlist_column_add(self->type_list, /*"particleeditortyperate"*/ STR(219), 0.75);
			...
			ObjType(obj_textbox, self->tbx_type_spawn_rate)->suffix = /*"%"*/ STR(205);
			...
			ObjType(obj_textbox, self->tbx_type_xangle)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_xangle_random)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_yangle)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_yangle_random)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_zangle)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_zangle_random)->suffix = /*"°"*/ STR(211);
			...
			ObjType(obj_textbox, self->tbx_type_xrot)->suffix = /*"°"*/ STR(211);
			self->tbx_type_xrot_random = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_xrot_random)->suffix = /*"°"*/ STR(211);
			self->tbx_type_yrot = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_yrot)->suffix = /*"°"*/ STR(211);
			self->tbx_type_yrot_random = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_yrot_random)->suffix = /*"°"*/ STR(211);
			self->tbx_type_zrot = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_zrot)->suffix = /*"°"*/ STR(211);
			self->tbx_type_zrot_random = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_zrot_random)->suffix = /*"°"*/ STR(211);
			...
			ObjType(obj_textbox, self->tbx_type_xrot_spd)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_xrot_spd_random)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_yrot_spd)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_yrot_spd_random)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_zrot_spd)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_zrot_spd_random)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_xrot_spd_add)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_xrot_spd_add_random)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_yrot_spd_add)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_yrot_spd_add_random)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_zrot_spd_add)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_zrot_spd_add_random)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_xrot_spd_mul)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_xrot_spd_mul_random)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_yrot_spd_mul)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_yrot_spd_mul_random)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_zrot_spd_mul)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_zrot_spd_mul_random)->suffix = /*"°"*/ STR(211);
			self->tbx_type_sprite_angle = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_sprite_angle)->suffix = /*"°"*/ STR(211);
			self->tbx_type_sprite_angle_random = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_sprite_angle_random)->suffix = /*"°"*/ STR(211);
			self->tbx_type_sprite_angle_add = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_sprite_angle_add)->suffix = /*"°"*/ STR(211);
			self->tbx_type_sprite_angle_add_random = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_sprite_angle_add_random)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_sprite_angle_add)->suffix = /*"°"*/ STR(211);
			ObjType(obj_textbox, self->tbx_type_sprite_angle_add_random)->suffix = /*"°"*/ STR(211);
			...
			ObjType(obj_textbox, self->tbx_type_alpha)->suffix = /*"%"*/ STR(205);
			self->tbx_type_alpha_random = new_textbox_integer();
			ObjType(obj_textbox, self->tbx_type_alpha_random)->suffix = /*"%"*/ STR(205);
			self->tbx_type_alpha_add = new_textbox_ninteger();
			ObjType(obj_textbox, self->tbx_type_alpha_add)->suffix = /*"%"*/ STR(205);
			self->tbx_type_alpha_add_random = new_textbox_ninteger();
			ObjType(obj_textbox, self->tbx_type_alpha_add_random)->suffix = /*"%"*/ STR(205);
		...
		{
			self->info = tab_add_category(self, /*"timelineeditorinfo"*/ STR(220), icons_LIST_BULLETED_SMALL, ID_tab_timeline_editor_info, true);
			...
			self->hierarchy = tab_add_category(self, /*"timelineeditorhierarchy"*/ STR(221), icons_HIERARCHY_SMALL, ID_tab_timeline_editor_hierarchy, true);
			self->appearance = tab_add_category(self, /*"timelineeditorappearance"*/ STR(222), ArrType::From({ icons_SPHERE_SHADING_SMALL, icons_SPHERE_SHADING_SMALL__DARK }), ID_tab_timeline_editor_appearance, false);
			withOne (obj_category, self->appearance, self->id)
				self->tbx_depth = new_textbox_ninteger();
			
			self->audio = tab_add_category(self, /*"timelineeditoraudio"*/ STR(223), icons_NOTE_SMALL, ID_tab_timeline_editor_audio, true);
			self->path = tab_add_category(self, /*"timelineeditorpath"*/ STR(224), icons_PATH_SMALL, ID_tab_timeline_editor_path, true);
		...
		{
			self->transform = tab_add_category(self, /*"frameeditortransform"*/ STR(225), icons_TRANSFORM_SMALL, ID_tab_frame_editor_transform, false);
			withOne (obj_category, self->transform, self->id)
			{
				...
				ObjType(obj_textbox, self->tbx_rot_x)->suffix = /*"°"*/ STR(211);
				self->tbx_rot_y = new_textbox_ndecimals();
				ObjType(obj_textbox, self->tbx_rot_y)->suffix = /*"°"*/ STR(211);
				self->tbx_rot_z = new_textbox_ndecimals();
				ObjType(obj_textbox, self->tbx_rot_z)->suffix = /*"°"*/ STR(211);
				...
				ObjType(obj_textbox, self->tbx_bend[IntType(0)])->suffix = /*"°"*/ STR(211);
				self->tbx_bend[IntType(1)] = new_textbox_ndecimals();
				ObjType(obj_textbox, self->tbx_bend[IntType(1)])->suffix = /*"°"*/ STR(211);
				self->tbx_bend[IntType(2)] = new_textbox_ndecimals();
				ObjType(obj_textbox, self->tbx_bend[IntType(2)])->suffix = /*"°"*/ STR(211);
				self->tbx_path_point_angle = new_textbox_ndecimals();
				ObjType(obj_textbox, self->tbx_path_point_angle)->suffix = /*"°"*/ STR(211);
				self->tbx_path_point_scale = new_textbox_decimals();
			}
			
			self->constraints = tab_add_category(self, /*"frameeditorconstraints"*/ STR(226), icons_JOINT_SMALL, ID_tab_frame_editor_constraints, false);
			withOne (obj_category, self->constraints, self->id)
			{
				...
				ObjType(obj_textbox, self->tbx_ik_blend)->suffix = /*"%"*/ STR(205);
				self->tbx_ik_angle_offset = new_textbox_ndecimals();
				ObjType(obj_textbox, self->tbx_ik_angle_offset)->suffix = /*"°"*/ STR(211);
			}
			
			self->material = tab_add_category(self, /*"frameeditormaterial"*/ STR(227), ArrType::From({ icons_SPHERE_MATERIAL_SMALL, icons_SPHERE_MATERIAL_SMALL__DARK }), ID_tab_frame_editor_material, false);
			withOne (obj_category, self->material, self->id)
			{
				self->tbx_alpha = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_alpha)->suffix = /*"%"*/ STR(205);
				self->tbx_mix_percent = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_mix_percent)->suffix = /*"%"*/ STR(205);
				self->tbx_emissive = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_emissive)->suffix = /*"%"*/ STR(205);
				self->tbx_metallic = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_metallic)->suffix = /*"%"*/ STR(205);
				self->tbx_roughness = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_roughness)->suffix = /*"%"*/ STR(205);
				self->tbx_subsurface = new_textbox_decimals();
				self->tbx_subsurface_radius.Real(X_) = new_textbox_integer();
				idVar(self->tbx_subsurface_radius.Real(X_), suffix) = /*"%"*/ STR(205);
				self->tbx_subsurface_radius.Real(Y_) = new_textbox_integer();
				idVar(self->tbx_subsurface_radius.Real(Y_), suffix) = /*"%"*/ STR(205);
				self->tbx_subsurface_radius.Real(Z_) = new_textbox_integer();
				idVar(self->tbx_subsurface_radius.Real(Z_), suffix) = /*"%"*/ STR(205);
				self->tbx_wind_influence = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_wind_influence)->suffix = /*"%"*/ STR(205);
			}
			
			self->particles = tab_add_category(self, /*"frameeditorparticles"*/ STR(228), icons_PARTICLES_SMALL, ID_tab_frame_editor_particles, false);
			...
			self->light = tab_add_category(self, /*"frameeditorlight"*/ STR(229), icons_LIGHT_POINT_SMALL, ID_tab_frame_editor_light, false);
			withOne (obj_category, self->light, self->id)
			{
				...
				ObjType(obj_textbox, self->tbx_strength)->suffix = /*"%"*/ STR(205);
				self->tbx_specular_strength = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_specular_strength)->suffix = /*"%"*/ STR(205);
				self->tbx_fade_size = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_fade_size)->suffix = /*"%"*/ STR(205);
				self->tbx_spot_radius = new_textbox_decimals();
				self->tbx_spot_sharpness = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_spot_sharpness)->suffix = /*"%"*/ STR(205);
			}
			
			self->camera = tab_add_category(self, /*"frameeditorcamera"*/ STR(230), icons_CAMERA_SMALL, ID_tab_frame_editor_camera, false);
			withOne (Object, self->camera, self->id)
			{
				sVar(video_template) = null_;
				sBool(look_at_rotate) = true;
				sInt(tbx_fov) = new_textbox_decimals();
				ObjType(obj_textbox, sInt(tbx_fov))->suffix = /*"°"*/ STR(211);
				...
				ObjType(obj_textbox, sInt(tbx_blade_angle))->suffix = /*"°"*/ STR(211);
				sInt(tbx_rotate_distance) = new_textbox_decimals();
				sInt(tbx_rotate_angle_xy) = new_textbox_ndecimals();
				ObjType(obj_textbox, sInt(tbx_rotate_angle_xy))->suffix = /*"°"*/ STR(211);
				sInt(tbx_rotate_angle_z) = new_textbox_ndecimals();
				ObjType(obj_textbox, sInt(tbx_rotate_angle_z))->suffix = /*"°"*/ STR(211);
				sInt(tbx_shake_strength_x) = new_textbox_decimals();
				ObjType(obj_textbox, sInt(tbx_shake_strength_x))->suffix = /*"%"*/ STR(205);
				sInt(tbx_shake_strength_y) = new_textbox_decimals();
				ObjType(obj_textbox, sInt(tbx_shake_strength_y))->suffix = /*"%"*/ STR(205);
				sInt(tbx_shake_strength_z) = new_textbox_decimals();
				ObjType(obj_textbox, sInt(tbx_shake_strength_z))->suffix = /*"%"*/ STR(205);
				sInt(tbx_shake_speed_x) = new_textbox_decimals();
				ObjType(obj_textbox, sInt(tbx_shake_speed_x))->suffix = /*"%"*/ STR(205);
				sInt(tbx_shake_speed_y) = new_textbox_decimals();
				ObjType(obj_textbox, sInt(tbx_shake_speed_y))->suffix = /*"%"*/ STR(205);
				sInt(tbx_shake_speed_z) = new_textbox_decimals();
				ObjType(obj_textbox, sInt(tbx_shake_speed_z))->suffix = /*"%"*/ STR(205);
				...
				ObjType(obj_textbox, sInt(tbx_dof_blur_size))->suffix = /*"%"*/ STR(205);
				sInt(tbx_dof_blur_ratio) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_dof_blur_ratio))->suffix = /*"%"*/ STR(205);
				sInt(tbx_dof_bias) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_dof_bias))->suffix = /*"%"*/ STR(205);
				sInt(tbx_dof_threshold) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_dof_threshold))->suffix = /*"%"*/ STR(205);
				sInt(tbx_dof_gain) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_dof_gain))->suffix = /*"%"*/ STR(205);
				sInt(tbx_dof_fringe_angle_red) = new_textbox_ndecimals();
				ObjType(obj_textbox, sInt(tbx_dof_fringe_angle_red))->suffix = /*"°"*/ STR(211);
				sInt(tbx_dof_fringe_angle_green) = new_textbox_ndecimals();
				ObjType(obj_textbox, sInt(tbx_dof_fringe_angle_green))->suffix = /*"°"*/ STR(211);
				sInt(tbx_dof_fringe_angle_blue) = new_textbox_ndecimals();
				ObjType(obj_textbox, sInt(tbx_dof_fringe_angle_blue))->suffix = /*"°"*/ STR(211);
				sInt(tbx_dof_fringe_red) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_dof_fringe_red))->suffix = /*"%"*/ STR(205);
				sInt(tbx_dof_fringe_green) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_dof_fringe_green))->suffix = /*"%"*/ STR(205);
				sInt(tbx_dof_fringe_blue) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_dof_fringe_blue))->suffix = /*"%"*/ STR(205);
				...
				ObjType(obj_textbox, sInt(tbx_bloom_threshold))->suffix = /*"%"*/ STR(205);
				sInt(tbx_bloom_intensity) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_bloom_intensity))->suffix = /*"%"*/ STR(205);
				sInt(tbx_bloom_radius) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_bloom_radius))->suffix = /*"%"*/ STR(205);
				sInt(tbx_bloom_ratio) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_bloom_ratio))->suffix = /*"%"*/ STR(205);
				sInt(tbx_lens_dirt_radius) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_lens_dirt_radius))->suffix = /*"%"*/ STR(205);
				sInt(tbx_lens_dirt_intensity) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_lens_dirt_intensity))->suffix = /*"%"*/ STR(205);
				sInt(tbx_lens_dirt_power) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_lens_dirt_power))->suffix = /*"%"*/ STR(205);
				sInt(tbx_contrast) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_contrast))->suffix = /*"%"*/ STR(205);
				sInt(tbx_brightness) = new_textbox_ninteger();
				ObjType(obj_textbox, sInt(tbx_brightness))->suffix = /*"%"*/ STR(205);
				sInt(tbx_saturation) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_saturation))->suffix = /*"%"*/ STR(205);
				sInt(tbx_vibrance) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_vibrance))->suffix = /*"%"*/ STR(205);
				sInt(tbx_grain_strength) = new_textbox_ninteger();
				ObjType(obj_textbox, sInt(tbx_grain_strength))->suffix = /*"%"*/ STR(205);
				sInt(tbx_grain_saturation) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_grain_saturation))->suffix = /*"%"*/ STR(205);
				sInt(tbx_grain_size) = new_textbox_integer();
				sInt(tbx_vignette_radius) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_vignette_radius))->suffix = /*"%"*/ STR(205);
				sInt(tbx_vignette_softness) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_vignette_softness))->suffix = /*"%"*/ STR(205);
				sInt(tbx_vignette_strength) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_vignette_strength))->suffix = /*"%"*/ STR(205);
				sInt(tbx_ca_blur_amount) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_ca_blur_amount))->suffix = /*"%"*/ STR(205);
				sInt(tbx_ca_red_offset) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_ca_red_offset))->suffix = /*"%"*/ STR(205);
				sInt(tbx_ca_green_offset) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_ca_green_offset))->suffix = /*"%"*/ STR(205);
				sInt(tbx_ca_blue_offset) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_ca_blue_offset))->suffix = /*"%"*/ STR(205);
				sInt(tbx_distort_zoom_amount) = new_textbox_decimals();
				ObjType(obj_textbox, sInt(tbx_distort_zoom_amount))->suffix = /*"%"*/ STR(205);
				sInt(tbx_distort_amount) = new_textbox_ninteger();
				ObjType(obj_textbox, sInt(tbx_distort_amount))->suffix = /*"%"*/ STR(205);
			}
			
			self->sound = tab_add_category(self, /*"frameeditorsound"*/ STR(231), icons_VOLUME_SMALL, ID_tab_frame_editor_sound, true);
			withOne (obj_category, self->sound, self->id)
			{
				self->tbx_volume = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_volume)->suffix = /*"%"*/ STR(205);
				self->tbx_pitch = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_pitch)->suffix = /*"%"*/ STR(205);
				self->tbx_start = new_textbox_decimals();
				self->tbx_end = new_textbox_ndecimals();
			}
			
			self->text = tab_add_category(self, /*"frameeditortext"*/ STR(232), icons_TEXT_SMALL, ID_tab_frame_editor_text, false);
			withOne (Object, self->text, self->id)
				sInt(tbx_text) = new_textbox(false, IntType(0), /*""*/ STR(0));
			
			self->item = tab_add_category(self, /*"frameeditoritem"*/ STR(233), icons_ITEM_SMALL, ID_tab_frame_editor_item, false);
			...
			self->keyframe = tab_add_category(self, /*"frameeditorkeyframe"*/ STR(234), icons_KEYFRAME_SMALL, ID_tab_frame_editor_keyframe, false);
			withOne (obj_category, self->keyframe, self->id)
			{
				self->tbx_ease_in_x = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_ease_in_x)->suffix = /*"%"*/ STR(205);
				self->tbx_ease_in_y = new_textbox_ninteger();
				ObjType(obj_textbox, self->tbx_ease_in_y)->suffix = /*"%"*/ STR(205);
				self->tbx_ease_out_x = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_ease_out_x)->suffix = /*"%"*/ STR(205);
				self->tbx_ease_out_y = new_textbox_ninteger();
				ObjType(obj_textbox, self->tbx_ease_out_y)->suffix = /*"%"*/ STR(205);
		...
		{
			self->program = tab_add_category(self, /*"settingsprogram"*/ STR(235), icons_SETTINGS_SMALL, ID_tab_settings_program, false);
			withOne (obj_category, self->program, self->id)
			{
				...
				ObjType(obj_textbox, self->tbx_watermark_padding)->suffix = /*"%"*/ STR(205);
				self->tbx_watermark_scale = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_watermark_scale)->suffix = /*"%"*/ STR(205);
				self->tbx_watermark_opacity = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_watermark_opacity)->suffix = /*"%"*/ STR(205);
			}
			
			self->interface_ = tab_add_category(self, /*"settingsinterface"*/ STR(236), icons_BRUSH_SMALL, ID_tab_settings_interface, false);
			self->controls = tab_add_category(self, /*"settingscontrols"*/ STR(237), icons_KEYBOARD_SMALL, ID_tab_settings_controls, false);
