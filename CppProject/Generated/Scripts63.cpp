...
namespace CppProject
{
	void tab_timeline_editor_appearance(ScopeAny self)
	{
		if (idVar(global::tl_edit, type) != e_tl_type_POINT_LIGHT && idVar(global::tl_edit, type) != e_tl_type_SPOT_LIGHT)
		{
			...
			draw_button_collapse(self, /*"tl_glint"*/ STR(167), DsMap(global::collapse_map).Value(/*"tl_glint"*/ STR(167)), null_, true, /*"timelineeditorglint"*/ STR(3729));
			tab_next(self);
	...
	RealType tab_timeline_editor_hierarchy(ScopeAny self)
	{
		...
		if (idVar(global::tl_edit, part_of) == null_)
		{
			...
			{
				ArrType partname = ArrType::From({ /*"right"*/ STR(198), /*"left"*/ STR(197), /*"front"*/ STR(860), /*"back"*/ STR(862), /*"upper"*/ STR(894), /*"lower"*/ STR(1835) });
				tab_control_switch(self);
		...
		{
			sVar(dy) += IntType(20);
			draw_label(self, { text_get({ /*"timelineeditorinherit"*/ STR(3754) }) + /*":"*/ STR(760), sVar(dx), sVar(dy), fa_left, fa_bottom, global::c_text_tertiary, global::a_text_tertiary, sInt(font_label) });
			sVar(dy) += IntType(8);
			tab_set_collumns(self, { true, floor((RealType)sVar(content_width) / 150.0) });
			tab_control_checkbox(self);
	...
	void tab_timeline_editor_info(ScopeAny self)
	{
		...
		draw_textfield(self, /*"timelineeditorname"*/ STR(3773), sVar(dx), sVar(dy), sVar(dw), IntType(24), ObjType(obj_category, idInt(sVar(tab), info))->tbx_name, ID_action_tl_name, string_remove_newline(idVar(global::tl_edit, display_name)), /*"top"*/ STR(196));
		tab_next(self);
		if (idVar(global::tl_edit, type) == e_temp_type_TEXT)
		{
			...
			draw_textfield(self, /*"timelineeditortext"*/ STR(3185), sVar(dx), sVar(dy), sVar(dw), IntType(76), ObjType(obj_category, idInt(sVar(tab), info))->tbx_text, ID_action_tl_text, /*""*/ STR(0), /*"top"*/ STR(196));
			tab_next(self);
		}
	...
	void tab_timeline_editor_path(ScopeAny self)
	{
		...
		tab_next(self);
		tab_control_switch(self);
		draw_button_collapse(self, /*"path_shape"*/ STR(148), DsMap(global::collapse_map).Value(/*"path_shape"*/ STR(148)), ID_action_tl_path_shape_generate, idVar(global::tl_edit, path_shape_generate), /*"timelineeditorpathshape"*/ STR(3785));
		tab_next(self);
		if (DsMap(global::collapse_map).Value(/*"path_shape"*/ STR(148)) > 0 && idVar(global::tl_edit, path_shape_generate) > 0)
		{
			...
			tab_next(self);
			tab_control_switch(self);
			draw_button_collapse(self, /*"path_shape_tube"*/ STR(149), DsMap(global::collapse_map).Value(/*"path_shape_tube"*/ STR(149)), ID_action_tl_path_shape_tube, idVar(global::tl_edit, path_shape_tube), /*"timelineeditorpathshapetube"*/ STR(3792));
			tab_next(self);
	...
	void temp_event_create(ScopeAny self)
	{
		...
		array_add(VarType::CreateRef(sArr(armor_array)), ArrType::From({ /*"none"*/ STR(880), minecraft_get_color(/*"other:leather"*/ STR(1996)), /*"none"*/ STR(880), DsList(global::minecraft_armor_trim_material_list).Value(IntType(0)) }));
		array_add(VarType::CreateRef(sArr(armor_array)), ArrType::From({ /*"none"*/ STR(880), minecraft_get_color(/*"other:leather"*/ STR(1996)), /*"none"*/ STR(880), DsList(global::minecraft_armor_trim_material_list).Value(IntType(0)) }));
		array_add(VarType::CreateRef(sArr(armor_array)), ArrType::From({ /*"none"*/ STR(880), minecraft_get_color(/*"other:leather"*/ STR(1996)), /*"none"*/ STR(880), DsList(global::minecraft_armor_trim_material_list).Value(IntType(0)) }));
		array_add(VarType::CreateRef(sArr(armor_array)), ArrType::From({ /*"none"*/ STR(880), minecraft_get_color(/*"other:leather"*/ STR(1996)), /*"none"*/ STR(880), DsList(global::minecraft_armor_trim_material_list).Value(IntType(0)) }));
