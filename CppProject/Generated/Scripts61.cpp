...
namespace CppProject
{
	void tab_timeline_editor_appearance(ScopeAny self)
	{
		if (idVar(global::tl_edit, type) != e_tl_type_POINT_LIGHT && idVar(global::tl_edit, type) != e_tl_type_SPOT_LIGHT)
		{
			...
			draw_button_menu(self, { /*"timelineeditorblendmode"*/ STR(1447), e_menu_LIST, sVar(dx), sVar(dy), sVar(dw), IntType(24), idVar(global::tl_edit, blend_mode), text_get({ /*"timelineeditorblendmode"*/ STR(1447) + idVar(global::tl_edit, blend_mode) }), ID_action_tl_blend_mode });
			tab_next(self);
			VarType text;
			if (idVar(global::tl_edit, alpha_mode) == e_alpha_mode_BLEND)
				text = text_get({ /*"renderalphamodeblend"*/ STR(1470) });
			else
				if (idVar(global::tl_edit, alpha_mode) == e_alpha_mode_HASHED)
					text = text_get({ /*"renderalphamodehashed"*/ STR(1469) });
				else
					text = text_get({ /*"renderalphamodedefault"*/ STR(1468) });
			
			
			tab_control_menu(self);
			draw_button_menu(self, { /*"timelineeditoralphamode"*/ STR(1467), e_menu_LIST, sVar(dx), sVar(dy), sVar(dw), IntType(24), idVar(global::tl_edit, alpha_mode), text, ID_action_tl_alpha_mode });
			tab_next(self);
			tab_control_dragger(self);
			draw_dragger(self, { /*"timelineeditordepth"*/ STR(3632), sVar(dx), sVar(dy), dragger_width, idVar(global::tl_edit, depth), 0.1, -no_limit, no_limit, IntType(0), IntType(1), ObjType(obj_category, idInt(sVar(tab), appearance))->tbx_depth, ID_action_tl_depth });
			tab_next(self);
			tab_set_collumns(self, { true, floor((RealType)sVar(content_width) / 150.0) });
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditortextureblur"*/ STR(3633), sVar(dx), sVar(dy), idVar(global::tl_edit, texture_blur), ID_action_tl_texture_blur);
			tab_next(self);
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditortexturefiltering"*/ STR(3634), sVar(dx), sVar(dy), idVar(global::tl_edit, texture_filtering), ID_action_tl_texture_filtering);
			tab_next(self);
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorshadows"*/ STR(3635), sVar(dx), sVar(dy), idVar(global::tl_edit, shadows), ID_action_tl_shadows);
			tab_next(self);
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorssao"*/ STR(3636), sVar(dx), sVar(dy), idVar(global::tl_edit, ssao), ID_action_tl_ssao);
			tab_next(self);
			if (type_has_wind(idVar(global::tl_edit, type)))
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorwind"*/ STR(3637), sVar(dx), sVar(dy), idVar(global::tl_edit, wind), ID_action_tl_wind);
				tab_next(self);
				if (idVar(global::tl_edit, type) != e_temp_type_TEXT && !type_is_shape(idVar(global::tl_edit, type)))
				{
					tab_control_checkbox(self);
					draw_checkbox(self, /*"timelineeditorwindterrain"*/ STR(3638), sVar(dx), sVar(dy), idVar(global::tl_edit, wind_terrain), ID_action_tl_wind_terrain);
					tab_next(self);
				}
			}
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorglow"*/ STR(3639), sVar(dx), sVar(dy), idVar(global::tl_edit, glow), ID_action_tl_glow);
			tab_next(self);
			if (idVar(global::tl_edit, glow) > 0)
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorglowtexture"*/ STR(3640), sVar(dx), sVar(dy), idVar(global::tl_edit, glow_texture), ID_action_tl_glow_texture);
				tab_next(self);
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditoronlyrenderglow"*/ STR(3641), sVar(dx), sVar(dy), idVar(global::tl_edit, only_render_glow), ID_action_tl_only_render_glow);
				tab_next(self);
			}
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorfog"*/ STR(3642), sVar(dx), sVar(dy), idVar(global::tl_edit, fog), ID_action_tl_fog);
			tab_next(self);
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorbackfaces"*/ STR(3643), sVar(dx), sVar(dy), idVar(global::tl_edit, backfaces), ID_action_tl_backfaces);
			tab_next(self);
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorhqhiding"*/ STR(3644), sVar(dx), sVar(dy), idVar(global::tl_edit, hq_hiding), ID_action_tl_hq_hiding);
			tab_next(self);
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorlqhiding"*/ STR(3645), sVar(dx), sVar(dy), idVar(global::tl_edit, lq_hiding), ID_action_tl_lq_hiding);
			tab_next(self);
		...
		{
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorrendershadows"*/ STR(3646), sVar(dx), sVar(dy), idVar(global::tl_edit, shadows), ID_action_tl_shadows);
			tab_next(self);
		}
	...
	void tab_timeline_editor_audio(ScopeAny self)
	{
		...
		draw_button_label(self, { /*"timelineeditoraudioadd"*/ STR(3647), floor(sVar(dx) + (RealType)sVar(dw) / 2.0), sVar(dy), null_, null_, e_button_PRIMARY, ID_action_tl_add_sound, e_anchor_CENTER });
		tab_next(self);
	}
	...
	RealType tab_timeline_editor_hierarchy(ScopeAny self)
	{
		...
		if (idVar(global::tl_edit, part_of) == null_)
		{
			...
			if (par == global::_app->id)
				text = text_get({ /*"timelinenone"*/ STR(1655) });
			else
				text = string_remove_newline(idVar(par, display_name));
			
			tab_control_menu(self);
			draw_button_menu(self, { /*"timelineeditorparent"*/ STR(1044), e_menu_TIMELINE, sVar(dx), sVar(dy), sVar(dw), IntType(24), par, text, ID_action_tl_parent });
			tab_next(self);
			...
			{
				ArrType partname = ArrType::From({ /*"right"*/ STR(189), /*"left"*/ STR(188), /*"front"*/ STR(1798), /*"back"*/ STR(1799), /*"upper"*/ STR(889), /*"lower"*/ STR(1800) });
				tab_control_switch(self);
				draw_switch(self, { /*"timelineeditorlockbend"*/ STR(3648) + partname.Value(idInt(idVar(par, model_part), bend_part)), sVar(dx), sVar(dy), idVar(global::tl_edit, lock_bend), ID_action_tl_lock_bend });
				tab_next(self);
			}
		}
		if (par != global::_app->id)
		{
			...
			draw_label(self, { text_get({ /*"timelineeditorinherit"*/ STR(3649) }), sVar(dx), sVar(dy) + IntType(10), fa_left, fa_middle, global::c_text_secondary, global::a_text_secondary });
			tab_next(self);
			tab_set_collumns(self, { true, floor((RealType)sVar(content_width) / 150.0) });
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorinheritposition"*/ STR(3650), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_position), ID_action_tl_inherit_position);
			tab_next(self);
			if (idArr(global::tl_edit, value_type).Value(e_value_type_TRANSFORM_ROT))
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritrotation"*/ STR(3651), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_rotation), ID_action_tl_inherit_rotation);
				tab_next(self);
			}
			if (idArr(global::tl_edit, value_type).Value(e_value_type_ROT_POINT) && sReal(setting_advanced_mode) > 0)
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritrotpoint"*/ STR(3652), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_rot_point), ID_action_tl_inherit_rot_point);
				tab_next(self);
			}
			if (idArr(global::tl_edit, value_type).Value(e_value_type_TRANSFORM_SCA))
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritscale"*/ STR(3653), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_scale), ID_action_tl_inherit_scale);
				tab_next(self);
			}
			if (idArr(global::tl_edit, value_type).Value(e_value_type_MATERIAL_COLOR))
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritopacity"*/ STR(3654), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_alpha), ID_action_tl_inherit_alpha);
				tab_next(self);
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritcolor"*/ STR(3655), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_color), ID_action_tl_inherit_color);
				tab_next(self);
			}
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorinheritvisibility"*/ STR(3656), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_visibility), ID_action_tl_inherit_visibility);
			tab_next(self);
			if (idArr(global::tl_edit, value_type).Value(e_value_type_TRANSFORM_BEND) && sReal(setting_advanced_mode) > 0)
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritbend"*/ STR(3657), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_bend), ID_action_tl_inherit_bend);
				tab_next(self);
			}
			if (idArr(global::tl_edit, value_type).Value(e_value_type_MATERIAL_TEXTURE))
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinherittexture"*/ STR(3658), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_texture), ID_action_tl_inherit_texture);
				tab_next(self);
			}
			if (idArr(global::tl_edit, value_type).Value(e_value_type_MATERIAL) && sReal(setting_advanced_mode) > 0)
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritsurface"*/ STR(3659), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_surface), ID_action_tl_inherit_surface);
				tab_next(self);
			}
			if (idArr(global::tl_edit, value_type).Value(e_value_type_MATERIAL) && sReal(setting_advanced_mode) > 0)
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritsubsurface"*/ STR(3660), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_subsurface), ID_action_tl_inherit_subsurface);
				tab_next(self);
			}
			...
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritglowcolor"*/ STR(3661), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_glow_color), ID_action_tl_inherit_glow_color);
				tab_next(self);
			}
			if (sReal(setting_advanced_mode) > 0)
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritselect"*/ STR(3662), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_select), ID_action_tl_inherit_select);
				tab_next(self);
			}
			tab_set_collumns(self, { false });
			if (idArr(global::tl_edit, value_type).Value(e_value_type_TRANSFORM_SCA) && idVar(global::tl_edit, inherit_scale) > 0 && sReal(setting_advanced_mode) > 0)
			{
				...
				togglebutton_add(self, { /*"timelineeditorscalemoderesize"*/ STR(3663), null_, IntType(1), idVar(global::tl_edit, scale_resize) == IntType(1), ID_action_tl_scale_resize });
				togglebutton_add(self, { /*"timelineeditorscalemodestretch"*/ STR(3664), null_, IntType(0), idVar(global::tl_edit, scale_resize) == IntType(0), ID_action_tl_scale_resize });
				draw_togglebutton(self, { /*"timelineeditorscalemode"*/ STR(3665), sVar(dx), sVar(dy) });
				tab_next(self);
			}
		}
		return 0.0;
	...
	void tab_timeline_editor_info(ScopeAny self)
	{
		...
		draw_textfield(self, { /*"timelineeditorname"*/ STR(3666), sVar(dx), sVar(dy), sVar(dw), IntType(24), ObjType(obj_category, idInt(sVar(tab), info))->tbx_name, ID_action_tl_name, string_remove_newline(idVar(global::tl_edit, display_name)), /*"top"*/ STR(187) });
		tab_next(self);
		if (idVar(global::tl_edit, type) == e_temp_type_TEXT)
		{
			...
			draw_textfield(self, { /*"timelineeditortext"*/ STR(3096), sVar(dx), sVar(dy), sVar(dw), IntType(76), ObjType(obj_category, idInt(sVar(tab), info))->tbx_text, ID_action_tl_text, /*""*/ STR(0), /*"top"*/ STR(187) });
			tab_next(self);
		}
		tab_control(self, sReal(ui_small_height));
		draw_label_value(self, sVar(dx), sVar(dy), sVar(dw), sReal(ui_small_height), text_get({ /*"timelineeditortype"*/ STR(3667) }), string_remove_newline(idVar(global::tl_edit, type_name)));
		tab_next(self);
		if (idArr(global::tl_edit, value_type).Value(e_value_type_ROT_POINT) && sReal(setting_advanced_mode) > 0)
		{
			tab_control_switch(self);
			draw_switch(self, { /*"timelineeditorrotpointcustom"*/ STR(3668), sVar(dx), sVar(dy), idVar(global::tl_edit, rot_point_custom), ID_action_tl_rotpoint_custom });
			tab_next(self);
			if (idVar(global::tl_edit, rot_point_custom) > 0)
			{
				...
				global::axis_edit = X_;
				textfield_group_add(self, { /*"timelineeditorrotpointx"*/ STR(3669), idVar(global::tl_edit, rot_point).Value(global::axis_edit), def.Value(global::axis_edit), ID_action_tl_rotpoint, global::axis_edit, ObjType(obj_category, idInt(sVar(tab), info))->tbx_rot_point_x });
				global::axis_edit = ((sReal(setting_z_is_up) > 0) ? Y_ : Z_);
				textfield_group_add(self, { /*"timelineeditorrotpointy"*/ STR(3670), idVar(global::tl_edit, rot_point).Value(global::axis_edit), def.Value(global::axis_edit), ID_action_tl_rotpoint, global::axis_edit, ObjType(obj_category, idInt(sVar(tab), info))->tbx_rot_point_y });
				global::axis_edit = ((sReal(setting_z_is_up) > 0) ? Z_ : Y_);
				textfield_group_add(self, { /*"timelineeditorrotpointz"*/ STR(3671), idVar(global::tl_edit, rot_point).Value(global::axis_edit), def.Value(global::axis_edit), ID_action_tl_rotpoint, global::axis_edit, ObjType(obj_category, idInt(sVar(tab), info))->tbx_rot_point_z });
				sInt(context_menu_group_temp) = e_context_group_ROT_POINT;
				tab_control_textfield_group(self, { false });
				draw_textfield_group(self, { /*"timelineeditorrotpoint"*/ STR(3672), sVar(dx), sVar(dy), sVar(dw), mul, -no_limit, no_limit, snapval, false, true, IntType(1) });
				tab_next(self);
	...
	{
		tab_control_button_label(self);
		draw_button_label(self, { /*"timelineeditorpathpointadd"*/ STR(3673), floor(sVar(dx) + (RealType)sVar(dw) / 2.0), sVar(dy), null_, icons_PATH_POINT, e_button_PRIMARY, ID_action_tl_path_point_add, fa_middle });
		tab_next(self);
		tab_control_switch(self);
		draw_switch(self, { /*"timelineeditorpathclosed"*/ STR(3674), sVar(dx), sVar(dy), idVar(global::tl_edit, path_closed), ID_action_tl_path_closed });
		tab_next(self);
		tab_control_switch(self);
		draw_switch(self, { /*"timelineeditorpathsmooth"*/ STR(3675), sVar(dx), sVar(dy), idVar(global::tl_edit, path_smooth), ID_action_tl_path_smooth });
		tab_next(self);
		tab_control_dragger(self);
		draw_dragger(self, { /*"timelineeditorpathdetail"*/ STR(3676), sVar(dx), sVar(dy), dragger_width, idVar(global::tl_edit, path_detail), 1.0 / 4.0, IntType(1), no_limit, IntType(6), IntType(1), ObjType(obj_category, idInt(sVar(tab), path))->tbx_detail, ID_action_tl_path_detail, null_, true, false, /*"timelineeditorpathdetailtip"*/ STR(3677) });
		tab_next(self);
		tab_control_switch(self);
		draw_button_collapse(self, /*"path_shape"*/ STR(141), DsMap(global::collapse_map).Value(/*"path_shape"*/ STR(141)), ID_action_tl_path_shape_generate, idVar(global::tl_edit, path_shape_generate), /*"timelineeditorpathshape"*/ STR(3678));
		tab_next(self);
		if (DsMap(global::collapse_map).Value(/*"path_shape"*/ STR(141)) > 0 && idVar(global::tl_edit, path_shape_generate) > 0)
		{
			...
			tab_control_dragger(self);
			draw_dragger(self, { /*"timelineeditorpathshaperadius"*/ STR(3679), sVar(dx), sVar(dy), dragger_width, idVar(global::tl_edit, path_shape_radius), 0.1, 0.01, no_limit, IntType(8), 0.01, ObjType(obj_category, idInt(sVar(tab), path))->tbx_radius, ID_action_tl_path_shape_radius });
			tab_next(self);
			tab_control_dragger(self);
			draw_dragger(self, { /*"timelineeditorpathshapetexlength"*/ STR(3680), sVar(dx), sVar(dy), dragger_width, idVar(global::tl_edit, path_shape_tex_length), 0.1, 0.01, no_limit, IntType(16), 0.01, ObjType(obj_category, idInt(sVar(tab), path))->tbx_tex_length, ID_action_tl_path_shape_tex_length, null_, true, false, /*"timelineeditorpathshapetexlengthtip"*/ STR(3681) });
			tab_next(self);
			tab_control_switch(self);
			draw_switch(self, { /*"timelineeditorpathshapeinvert"*/ STR(3682), sVar(dx), sVar(dy), idVar(global::tl_edit, path_shape_invert), ID_action_tl_path_shape_invert });
			tab_next(self);
			tab_control_switch(self);
			draw_switch(self, { /*"timelineeditorpathshapesmoothsegments"*/ STR(3683), sVar(dx), sVar(dy), idVar(global::tl_edit, path_shape_smooth_segments), ID_action_tl_path_shape_smooth_segments, /*"timelineeditorpathshapesmoothsegmentstip"*/ STR(3684) });
			tab_next(self);
			tab_control_switch(self);
			draw_button_collapse(self, /*"path_shape_tube"*/ STR(142), DsMap(global::collapse_map).Value(/*"path_shape_tube"*/ STR(142)), ID_action_tl_path_shape_tube, idVar(global::tl_edit, path_shape_tube), /*"timelineeditorpathshapetube"*/ STR(3685));
			tab_next(self);
			if (DsMap(global::collapse_map).Value(/*"path_shape_tube"*/ STR(142)) > 0 && idVar(global::tl_edit, path_shape_tube) > 0)
			{
				tab_collapse_start(self);
				tab_control_dragger(self);
				draw_dragger(self, { /*"timelineeditorpathshapedetail"*/ STR(3686), sVar(dx), sVar(dy), dragger_width, idVar(global::tl_edit, path_shape_detail), 1.0 / 4.0, IntType(3), no_limit, IntType(6), IntType(1), ObjType(obj_category, idInt(sVar(tab), path))->tbx_shape_detail, ID_action_tl_path_shape_detail });
				tab_next(self);
				tab_control_switch(self);
				draw_switch(self, { /*"timelineeditorpathshapesmoothring"*/ STR(3687), sVar(dx), sVar(dy), idVar(global::tl_edit, path_shape_smooth_ring), ID_action_tl_path_shape_smooth_ring, /*"timelineeditorpathshapesmoothringtip"*/ STR(3688) });
				tab_next(self);
				tab_collapse_end(self);
			}
			tab_control_button_label(self);
			if (draw_button_label(self, { /*"timelineeditorpathshapesavemap"*/ STR(3689), sVar(dx), sVar(dy), sVar(dw), icons_TEXTURE_EXPORT, e_button_SECONDARY }))
			{
