...
namespace CppProject
{
	...
	RealType view_draw(ScopeAny self, IntType view)
	{
		...
		if (sStr(settings_menu_name) == (string(view) + /*"viewqualitysettings"*/ STR(3782)) && sStr(settings_menu_ani_type) != /*"hide"*/ STR(718))
		...
		if (sStr(settings_menu_name) == (string(view) + /*"viewgridsettings"*/ STR(3792)) && sStr(settings_menu_ani_type) != /*"hide"*/ STR(718))
			ObjType(value_animation, ObjType(micro_animation, global::current_microani)->active)->value = true;
		dx -= sVar(dw);
		...
		if (view == sInt(view_main))
		{
			...
			if (sStr(settings_menu_name) == (string(view) + /*"viewsnapsettings"*/ STR(3802)) && sStr(settings_menu_ani_type) != /*"hide"*/ STR(718))
				ObjType(value_animation, ObjType(micro_animation, global::current_microani)->active)->value = true;
			dx -= sVar(dw);
		...
		if (ObjType(obj_view, view)->quality == e_view_mode_RENDER)
		{
			...
			{
				infotext = text_get({ /*"viewrenderpass"*/ STR(3815), text_get({ /*"viewmodepass"*/ STR(1454) + DsList(global::render_pass_list).Value(sInt(project_render_pass)) }) });
