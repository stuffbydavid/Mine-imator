...
namespace CppProject
{
	...
	StringType unzip_asset(VarType fn)
	{
		...
		if (!file_exists_lib(validfile))
			validfile = file_find_single(unzip_directory + name + /*"/"*/ STR(19), /*"miproject;.mproj;.mani;"*/ STR(3866));
		if (!file_exists_lib(validfile))
			validfile = file_find_single(unzip_directory, /*"miobject;miparticles;.object;.particles;.json;"*/ STR(3867));
		if (!file_exists_lib(validfile))
			validfile = file_find_single(unzip_directory + name + /*"/"*/ STR(19), /*"miobject;miparticles;.object;.particles;.json;"*/ STR(3867));
		if (!file_exists_lib(validfile))
			return /*""*/ STR(0);
		return validfile;
	}
	...
	StringType unzip_model(StringType fn)
	{
		...
		if (!file_exists_lib(validfile))
			validfile = file_find_single(unzip_directory + name + /*"/"*/ STR(19), /*"json"*/ STR(3868));
		if (!file_exists_lib(validfile))
