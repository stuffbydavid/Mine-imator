...
namespace CppProject
{
	...
	RealType render_set_texture(VarType tex, StringType type)
	{
		...
		sampler = DsMap(idInt(global::render_shader_obj, sampler_map)).Value(/*"uTexture"*/ STR(1912) + type);
		scalex = IntType(1);
		scaley = IntType(1);
		...
		if (type == /*""*/ STR(0))
			render_set_uniform_vec2(/*"uTextureSize"*/ STR(1913), global::shader_texture_width, global::shader_texture_height);
	...
	void render_startup(ScopeAny self)
	{
		...
		if (!file_exists_lib(render_default_file))
		{
			...
			project_save_done();
			log({ /*"Saved default render settings"*/ STR(2528), render_default_file });
		}
	}
	...
	void render_update_text()
	{
		...
		withAll (obj_preview, noone)
			if (instance_exists(self->select) && Obj(self->select)->subAssetId != ID_obj_resource && idVar(self->select, type) == e_temp_type_TEXT)
				render_generate_text(ScopeAny(self), { /*"AaBbCc"*/ STR(2088), idVar(self->select, text_font), idVar(self->select, text_3d) });
	...
	RealType render_world_block(VarType vbuffer, VarType res, BoolType rotate, VarType size, VarType temp)
	{
		...
		render_set_texture(texnormal, /*"Normal"*/ STR(2531));
		if (rotate)
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1914), color_multiply(blend, idVar(res.Value(IntType(0)), color_grass)), global::shader_blend_alpha);
			vbuffer_render({ vbuffer[e_block_depth_DEPTH0][e_block_vbuffer_GRASS] });
			render_set_uniform_color(/*"uBlendColor"*/ STR(1914), blend, global::shader_blend_alpha);
		}
		if (!vbuffer_is_empty(vbuffer[e_block_depth_DEPTH0][e_block_vbuffer_ANIMATED]))
		{
			...
			{
				render_set_texture(texanimat, /*"Material"*/ STR(2530));
				texmatprev = texanimat;
			}
			if (texaninormal != texnormalprev)
			{
				render_set_texture(texaninormal, /*"Normal"*/ STR(2531));
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1914), color_multiply(blend, idVar(res.Value(IntType(0)), color_foliage)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1914), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_oak)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1914), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_spruce)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1914), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_birch)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1914), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_jungle)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1914), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_acacia)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1914), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_dark_oak)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1914), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_mangrove)), global::shader_blend_alpha);
		...
		if (!vbuffer_is_empty(vbuffer[e_block_depth_DEPTH2][e_block_vbuffer_WATER]))
		{
			...
			{
				render_set_texture(texani);
				render_set_uniform_color(/*"uBlendColor"*/ STR(1914), color_multiply(blend, idVar(res.Value(IntType(0)), color_water)), global::shader_blend_alpha);
				render_set_uniform_int(/*"uIsWater"*/ STR(2535), IntType(1));
