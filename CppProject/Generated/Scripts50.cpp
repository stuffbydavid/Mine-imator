...
namespace CppProject
{
	...
	RealType render_set_texture(VarType tex, StringType type)
	{
		...
		sampler = DsMap(idInt(global::render_shader_obj, sampler_map)).Value(/*"uTexture"*/ STR(1913) + type);
		scalex = IntType(1);
		scaley = IntType(1);
		...
		if (type == /*""*/ STR(0))
			render_set_uniform_vec2(/*"uTextureSize"*/ STR(1914), global::shader_texture_width, global::shader_texture_height);
	...
	RealType render_world_block(VarType vbuffer, VarType res, BoolType rotate, VarType size, VarType temp)
	{
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1915), color_multiply(blend, idVar(res.Value(IntType(0)), color_grass)), global::shader_blend_alpha);
			vbuffer_render({ vbuffer[e_block_depth_DEPTH0][e_block_vbuffer_GRASS] });
			render_set_uniform_color(/*"uBlendColor"*/ STR(1915), blend, global::shader_blend_alpha);
		}
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1915), color_multiply(blend, idVar(res.Value(IntType(0)), color_foliage)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1915), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_oak)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1915), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_spruce)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1915), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_birch)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1915), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_jungle)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1915), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_acacia)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1915), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_dark_oak)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1915), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_mangrove)), global::shader_blend_alpha);
		...
		if (!vbuffer_is_empty(vbuffer[e_block_depth_DEPTH2][e_block_vbuffer_WATER]))
		{
			...
			{
				render_set_texture(texani);
				render_set_uniform_color(/*"uBlendColor"*/ STR(1915), color_multiply(blend, idVar(res.Value(IntType(0)), color_water)), global::shader_blend_alpha);
