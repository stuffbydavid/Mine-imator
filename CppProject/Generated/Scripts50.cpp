...
namespace CppProject
{
	...
	RealType render_world_ground(ScopeAny self)
	{
		...
		if (global::render_mode == e_render_mode_SCENE_TEST || global::render_mode == e_render_mode_AO_MASK)
			render_set_uniform_color(/*"uReplaceColor"*/ STR(2466), c_white, IntType(1));
		VarType blend = block_texture_get_blend(sVar(background_ground_name), sVar(background_ground_tex));
		BoolType iswater = (sVar(background_ground_name) == /*"block/water_flow"*/ STR(1709) || sVar(background_ground_name) == /*"block/water_still"*/ STR(1707));
		render_set_uniform_int(/*"uIsGround"*/ STR(2467), IntType(1));
		render_set_uniform_color(/*"uBlendColor"*/ STR(1878), blend, IntType(1));
		render_set_uniform_color(/*"uGlowColor"*/ STR(2468), c_black, IntType(1));
		render_set_uniform_int(/*"uGlowTexture"*/ STR(2469), IntType(0));
		render_set_uniform_int(/*"uFogShow"*/ STR(1887), global::_app->background_fog_show);
		render_set_uniform_int(/*"uIsWater"*/ STR(2465), iswater);
		render_set_uniform_int(/*"uMaterialFormat"*/ STR(2459), idVar(sVar(background_ground_tex_material), material_format));
		if (sVar(background_ground_tex_material) == global::mc_res)
		{
			render_set_uniform(/*"uMetallic"*/ STR(2462), IntType(0));
			render_set_uniform(/*"uRoughness"*/ STR(2463), (iswater && global::_app->project_render_water_reflections > 0 ? .07 : 1.0));
			render_set_uniform(/*"uEmissive"*/ STR(2464), IntType(0));
		}
		else
		{
			render_set_uniform(/*"uMetallic"*/ STR(2462), IntType(0));
			render_set_uniform(/*"uRoughness"*/ STR(2463), IntType(0));
			render_set_uniform(/*"uEmissive"*/ STR(2464), IntType(0));
		}
		...
		if (sBool(background_ground_material_ani))
			render_set_texture(sArr(background_ground_ani_texture_material).Value(block_texture_get_frame()), /*"Material"*/ STR(2460));
		else
			render_set_texture(sInt(background_ground_texture_material), /*"Material"*/ STR(2460));
		
		if (sBool(background_ground_normal_ani))
			render_set_texture(sArr(background_ground_ani_texture_normal).Value(block_texture_get_frame()), /*"Normal"*/ STR(2461));
		else
			render_set_texture(sInt(background_ground_texture_normal), /*"Normal"*/ STR(2461));
	...
	void render_world_item(VarType vbuffer, VarType is3d, VarType facecamera, VarType bounce, VarType rotate, ArrType res)
	{
		...
		if (res.Value(IntType(1)) != null_ && res.Value(IntType(1)) != global::mc_res)
		{
			if (global::shader_uniform_metallic != IntType(0))
			{
				...
				render_set_uniform(/*"uMetallic"*/ STR(2462), global::shader_uniform_metallic);
			}
			if (global::shader_uniform_roughness != IntType(0))
			{
				global::shader_uniform_roughness = IntType(0);
				render_set_uniform(/*"uRoughness"*/ STR(2463), global::shader_uniform_roughness);
			}
			if (global::shader_uniform_emissive != IntType(0))
			{
				global::shader_uniform_emissive = IntType(0);
				render_set_uniform(/*"uEmissive"*/ STR(2464), global::shader_uniform_emissive);
			}
			if (idInt(res.Value(IntType(1)), item_sheet_texture_material) != null_)
				render_set_texture(idInt(res.Value(IntType(1)), item_sheet_texture_material), /*"Material"*/ STR(2460));
			else
				render_set_texture(idVar(res.Value(IntType(1)), texture), /*"Material"*/ STR(2460));
			
			render_set_uniform_int(/*"uMaterialFormat"*/ STR(2459), idVar(res.Value(IntType(1)), material_format));
		}
		else
		{
			render_set_texture(ID_spr_default_material, /*"Material"*/ STR(2460));
			render_set_uniform_int(/*"uMaterialFormat"*/ STR(2459), e_material_FORMAT_NONE);
		}
		
		if (res.Value(IntType(2)) != null_ && res.Value(IntType(2)) != global::mc_res)
		{
			if (idInt(res.Value(IntType(2)), item_sheet_tex_normal) != null_)
				render_set_texture(idInt(res.Value(IntType(2)), item_sheet_tex_normal), /*"Normal"*/ STR(2461));
			else
				render_set_texture(idVar(res.Value(IntType(2)), texture), /*"Normal"*/ STR(2461));
			
		}
		else
			render_set_texture(ID_spr_default_normal, /*"Normal"*/ STR(2461));
	...
	RealType render_world_model_part(ScopeAny self, VarType part, VarType res, IntType texnamemap, IntType shapevbuffermap, IntType colornamemap, IntType shapehidelist, IntType shapetexnamemap, VarType tlobject)
	{
		...
		for (IntType s = IntType(0); s < ds_list_size(idInt(part, shape_list)); s++)
		{
			...
			if (tlobject > 0)
			{
				...
				render_set_uniform_int(/*"uMaterialFormat"*/ STR(2459), sArr(model_part_shape_material_res).Value(s));
				...
				{
					render_set_texture(sArr(model_part_shape_tex_material).Value(s), /*"Material"*/ STR(2460));
				...
				if (sArr(model_part_shape_tex_normal).Value(s) == null_)
					...
					render_set_texture(sArr(model_part_shape_tex_normal).Value(s), /*"Normal"*/ STR(2461));
			...
			{
				render_set_uniform_color(/*"uBlendColor"*/ STR(1878), blendcolor, alpha);
	...
	RealType render_world_particle(ScopeAny self)
	{
		...
		render_set_uniform_color(/*"uBlendColor"*/ STR(1878), global::shader_blend_color, global::shader_blend_alpha);
	...
	void render_world_shape(VarType type, VarType vbuf, VarType facecamera, ArrType tex)
	{
		...
		render_set_texture(tex.Value(IntType(1)), /*"Material"*/ STR(2460));
		render_set_texture(tex.Value(IntType(2)), /*"Normal"*/ STR(2461));
		vbuffer_render({ vbuf });
	}
	...
	RealType render_world_sky()
	{
		...
		if (global::_app->background_image_show > 0 && global::_app->background_image != null_ && global::_app->background_image_type != /*"image"*/ STR(90))
		{
			...
			if (global::_app->background_image_type == /*"sphere"*/ STR(513))
			{
				...
				if (global::_app->background_image_type == /*"box"*/ STR(1317))
				{
		...
		if (global::_app->background_fog_show > 0 && global::_app->background_fog_sky > 0)
		{
			...
			render_set_uniform_color(/*"uBlendColor"*/ STR(1878), global::_app->background_fog_color_final, IntType(1));
		...
		if (!(global::_app->background_image_show > 0))
		{
			...
			if (global::_app->background_night_alpha > IntType(0))
			{
				...
				render_set_uniform_color(/*"uBlendColor"*/ STR(1878), c_white, 0.4 * global::_app->background_night_alpha);
			...
			render_set_uniform_color(/*"uBlendColor"*/ STR(1878), c_white, vis);
	...
	RealType render_world_sky_clouds(ScopeAny self)
	{
		if (!(sVar(background_sky_clouds_show) > 0) || !(global::render_background > 0) || global::render_mode == e_render_mode_DEPTH_NO_SKY)
			return IntType(0);
		if (global::render_mode == e_render_mode_SCENE_TEST || global::render_mode == e_render_mode_AO_MASK)
			render_set_uniform_color(/*"uReplaceColor"*/ STR(2466), c_black, IntType(1));
		VarType res = sVar(background_sky_clouds_tex);
		if (!res_is_ready(res))
			res = global::mc_res;
		render_set_uniform_int(/*"uIsSky"*/ STR(2470), IntType(1));
		render_set_uniform_color(/*"uBlendColor"*/ STR(1878), sInt(background_sky_clouds_final), sReal(background_clouds_alpha));
		render_set_uniform_color(/*"uGlowColor"*/ STR(2468), c_black, IntType(1));
		render_set_uniform_int(/*"uGlowTexture"*/ STR(2469), IntType(0));
		render_set_uniform(/*"uMetallic"*/ STR(2462), IntType(0));
		render_set_uniform(/*"uRoughness"*/ STR(2463), IntType(1));
		render_set_uniform(/*"uEmissive"*/ STR(2464), IntType(0));
		render_set_uniform(/*"uLightSpecular"*/ STR(2471), IntType(0));
		...
		if (!(sVar(background_fog_show) > 0) || !(sVar(background_fog_sky) > 0))
			render_set_uniform(/*"uFogShow"*/ STR(1887), IntType(0));
		...
		if (!(sVar(background_fog_show) > 0) || !(sVar(background_fog_sky) > 0))
			render_set_uniform(/*"uFogShow"*/ STR(1887), global::_app->background_fog_show);
		return 0.0;
	}
	...
	RealType render_world_tl(ScopeAny self)
	{
		...
		if (global::render_mode == e_render_mode_CLICK)
		{
			if (sReal(selected) > 0 || sVar(lock) > 0 || !tl_update_list_filter(self->id))
				return IntType(0);
			render_set_uniform_color(/*"uReplaceColor"*/ STR(2466), self->id, IntType(1));
		}
		...
		if (global::render_mode == e_render_mode_AO_MASK)
			render_set_uniform_color(/*"uReplaceColor"*/ STR(2466), (sVar(ssao) > 0) ? c_white : c_black, IntType(1));
		...
		if (sVar(wind) != global::shader_uniform_wind)
		{
			...
			render_set_uniform(/*"uWindEnable"*/ STR(1880), global::shader_uniform_wind);
		}
		if (sVar(wind_terrain) != global::shader_uniform_wind_terrain)
		{
			global::shader_uniform_wind_terrain = sVar(wind_terrain);
			render_set_uniform(/*"uWindTerrain"*/ STR(1881), global::shader_uniform_wind_terrain);
		}
		if ((global::_app->background_fog_show > 0 && sVar(fog) > 0) != global::shader_uniform_fog)
		{
			...
			render_set_uniform_int(/*"uFogShow"*/ STR(1887), global::shader_uniform_fog);
		}
		if (sArr(value_inherit).Value(e_value_SUBSURFACE) != global::shader_uniform_sss || sArr(value_inherit).Value(e_value_SUBSURFACE_RADIUS_RED) != global::shader_uniform_sss_red || sArr(value_inherit).Value(e_value_SUBSURFACE_RADIUS_GREEN) != global::shader_uniform_sss_green || sArr(value_inherit).Value(e_value_SUBSURFACE_RADIUS_BLUE) != global::shader_uniform_sss_blue || sArr(value_inherit).Value(e_value_SUBSURFACE_COLOR) != global::shader_uniform_sss_color)
		{
			...
			render_set_uniform(/*"uSSS"*/ STR(2472), global::shader_uniform_sss);
			render_set_uniform_vec3(/*"uSSSRadius"*/ STR(2473), global::shader_uniform_sss_red, global::shader_uniform_sss_green, global::shader_uniform_sss_blue);
			render_set_uniform_color(/*"uSSSColor"*/ STR(2474), global::shader_uniform_sss_color, 1.0);
		}
		if (sArr(value_inherit).Value(e_value_WIND_INFLUENCE) != global::shader_uniform_wind_strength)
		{
			...
			render_set_uniform(/*"uWindStrength"*/ STR(1883), global::shader_uniform_wind_strength);
			render_set_uniform(/*"uWindDirectionalStrength"*/ STR(1886), global::shader_uniform_wind_strength * global::_app->background_wind_directional_strength);
		}
		...
		if (sVar(glow) != global::shader_uniform_glow || sVar(glow_texture) != global::shader_uniform_glow_texture || sArr(value_inherit).Value(e_value_GLOW_COLOR) != global::shader_uniform_glow_color)
		{
			...
			{
				render_set_uniform_int(/*"uGlow"*/ STR(2475), IntType(1));
				render_set_uniform_int(/*"uGlowTexture"*/ STR(2469), sVar(glow_texture));
				render_set_uniform_color(/*"uGlowColor"*/ STR(2468), global::shader_uniform_glow_color, IntType(1));
			...
			{
				render_set_uniform_int(/*"uGlow"*/ STR(2475), IntType(0));
				render_set_uniform_int(/*"uGlowTexture"*/ STR(2469), IntType(0));
				render_set_uniform_color(/*"uGlowColor"*/ STR(2468), c_black, IntType(0));
			}
			...
			switch ((IntType)sVar(type))
			{
				...
				case e_tl_type_PATH:
				{
					if (sVar(path_vbuffer) != null_)
					{
						...
						else
						{
							...
							render_set_uniform_int(/*"uMaterialFormat"*/ STR(2459), idVar(sArr(value_inherit).Value(e_value_TEXTURE_MATERIAL_OBJ), material_format));
						}
						...
						render_set_texture(tex);
						render_set_texture(texmat, /*"Material"*/ STR(2460));
						render_set_texture(texnorm, /*"Normal"*/ STR(2461));
				...
				default:
				{
					...
					withOne (Object, sVar(temp), self->id)
					{
						...
						if (matres != null_)
							render_set_uniform_int(/*"uMaterialFormat"*/ STR(2459), idVar(matres, material_format));
						else
							render_set_uniform_int(/*"uMaterialFormat"*/ STR(2459), e_material_FORMAT_NONE);
