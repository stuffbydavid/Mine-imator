...
namespace CppProject
{
	...
	RealType res_load_pack(ScopeAny self)
	{
		...
		switch (StringType(sStr(load_stage)).id)
		{
			case 1277: // unzip
			{
				debug({ /*"res_load_pack"*/ STR(2563), /*"unzip"*/ STR(1277) });
			...
			{
				debug({ /*"res_load_pack"*/ STR(2563), /*"modeltextures"*/ STR(1359) });
			...
			case 2569: // itemtextures
			{
				...
				file_rename_lib(global::load_assets_dir + mc_textures_directory + /*"items"*/ STR(2571), global::load_assets_dir + mc_textures_directory + /*"item"*/ STR(523));
				res_load_pack_item_textures(self, /*"diffuse"*/ STR(609), /*""*/ STR(0));
				res_load_pack_item_textures(self, /*"material"*/ STR(614), /*"_s"*/ STR(2572));
				res_load_pack_item_textures(self, /*"normal"*/ STR(603), /*"_n"*/ STR(2573));
