...
namespace CppProject
{
	IntType list_init_context_menu(ScopeAny self, VarType name)
	{
		...
		if (sStr(context_menu_value_name) != /*""*/ STR(0))
		{
			...
			{
				case 1535: // pathoffset
				{
					list_item_add(text_get({ /*"contextmenupathsetlength"*/ STR(1536) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_frame_path_offset_set_length);
					break;
				}
		...
		{
			case 1090: // contextmenuvalue
			case 1537: // contextmenucategory
			{
				if (sInt(context_menu_group) == e_context_group_SCALE && sReal(setting_advanced_mode) > 0)
				{
					StringType text = ((ObjType(obj_category, ObjType(obj_tab, sInt(frame_editor))->transform)->scale_all > 0) ? /*"contextmenuscaleseparate"*/ STR(1538) : /*"contextmenuscalecombine"*/ STR(1539));
					list_item_add(text_get({ text }), null_, /*""*/ STR(0), null_, icons_SCALE, null_, ID_action_group_combine_scale, true);
				}
				if (name == /*"contextmenuvalue"*/ STR(1090))
				{
					list_item_add(text_get({ /*"contextmenuvaluecut"*/ STR(1540) }), null_, /*""*/ STR(0), null_, icons_CUT, null_, ID_action_value_cut, true);
					list_item_add(text_get({ /*"contextmenuvaluecopy"*/ STR(1541) }), null_, /*""*/ STR(0), null_, icons_COPY, null_, ID_action_value_copy, false);
					...
					list_item_add(text_get({ /*"contextmenuvaluepaste"*/ STR(1542) }), null_, caption, null_, icons_PASTE, null_, ID_action_value_paste, false);
					...
					list_item_add(text_get({ /*"contextmenuvaluereset"*/ STR(1543) }), null_, /*""*/ STR(0), null_, icons_RESET, null_, ID_action_value_reset, false);
				}
				if (sInt(context_menu_group) != null_)
				{
					list_item_add(text_get({ /*"contextmenugroupcopy"*/ STR(1544) }), null_, /*""*/ STR(0), null_, icons_COPY_ALL, null_, ID_action_group_copy, true);
					list_item_add(text_get({ /*"contextmenugrouppaste"*/ STR(1545) }), null_, /*""*/ STR(0), null_, icons_PASTE_ALL, null_, ID_action_group_paste, false);
					...
					list_item_add(text_get({ /*"contextmenugroupreset"*/ STR(1546) }), null_, /*""*/ STR(0), null_, icons_RESET_ALL, null_, ID_action_group_reset, false);
					if (sInt(context_menu_group) == e_context_group_POSITION)
						list_item_add(text_get({ /*"contextmenugroupcopyglobalposition"*/ STR(1547) }), null_, /*""*/ STR(0), null_, icons_COPY_ALL, null_, ID_action_group_copy_global, true);
				}
				break;
			}
			
			case 1101: // contextmenutextbox
			{
				list_item_add(text_get({ /*"contextmenutextboxcut"*/ STR(1548) }), null_, text_control_name(keybind_new(/*"X"*/ STR(268), true)), null_, icons_CUT, null_, ID_action_textbox_cut, true);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(textbox_select_startpos) == sVar(textbox_select_endpos));
				list_item_add(text_get({ /*"contextmenutextboxcopy"*/ STR(1549) }), null_, text_control_name(keybind_new(/*"C"*/ STR(266), true)), null_, icons_COPY, null_, ID_action_textbox_copy, false);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(textbox_select_startpos) == sVar(textbox_select_endpos));
				list_item_add(text_get({ /*"contextmenutextboxpaste"*/ STR(1550) }), null_, text_control_name(keybind_new(/*"V"*/ STR(270), true)), null_, icons_PASTE, null_, ID_action_textbox_paste, false);
				ObjType(obj_list_item, global::list_item_last)->disabled = (clipboard_get_text() == /*""*/ STR(0) || !clipboard_has_text());
				list_item_add(text_get({ /*"contextmenutextboxselectall"*/ STR(1551) }), null_, text_control_name(keybind_new(/*"A"*/ STR(257), true)), null_, icons_SELECT_ALL, null_, ID_action_textbox_select_all, false);
				break;
			}
			
			case 1552: // timelinelist
			{
				list_item_add(text_get({ /*"contextmenutladdfolder"*/ STR(1553) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_CREATE_FOLDER))->keybind), null_, icons_FOLDER, null_, ID_action_tl_folder, true);
				list_item_add(text_get({ /*"contextmenutlselectkeyframes"*/ STR(1554) }), sVar(context_menu_value), /*""*/ STR(0), null_, icons_KEYFRAME, null_, ID_action_tl_select_keyframes);
				...
				{
					list_item_add(text_get({ /*"contextmenutlcolortag"*/ STR(1555) }), null_, /*""*/ STR(0), null_, icons_TAG, icons_CHEVRON_RIGHT_TINY, null_);
					ObjType(obj_list_item, global::list_item_last)->context_menu_name = /*"color"*/ STR(929);
					ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(context_menu_value) == null_ && global::tl_edit == null_);
				}
				list_item_add(text_get({ /*"contextmenutlexpandchildren"*/ STR(1556) }), null_, /*""*/ STR(0), null_, icons_MAXIMIZE, null_, ID_action_tl_extend_children);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(context_menu_value) == null_ && global::tl_edit == null_);
				list_item_add(text_get({ /*"contextmenutlcollapsechildren"*/ STR(1557) }), null_, /*""*/ STR(0), null_, icons_MINIMIZE, null_, ID_action_tl_collapse_children);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(context_menu_value) == null_ && global::tl_edit == null_);
				list_item_add(text_get({ /*"contextmenutlduplicate"*/ STR(1558) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_DUPLICATE))->keybind), null_, icons_DUPLICATE, null_, ID_action_tl_duplicate, true);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(context_menu_value) == null_ && global::tl_edit == null_);
				list_item_add(text_get({ /*"contextmenutldelete"*/ STR(1559) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_DELETE))->keybind), null_, icons_DELETE, null_, ID_action_tl_remove);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(context_menu_value) == null_ && global::tl_edit == null_);
				list_item_add(text_get({ /*"contextmenutlexport"*/ STR(1560) }), null_, /*""*/ STR(0), null_, icons_ASSET_EXPORT, null_, ID_object_save);
				...
				list_item_add(text_get({ /*"contextmenutlselectall"*/ STR(1561) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_SELECT))->keybind), null_, icons_SELECT_ALL, null_, ID_action_tl_select_all, true);
				list_item_add(text_get({ /*"contextmenutlexpandall"*/ STR(1562) }), null_, /*""*/ STR(0), null_, icons_MAXIMIZE, null_, ID_action_tl_extend_all);
				list_item_add(text_get({ /*"contextmenutlcollapseall"*/ STR(1563) }), null_, /*""*/ STR(0), null_, icons_MINIMIZE, null_, ID_action_tl_collapse_all);
				break;
			}
			
			case 119: // timeline
			{
				list_item_add(text_get({ /*"contextmenutlkeyframestransition"*/ STR(1564) }), null_, /*""*/ STR(0), null_, icons_EASE_IN_OUT, icons_CHEVRON_RIGHT_TINY, null_, true);
				...
				ObjType(obj_list_item, global::list_item_last)->context_menu_name = /*"timelinelkeyframetransitions"*/ STR(1565);
				list_item_add(text_get({ /*"contextmenutlkeyframescut"*/ STR(1566) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_KEYFRAMES_CUT))->keybind), null_, icons_CUT_KEYFRAME, null_, ID_action_tl_keyframes_cut, true);
				ObjType(obj_list_item, global::list_item_last)->disabled = !sBool(timeline_settings_keyframes);
				list_item_add(text_get({ /*"contextmenutlkeyframescopy"*/ STR(1567) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_KEYFRAMES_COPY))->keybind), null_, icons_COPY_KEYFRAME, null_, ID_tl_keyframes_copy);
				ObjType(obj_list_item, global::list_item_last)->disabled = !sBool(timeline_settings_keyframes);
				list_item_add(text_get({ /*"contextmenutlkeyframespaste"*/ STR(1568) }), sVar(timeline_insert_pos), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_KEYFRAMES_PASTE))->keybind), null_, icons_PASTE_KEYFRAME, null_, ID_action_tl_keyframes_paste);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sInt(copy_kf_amount) == IntType(0));
				list_item_add(text_get({ /*"contextmenutlkeyframesdelete"*/ STR(1569) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_KEYFRAMES_DELETE))->keybind), null_, icons_DELETE_KEYFRAME, null_, ID_action_tl_keyframes_remove);
				ObjType(obj_list_item, global::list_item_last)->disabled = !sBool(timeline_settings_keyframes);
				list_item_add(text_get({ /*"contextmenutlkeyframesexport"*/ STR(1570) }), null_, /*""*/ STR(0), null_, icons_SAVE_KEYFRAME, null_, ID_keyframes_save);
				ObjType(obj_list_item, global::list_item_last)->disabled = !sBool(timeline_settings_keyframes_export);
				list_item_add(text_get({ /*"contextmenutlkeyframesselect"*/ STR(1571) }), null_, /*""*/ STR(0), null_, icons_SELECT_ALL_KEYFRAME, icons_CHEVRON_RIGHT_TINY, null_);
				ObjType(obj_list_item, global::list_item_last)->context_menu_name = /*"timelinelkeyframesselect"*/ STR(1572);
				list_item_add(text_get({ /*"contextmenutlkeyframeswalk"*/ STR(1573) }), sStr(timeline_settings_walk_fn), /*""*/ STR(0), null_, icons_WALK_CYCLE, null_, ID_action_tl_load_loop, true);
				ObjType(obj_list_item, global::list_item_last)->disabled = !file_exists_lib(sStr(timeline_settings_walk_fn));
				list_item_add(text_get({ /*"contextmenutlkeyframesrun"*/ STR(1574) }), sStr(timeline_settings_run_fn), /*""*/ STR(0), null_, icons_RUN_CYCLE, null_, ID_action_tl_load_loop);
				ObjType(obj_list_item, global::list_item_last)->disabled = !file_exists_lib(sStr(timeline_settings_run_fn));
				list_item_add(text_get({ /*"contextmenutlmarkeradd"*/ STR(1575) }), null_, /*""*/ STR(0), null_, icons_MARKER_ADD, null_, ID_action_tl_marker_new, true);
			...
			case 1572: // timelinelkeyframesselect
			{
				list_item_add(text_get({ /*"contextmenutlkeyframesselectbefore"*/ STR(1576) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_select_keyframes_before_marker);
				list_item_add(text_get({ /*"contextmenutlkeyframesselectafter"*/ STR(1577) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_select_keyframes_after_marker);
				list_item_add(text_get({ /*"contextmenutlkeyframesselectfirst"*/ STR(1578) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_select_keyframes_first);
				list_item_add(text_get({ /*"contextmenutlkeyframesselectlast"*/ STR(1579) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_select_keyframes_last);
				list_item_add(text_get({ /*"contextmenutlkeyframesselectregion"*/ STR(1580) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_select_keyframes_region);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(timeline_region_start) == null_);
				break;
			}
			
			case 1581: // timelinemarker
			{
				list_item_add(text_get({ /*"contextmenutlmarkeredit"*/ STR(1582) }), sVar(context_menu_value), /*""*/ STR(0), null_, icons_PENCIL, null_, ID_action_tl_marker_editor, true);
				list_item_add(text_get({ /*"contextmenutlmarkerdelete"*/ STR(1583) }), null_, /*""*/ STR(0), null_, icons_DELETE, null_, ID_action_tl_marker_delete);
				break;
			}
			
			case 929: // color
			{
				list_item_add(text_get({ /*"contextmenucolornone"*/ STR(1584) }), null_, /*""*/ STR(0), null_, icons_CLOSE, null_, ID_action_tl_color_tag_remove, true);
				for (IntType i = IntType(0); i <= IntType(8); i++)
				{
					list_item_add(text_get({ /*"contextmenucolor"*/ STR(1585) + string(i) }), i, /*""*/ STR(0), ID_spr_16, null_, null_, ID_action_tl_color_tag);
					ObjType(obj_list_item, global::list_item_last)->thumbnail_blend = ObjType(obj_theme, sInt(setting_theme))->accent_list.Value(i);
				}
				break;
			}
			
			case 1586: // toolbarfile
			{
				list_item_add(text_get({ /*"toolbarfilenew"*/ STR(1587) }), VarType(), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_PROJECT_NEW))->keybind), null_, icons_FILE, null_, ID_action_toolbar_new);
				list_item_add(text_get({ /*"toolbarfileopen"*/ STR(1588) }), VarType(), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_PROJECT_OPEN))->keybind), null_, icons_FOLDER, null_, ID_action_toolbar_open);
				list_item_add(text_get({ /*"toolbarfilerecent"*/ STR(1589) }), VarType(), /*""*/ STR(0), null_, icons_FOLDER_RECENTS, icons_CHEVRON_RIGHT_TINY, null_);
				ObjType(obj_list_item, global::list_item_last)->context_menu_name = /*"toolbarfilerecent"*/ STR(1589);
				list_item_add(text_get({ /*"toolbarfilelastbackup"*/ STR(1590) }), VarType(), /*""*/ STR(0), null_, icons_RECENTS, null_, ID_action_toolbar_open_last_backup);
				...
				list_item_add(text_get({ /*"toolbarfilesave"*/ STR(1591) }), VarType(), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_PROJECT_SAVE))->keybind), null_, icons_SAVE, null_, ID_action_toolbar_save, true);
				list_item_add(text_get({ /*"toolbarfilesaveas"*/ STR(1592) }), VarType(), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_PROJECT_SAVE_AS))->keybind), null_, icons_SAVE_AS, null_, ID_action_toolbar_save_as);
				if (sStr(window_state) == /*""*/ STR(0))
				{
					list_item_add(text_get({ /*"toolbarfileimport"*/ STR(1593) }), VarType(), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_IMPORT_ASSET))->keybind), null_, icons_ASSET_IMPORT, null_, ID_action_toolbar_import_asset, true);
					list_item_add(text_get({ /*"toolbarfileworldimport"*/ STR(1594) }), VarType(), /*""*/ STR(0), null_, icons_SCENERY, null_, ID_world_import_begin, false);
				}
				break;
			}
			
			case 1589: // toolbarfilerecent
			{
				VarType recent;
			...
			case 1595: // toolbaredit
			{
				list_item_add(text_get({ /*"toolbareditundo"*/ STR(1596) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_UNDO))->keybind), null_, icons_UNDO, null_, ID_action_toolbar_undo);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sReal(history_pos) == sReal(history_amount));
				list_item_add(text_get({ /*"toolbareditredo"*/ STR(1597) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_REDO))->keybind), null_, icons_REDO, null_, ID_action_toolbar_redo);
				ObjType(obj_list_item, global::list_item_last)->disabled = (sReal(history_pos) == IntType(0));
				list_item_add(text_get({ /*"toolbareditselectall"*/ STR(1598) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_SELECT))->keybind), null_, icons_SELECT_ALL, null_, ID_action_tl_select_all, true);
				ObjType(obj_list_item, global::list_item_last)->disabled = (ds_list_size(sInt(tree_list)) == IntType(0));
				list_item_add(text_get({ /*"toolbareditduplicate"*/ STR(1599) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_DUPLICATE))->keybind), null_, icons_DUPLICATE, null_, ID_action_tl_duplicate, true);
				ObjType(obj_list_item, global::list_item_last)->disabled = (global::tl_edit == null_);
				list_item_add(text_get({ /*"toolbareditdelete"*/ STR(1600) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_DELETE))->keybind), null_, icons_DELETE, null_, ID_action_tl_remove);
				ObjType(obj_list_item, global::list_item_last)->disabled = (global::tl_edit == null_);
				list_item_add(text_get({ /*"toolbaredithide"*/ STR(1601) }), true, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_HIDE))->keybind), null_, icons_HIDDEN, null_, ID_action_tl_hide_select, true);
				ObjType(obj_list_item, global::list_item_last)->disabled = (global::tl_edit == null_);
				list_item_add(text_get({ /*"toolbareditshowhidden"*/ STR(1602) }), false, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_SHOW_HIDDEN))->keybind), null_, icons_VISIBLE, null_, ID_action_tl_hide_select);
				ObjType(obj_list_item, global::list_item_last)->disabled = (global::tl_edit == null_);
				list_item_add(text_get({ /*"toolbareditpreferences"*/ STR(1603) }), sInt(settings), /*""*/ STR(0), null_, icons_SETTINGS, null_, (ObjType(obj_tab, sInt(settings))->show > 0) ? ID_tab_close : ID_tab_show, true);
				ObjType(obj_list_item, global::list_item_last)->toggled = ObjType(obj_tab, sInt(settings))->show;
				break;
			}
			
			case 1604: // toolbarrender
			{
				list_item_add(text_get({ /*"toolbarrenderimage"*/ STR(1605) }), null_, /*""*/ STR(0), null_, icons_IMAGE_EXPORT, null_, ID_action_toolbar_export_image);
				list_item_add(text_get({ /*"toolbarrenderanimation"*/ STR(1606) }), null_, /*""*/ STR(0), null_, icons_MOVIE_EXPORT, null_, ID_action_toolbar_export_movie);
				break;
			}
			
			case 1607: // toolbarview
			{
				if (sStr(window_state) == /*""*/ STR(0))
				{
					list_item_add(text_get({ /*"toolbarviewreset"*/ STR(1608) }), null_, /*""*/ STR(0), null_, icons_CAMERA, null_, ID_camera_work_reset);
					list_item_add(text_get({ /*"toolbarviewsecondaryview"*/ STR(1609) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_SECONDARY_VIEW))->keybind), null_, icons_VIEWPORT_SECONDARY, null_, ID_action_setting_secondary_view);
					ObjType(obj_list_item, global::list_item_last)->toggled = ObjType(obj_view, sInt(view_second))->show;
					list_item_add(text_get({ /*"toolbarviewtimelineshowmarkers"*/ STR(1610) }), null_, /*""*/ STR(0), null_, icons_MARKER, null_, ID_action_setting_timeline_show_markers);
					...
					list_item_add(text_get({ /*"toolbarviewtimelineplayback"*/ STR(1611) }), null_, /*""*/ STR(0), null_, icons_CLOCK, icons_CHEVRON_RIGHT_TINY, null_);
					ObjType(obj_list_item, global::list_item_last)->context_menu_name = /*"toolbarviewtimelineplayback"*/ STR(1611);
				}
				list_item_add(text_get({ /*"toolbarviewshortcutsbar"*/ STR(1612) }), null_, /*""*/ STR(0), null_, icons_KEYBOARD, null_, ID_action_setting_shortcuts_bar, true);
				ObjType(obj_list_item, global::list_item_last)->toggled = sBool(setting_show_shortcuts_bar);
				list_item_add(text_get({ /*"toolbarviewhome"*/ STR(1613) }), null_, /*""*/ STR(0), null_, icons_HOME, null_, ID_action_setting_home_screen, true);
				break;
			}
			
			case 1611: // toolbarviewtimelineplayback
			{
				list_item_add(text_get({ /*"toolbarviewtimelineplaybacktimeseconds"*/ STR(1614) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_setting_timeline_display_time);
				ObjType(obj_list_item, global::list_item_last)->toggled = !(sReal(timeline_show_frames) > 0);
				ObjType(obj_list_item, global::list_item_last)->divider = true;
				list_item_add(text_get({ /*"toolbarviewtimelineplaybacktimeframes"*/ STR(1615) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_setting_timeline_display_frames);
				ObjType(obj_list_item, global::list_item_last)->toggled = sReal(timeline_show_frames);
				break;
			}
			
			case 1616: // toolbarhelp
			{
				list_item_add(text_get({ /*"toolbarhelpabout"*/ STR(1617) }), sInt(popup_about), /*""*/ STR(0), null_, icons_INFO, null_, ID_popup_show);
				if (global::trial_version > 0)
					list_item_add(text_get({ /*"toolbarhelpupgrade"*/ STR(1618) }), sInt(popup_upgrade), /*""*/ STR(0), null_, icons_KEY, null_, ID_popup_show);
				list_item_add(text_get({ /*"toolbarhelptutorials"*/ STR(1619) }), link_tutorials, /*""*/ STR(0), null_, icons_TUTORIALS, null_, ID_popup_open_url);
				list_item_add(text_get({ /*"toolbarhelpreport"*/ STR(1620) }), link_forums_bugs, /*""*/ STR(0), null_, icons_BUG, null_, ID_popup_open_url, true);
				list_item_add(text_get({ /*"toolbarhelpforums"*/ STR(1621) }), link_forums, /*""*/ STR(0), null_, icons_COMMENTS, null_, ID_popup_open_url);
				break;
			}
			
			case 1103: // keybind
			{
				list_item_add(text_get({ /*"contextmenurestorekeybind"*/ STR(1622) }), sVar(context_menu_value), /*""*/ STR(0), null_, icons_RESET, null_, ID_keybind_restore);
				break;
			}
	...
	void marker_editor_draw(ScopeAny self)
	{
		...
		if (draw_textfield(self, /*"timelinemarkerlabel"*/ STR(1708), sVar(dx), sVar(dy), sVar(settings_menu_w) - IntType(24), IntType(24), idInt(sVar(timeline), tbx_marker_name), null_))
		...
		tab_next(self);
		VarType text, color;
		text = text_get({ /*"timelinemarkercolor"*/ STR(1502) + string(idVar(sVar(timeline_marker_edit), color)) });
		color = ObjType(obj_theme, sInt(setting_theme))->accent_list.Value(idVar(sVar(timeline_marker_edit), color));
		tab_control_menu(self);
		draw_button_menu(self, { /*"timelinemarkercolor"*/ STR(1502), e_menu_LIST, sVar(dx), sVar(dy), sVar(settings_menu_w) - IntType(24), IntType(24), idVar(sVar(timeline_marker_edit), color), text, ID_action_tl_marker_color, false, ID_spr_16, null_, /*""*/ STR(0), color, IntType(1) });
		tab_next(self);
	...
	void math_lib_startup(StringType path)
	{
		...
		global::lib_math_simplex1d = external_define({ path, /*"simplex1D"*/ STR(1709), dll_cdecl, ty_real, IntType(1), ty_real });
		global::lib_math_simplex2d = external_define({ path, /*"simplex2D"*/ STR(1710), dll_cdecl, ty_real, IntType(2), ty_real, ty_real });
		global::lib_math_simplex3d = external_define({ path, /*"simplex3D"*/ STR(1711), dll_cdecl, ty_real, IntType(3), ty_real, ty_real, ty_real });
		global::lib_math_simplex4d = external_define({ path, /*"simplex4D"*/ STR(1712), dll_cdecl, ty_real, IntType(4), ty_real, ty_real, ty_real, ty_real });
	}
	...
	RealType menu_add_timeline(VarType tl, RealType level, VarType menu)
	{
		if (tl == global::tl_edit && !ObjType(obj_menu, menu)->menu_include_tl_edit)
			return IntType(0);
		if (tl == null_)
			list_item_add(text_get({ /*"timelinenone"*/ STR(1713) }), tl);
		else
		{
			list_item_add(string_remove_newline(idVar(tl, display_name)), tl);
			if (ds_list_size(idInt(tl, tree_list)))
				list_item_add_action(global::list_item_last, string(tl) + /*"extend"*/ STR(1714), ID_menu_item_set_extend, idVar(tl, tree_extend), tl, null_, /*"left"*/ STR(189), (idVar(tl, tree_extend) > 0) ? /*"tooltiptlcollapse"*/ STR(1715) : /*"tooltiptlexpand"*/ STR(1716), ID_spr_chevron_ani);
		}
	...
	IntType menu_biome_init(ScopeAny self, VarType menu)
	{
		...
		for (IntType b = IntType(0); b < ds_list_size(global::biome_list); b++)
		{
			...
			{
				list_item_add_action(global::list_item_last, string(biome) + /*"extend"*/ STR(1714), ID_menu_item_set_extend, ObjType(obj_biome, biome)->variants_extend, biome, null_, /*"left"*/ STR(189), (ObjType(obj_biome, biome)->variants_extend > 0) ? /*"tooltiptlcollapse"*/ STR(1715) : /*"tooltiptlexpand"*/ STR(1716), ID_spr_chevron_ani);
				if (ObjType(obj_biome, biome)->variants_extend > 0)
				{
					...
					{
						if (ObjType(obj_biome, DsList(ObjType(obj_biome, biome)->biome_variants).Value(v))->name == /*"normal"*/ STR(641))
							continue;
	...
	void menu_draw(ScopeAny self)
	{
		...
		for (IntType i = IntType(0); i < ds_list_size(sInt(menu_list)); i++)
		{
			...
			if (ObjType(obj_menu, m)->menu_window != window_get_current())
				continue;
			if (ObjType(obj_menu, m)->menu_ani_type == /*"hide"*/ STR(758))
			{
				...
				if (ObjType(obj_menu, m)->menu_ani_type == /*"show"*/ STR(759))
				{
					ObjType(obj_menu, m)->menu_ani += test_reduced_motion(IntType(1), (0.06 * global::delta));
			...
			if (ObjType(obj_menu, m)->menu_steps == IntType(0))
				draw_set_alpha(0.0);
			ObjType(obj_menu, m)->menu_ani_ease = ease(((ObjType(obj_menu, m)->menu_ani_type == /*"show"*/ STR(759)) ? /*"easeoutexpo"*/ STR(562) : /*"easeinexpo"*/ STR(561)), ObjType(obj_menu, m)->menu_ani);
			...
			if (sVar(window_busy) == /*"menu"*/ STR(1091) && ObjType(obj_menu, m)->menu_ani_type != /*"hide"*/ STR(758) && menu_active)
			...
			if (!(ObjType(obj_scrollbar, ObjType(obj_menu, m)->menu_scroll_vertical)->needed && ObjType(obj_scrollbar, ObjType(obj_menu, m)->menu_scroll_vertical)->mouseon) && !(ObjType(obj_scrollbar, ObjType(obj_menu, m)->menu_scroll_horizontal)->needed && ObjType(obj_scrollbar, ObjType(obj_menu, m)->menu_scroll_horizontal)->mouseon) && sBool(mouse_left_released) && menu_active && ObjType(obj_menu, m)->menu_ani_type != /*"hide"*/ STR(758))
			{
				...
				{
					ObjType(obj_menu, m)->menu_ani = IntType(1);
					ObjType(obj_menu, m)->menu_ani_type = /*"hide"*/ STR(758);
					sVar(window_busy) = (ds_list_size(sInt(menu_list)) > IntType(1) ? /*"menu"*/ STR(1091) : ObjType(obj_menu, m)->menu_busy_prev);
				}
			}
			if (ObjType(obj_menu, m)->menu_steps == IntType(0))
				draw_set_alpha(1.0);
			ObjType(obj_menu, m)->menu_steps++;
			if (sVar(window_busy) == /*""*/ STR(0) && ObjType(obj_menu, m)->menu_ani_type != /*"hide"*/ STR(758) && menu_active)
				sVar(window_busy) = /*"menu"*/ STR(1091);
		}
