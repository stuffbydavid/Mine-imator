...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3764) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3765) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3766))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3767) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3766))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3766))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3768))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3769))
		{
			sInt(mouse_cursor) = cr_size_ns;
