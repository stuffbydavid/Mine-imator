...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3772) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3773) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3774))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3775) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3774))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3774))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3776))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3777))
		{
			sInt(mouse_cursor) = cr_size_ns;
