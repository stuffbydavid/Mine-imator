...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3828) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3829) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3830))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3831) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3830))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3830))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3832))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3833))
		{
			sInt(mouse_cursor) = cr_size_ns;
