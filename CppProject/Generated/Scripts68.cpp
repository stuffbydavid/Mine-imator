...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3761) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3762) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3763))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3764) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3763))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3763))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3765))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3766))
		{
			sInt(mouse_cursor) = cr_size_ns;
