...
namespace CppProject
{
	...
	VarType block_load_model_file_texture(Scope<obj_block_load_model_file> self, VarType name, IntType res)
	{
		...
		if (!file_exists_lib(fn))
			fn = global::load_folder + /*"/"*/ STR(20) + string_replace(name, /*"blocks/"*/ STR(827), /*""*/ STR(0)) + /*".png"*/ STR(10);
		if (!file_exists_lib(fn))
			fn = global::load_folder + /*"/"*/ STR(20) + string_replace(name, /*"block/"*/ STR(793), /*""*/ STR(0)) + /*".png"*/ STR(10);
		if (!file_exists_lib(fn))
