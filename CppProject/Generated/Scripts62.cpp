...
namespace CppProject
{
	void tab_timeline_editor_appearance(ScopeAny self)
	{
		if (idVar(global::tl_edit, type) != e_tl_type_POINT_LIGHT && idVar(global::tl_edit, type) != e_tl_type_SPOT_LIGHT)
		{
			...
			draw_button_collapse(self, /*"tl_glint"*/ STR(161), DsMap(global::collapse_map).Value(/*"tl_glint"*/ STR(161)), null_, true, /*"timelineeditorglint"*/ STR(3755));
			tab_next(self);
			if (DsMap(global::collapse_map).Value(/*"tl_glint"*/ STR(161)) > 0)
			{
				...
				draw_button_menu(self, { /*"timelineeditorglinttex"*/ STR(1537), e_menu_LIST, sVar(dx), sVar(dy), sVar(dw), sReal(ui_large_height), idVar(global::tl_edit, glint_tex), idVar(idVar(global::tl_edit, glint_tex), display_name), ID_action_tl_glint_tex, false, tex });
				tab_next(self);
				tab_control_togglebutton(self);
				togglebutton_add(self, { /*"timelineeditorglintmodenone"*/ STR(3756), null_, e_glint_NONE, idVar(global::tl_edit, glint_mode) == e_glint_NONE, ID_action_tl_glint_mode });
				togglebutton_add(self, { /*"timelineeditorglintmodeitem"*/ STR(3757), null_, e_glint_ITEM, idVar(global::tl_edit, glint_mode) == e_glint_ITEM, ID_action_tl_glint_mode });
				togglebutton_add(self, { /*"timelineeditorglintmodeentity"*/ STR(3758), null_, e_glint_ENTITY, idVar(global::tl_edit, glint_mode) == e_glint_ENTITY, ID_action_tl_glint_mode });
				draw_togglebutton(self, /*"timelineeditorglintmode"*/ STR(3759), sVar(dx), sVar(dy));
				tab_next(self);
				tab_control_dragger(self);
				draw_dragger(self, /*"timelineeditorglintscale"*/ STR(3760), sVar(dx), sVar(dy), dragger_width, round(idVar(global::tl_edit, glint_scale) * IntType(100)), idVar(global::tl_edit, glint_scale), IntType(1), no_limit, IntType(100), IntType(1), ObjType(obj_category, idInt(sVar(tab), appearance))->tbx_glint_scale, ID_action_tl_glint_scale);
				tab_next(self);
				tab_collapse_end(self);
			}
			sVar(dy) += IntType(8);
			tab_control_menu(self);
			draw_button_menu(self, { /*"timelineeditorblendmode"*/ STR(1498), e_menu_LIST, sVar(dx), sVar(dy), sVar(dw), IntType(24), idVar(global::tl_edit, blend_mode), text_get({ /*"timelineeditorblendmode"*/ STR(1498) + idVar(global::tl_edit, blend_mode) }), ID_action_tl_blend_mode });
			tab_next(self);
			VarType text;
			if (idVar(global::tl_edit, alpha_mode) == e_alpha_mode_BLEND)
				text = text_get({ /*"renderalphamodeblend"*/ STR(1521) });
			else
				if (idVar(global::tl_edit, alpha_mode) == e_alpha_mode_HASHED)
					text = text_get({ /*"renderalphamodehashed"*/ STR(1520) });
				else
					text = text_get({ /*"renderalphamodedefault"*/ STR(1519) });
			
			
			tab_control_menu(self);
			draw_button_menu(self, { /*"timelineeditoralphamode"*/ STR(1518), e_menu_LIST, sVar(dx), sVar(dy), sVar(dw), IntType(24), idVar(global::tl_edit, alpha_mode), text, ID_action_tl_alpha_mode });
			tab_next(self);
			tab_control_dragger(self);
			draw_dragger(self, /*"timelineeditordepth"*/ STR(3761), sVar(dx), sVar(dy), dragger_width, idVar(global::tl_edit, depth), 0.1, -no_limit, no_limit, IntType(0), IntType(1), ObjType(obj_category, idInt(sVar(tab), appearance))->tbx_depth, ID_action_tl_depth);
			tab_next(self);
			tab_set_collumns(self, { true, floor((RealType)sVar(content_width) / 150.0) });
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditortextureblur"*/ STR(3762), sVar(dx), sVar(dy), idVar(global::tl_edit, texture_blur), ID_action_tl_texture_blur);
			tab_next(self);
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditortexturefiltering"*/ STR(3763), sVar(dx), sVar(dy), idVar(global::tl_edit, texture_filtering), ID_action_tl_texture_filtering);
			tab_next(self);
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorshadows"*/ STR(3764), sVar(dx), sVar(dy), idVar(global::tl_edit, shadows), ID_action_tl_shadows);
			tab_next(self);
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorssao"*/ STR(3765), sVar(dx), sVar(dy), idVar(global::tl_edit, ssao), ID_action_tl_ssao);
			tab_next(self);
			if (type_has_wind(idVar(global::tl_edit, type)))
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorwind"*/ STR(3766), sVar(dx), sVar(dy), idVar(global::tl_edit, wind), ID_action_tl_wind);
				tab_next(self);
				if (idVar(global::tl_edit, type) != e_temp_type_TEXT && !type_is_shape(idVar(global::tl_edit, type)))
				{
					tab_control_checkbox(self);
					draw_checkbox(self, /*"timelineeditorwindterrain"*/ STR(3767), sVar(dx), sVar(dy), idVar(global::tl_edit, wind_terrain), ID_action_tl_wind_terrain);
					tab_next(self);
				}
			}
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorglow"*/ STR(3768), sVar(dx), sVar(dy), idVar(global::tl_edit, glow), ID_action_tl_glow);
			tab_next(self);
			if (idVar(global::tl_edit, glow) > 0)
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorglowtexture"*/ STR(3769), sVar(dx), sVar(dy), idVar(global::tl_edit, glow_texture), ID_action_tl_glow_texture);
				tab_next(self);
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditoronlyrenderglow"*/ STR(3770), sVar(dx), sVar(dy), idVar(global::tl_edit, only_render_glow), ID_action_tl_only_render_glow);
				tab_next(self);
			}
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorfog"*/ STR(3771), sVar(dx), sVar(dy), idVar(global::tl_edit, fog), ID_action_tl_fog);
			tab_next(self);
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorbackfaces"*/ STR(3772), sVar(dx), sVar(dy), idVar(global::tl_edit, backfaces), ID_action_tl_backfaces);
			tab_next(self);
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorhqhiding"*/ STR(3773), sVar(dx), sVar(dy), idVar(global::tl_edit, hq_hiding), ID_action_tl_hq_hiding);
			tab_next(self);
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorlqhiding"*/ STR(3774), sVar(dx), sVar(dy), idVar(global::tl_edit, lq_hiding), ID_action_tl_lq_hiding);
			tab_next(self);
		...
		{
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorrendershadows"*/ STR(3775), sVar(dx), sVar(dy), idVar(global::tl_edit, shadows), ID_action_tl_shadows);
			tab_next(self);
		}
	...
	void tab_timeline_editor_audio(ScopeAny self)
	{
		...
		draw_button_label(self, /*"timelineeditoraudioadd"*/ STR(3776), floor(sVar(dx) + (RealType)sVar(dw) / 2.0), sVar(dy), null_, null_, e_button_PRIMARY, ID_action_tl_add_sound, e_anchor_CENTER);
		tab_next(self);
	}
	...
	RealType tab_timeline_editor_hierarchy(ScopeAny self)
	{
		...
		if (idVar(global::tl_edit, part_of) == null_)
		{
			...
			if (par == global::_app->id)
				text = text_get({ /*"timelinenone"*/ STR(1718) });
			else
				text = string_remove_newline(idVar(par, display_name));
			
			tab_control_menu(self);
			draw_button_menu(self, { /*"timelineeditorparent"*/ STR(1094), e_menu_TIMELINE, sVar(dx), sVar(dy), sVar(dw), IntType(24), par, text, ID_action_tl_parent });
			tab_next(self);
			...
			{
				ArrType partname = ArrType::From({ /*"right"*/ STR(192), /*"left"*/ STR(191), /*"front"*/ STR(899), /*"back"*/ STR(901), /*"upper"*/ STR(933), /*"lower"*/ STR(1873) });
				tab_control_switch(self);
				draw_switch(self, /*"timelineeditorlockbend"*/ STR(3777) + partname.Value(idInt(idVar(par, model_part), bend_part)), sVar(dx), sVar(dy), idVar(global::tl_edit, lock_bend), ID_action_tl_lock_bend);
				tab_next(self);
			}
		}
		if (par != global::_app->id)
		{
			...
			draw_label(self, { text_get({ /*"timelineeditorinherit"*/ STR(3778) }), sVar(dx), sVar(dy) + IntType(10), fa_left, fa_middle, global::c_text_secondary, global::a_text_secondary });
			tab_next(self);
			tab_set_collumns(self, { true, floor((RealType)sVar(content_width) / 150.0) });
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorinheritposition"*/ STR(3779), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_position), ID_action_tl_inherit_position);
			tab_next(self);
			if (idArr(global::tl_edit, value_type).Value(e_value_type_TRANSFORM_ROT))
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritrotation"*/ STR(3780), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_rotation), ID_action_tl_inherit_rotation);
				tab_next(self);
			}
			if (idArr(global::tl_edit, value_type).Value(e_value_type_ROT_POINT) && sReal(setting_advanced_mode) > 0)
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritrotpoint"*/ STR(3781), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_rot_point), ID_action_tl_inherit_rot_point);
				tab_next(self);
			}
			if (idArr(global::tl_edit, value_type).Value(e_value_type_TRANSFORM_SCA))
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritscale"*/ STR(3782), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_scale), ID_action_tl_inherit_scale);
				tab_next(self);
			}
			if (idArr(global::tl_edit, value_type).Value(e_value_type_MATERIAL_COLOR))
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritopacity"*/ STR(3783), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_alpha), ID_action_tl_inherit_alpha);
				tab_next(self);
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritcolor"*/ STR(3784), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_color), ID_action_tl_inherit_color);
				tab_next(self);
			}
			tab_control_checkbox(self);
			draw_checkbox(self, /*"timelineeditorinheritvisibility"*/ STR(3785), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_visibility), ID_action_tl_inherit_visibility);
			tab_next(self);
			if (idArr(global::tl_edit, value_type).Value(e_value_type_TRANSFORM_BEND) && sReal(setting_advanced_mode) > 0)
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritbend"*/ STR(3786), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_bend), ID_action_tl_inherit_bend);
				tab_next(self);
			}
			if (idArr(global::tl_edit, value_type).Value(e_value_type_MATERIAL_TEXTURE))
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinherittexture"*/ STR(3787), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_texture), ID_action_tl_inherit_texture);
				tab_next(self);
			}
			if (idArr(global::tl_edit, value_type).Value(e_value_type_MATERIAL) && sReal(setting_advanced_mode) > 0)
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritsurface"*/ STR(3788), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_surface), ID_action_tl_inherit_surface);
				tab_next(self);
			}
			if (idArr(global::tl_edit, value_type).Value(e_value_type_MATERIAL) && sReal(setting_advanced_mode) > 0)
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritsubsurface"*/ STR(3789), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_subsurface), ID_action_tl_inherit_subsurface);
				tab_next(self);
			}
			...
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritglowcolor"*/ STR(3790), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_glow_color), ID_action_tl_inherit_glow_color);
				tab_next(self);
			}
			if (sReal(setting_advanced_mode) > 0)
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritselect"*/ STR(3791), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_select), ID_action_tl_inherit_select);
				tab_next(self);
			}
			if ((idVar(global::tl_edit, type) == e_tl_type_CHARACTER || idVar(global::tl_edit, type) == e_tl_type_SPECIAL_BLOCK) && (idVar(par, type) == e_tl_type_CHARACTER || idVar(par, type) == e_tl_type_SPECIAL_BLOCK))
			{
				tab_control_checkbox(self);
				draw_checkbox(self, /*"timelineeditorinheritpose"*/ STR(3792), sVar(dx), sVar(dy), idVar(global::tl_edit, inherit_pose), ID_action_tl_inherit_pose, /*"timelineeditorinheritposehelp"*/ STR(3793));
				tab_next(self);
			}
			tab_set_collumns(self, { false });
			...
			{
				tab_control_togglebutton(self);
				togglebutton_add(self, { /*"timelineeditorscalemoderesize"*/ STR(3794), null_, IntType(1), idVar(global::tl_edit, scale_resize) == IntType(1), ID_action_tl_scale_resize });
				togglebutton_add(self, { /*"timelineeditorscalemodestretch"*/ STR(3795), null_, IntType(0), idVar(global::tl_edit, scale_resize) == IntType(0), ID_action_tl_scale_resize });
				draw_togglebutton(self, /*"timelineeditorscalemode"*/ STR(3796), sVar(dx), sVar(dy));
				tab_next(self);
			}
		}
		return 0.0;
	...
	void tab_timeline_editor_info(ScopeAny self)
	{
		...
		draw_textfield(self, /*"timelineeditorname"*/ STR(3797), sVar(dx), sVar(dy), sVar(dw), IntType(24), ObjType(obj_category, idInt(sVar(tab), info))->tbx_name, ID_action_tl_name, string_remove_newline(idVar(global::tl_edit, display_name)), /*"top"*/ STR(190));
		tab_next(self);
		if (idVar(global::tl_edit, type) == e_temp_type_TEXT)
		{
			...
			draw_textfield(self, /*"timelineeditortext"*/ STR(3212), sVar(dx), sVar(dy), sVar(dw), IntType(76), ObjType(obj_category, idInt(sVar(tab), info))->tbx_text, ID_action_tl_text, /*""*/ STR(0), /*"top"*/ STR(190));
			tab_next(self);
		}
		tab_control(self, sReal(ui_small_height));
		draw_label_value(self, sVar(dx), sVar(dy), sVar(dw), sReal(ui_small_height), text_get({ /*"timelineeditortype"*/ STR(3798) }), string_remove_newline(idVar(global::tl_edit, type_name)));
		tab_next(self);
		if (idArr(global::tl_edit, value_type).Value(e_value_type_ROT_POINT) && sReal(setting_advanced_mode) > 0)
		{
			tab_control_switch(self);
			draw_switch(self, /*"timelineeditorrotpointcustom"*/ STR(3799), sVar(dx), sVar(dy), idVar(global::tl_edit, rot_point_custom), ID_action_tl_rotpoint_custom);
			tab_next(self);
			if (idVar(global::tl_edit, rot_point_custom) > 0)
			{
				...
				global::axis_edit = X_;
				textfield_group_add(self, { /*"timelineeditorrotpointx"*/ STR(3800), idVar(global::tl_edit, rot_point).Value(global::axis_edit), def.Value(global::axis_edit), ID_action_tl_rotpoint, global::axis_edit, ObjType(obj_category, idInt(sVar(tab), info))->tbx_rot_point_x });
				global::axis_edit = ((sReal(setting_z_is_up) > 0) ? Y_ : Z_);
				textfield_group_add(self, { /*"timelineeditorrotpointy"*/ STR(3801), idVar(global::tl_edit, rot_point).Value(global::axis_edit), def.Value(global::axis_edit), ID_action_tl_rotpoint, global::axis_edit, ObjType(obj_category, idInt(sVar(tab), info))->tbx_rot_point_y });
				global::axis_edit = ((sReal(setting_z_is_up) > 0) ? Z_ : Y_);
				textfield_group_add(self, { /*"timelineeditorrotpointz"*/ STR(3802), idVar(global::tl_edit, rot_point).Value(global::axis_edit), def.Value(global::axis_edit), ID_action_tl_rotpoint, global::axis_edit, ObjType(obj_category, idInt(sVar(tab), info))->tbx_rot_point_z });
				sInt(context_menu_group_temp) = e_context_group_ROT_POINT;
				tab_control_textfield_group(self, false);
				draw_textfield_group(self, /*"timelineeditorrotpoint"*/ STR(3803), sVar(dx), sVar(dy), sVar(dw), mul, -no_limit, no_limit, snapval, false, true, IntType(1));
				tab_next(self);
	...
	{
		tab_control_button_label(self);
		draw_button_label(self, /*"timelineeditorpathpointadd"*/ STR(3804), floor(sVar(dx) + (RealType)sVar(dw) / 2.0), sVar(dy), null_, icons_PATH_POINT, e_button_PRIMARY, ID_action_tl_path_point_add, fa_middle);
		tab_next(self);
		tab_control_switch(self);
		draw_switch(self, /*"timelineeditorpathclosed"*/ STR(3805), sVar(dx), sVar(dy), idVar(global::tl_edit, path_closed), ID_action_tl_path_closed);
		tab_next(self);
		tab_control_switch(self);
		draw_switch(self, /*"timelineeditorpathsmooth"*/ STR(3806), sVar(dx), sVar(dy), idVar(global::tl_edit, path_smooth), ID_action_tl_path_smooth);
		tab_next(self);
		tab_control_dragger(self);
		draw_dragger(self, /*"timelineeditorpathdetail"*/ STR(3807), sVar(dx), sVar(dy), dragger_width, idVar(global::tl_edit, path_detail), 1.0 / 4.0, IntType(1), no_limit, IntType(6), IntType(1), ObjType(obj_category, idInt(sVar(tab), path))->tbx_detail, ID_action_tl_path_detail, null_, true, false, /*"timelineeditorpathdetailtip"*/ STR(3808));
		tab_next(self);
		tab_control_switch(self);
		draw_button_collapse(self, /*"path_shape"*/ STR(142), DsMap(global::collapse_map).Value(/*"path_shape"*/ STR(142)), ID_action_tl_path_shape_generate, idVar(global::tl_edit, path_shape_generate), /*"timelineeditorpathshape"*/ STR(3809));
		tab_next(self);
		if (DsMap(global::collapse_map).Value(/*"path_shape"*/ STR(142)) > 0 && idVar(global::tl_edit, path_shape_generate) > 0)
		{
			tab_collapse_start(self);
			tab_control_dragger(self);
			draw_dragger(self, /*"timelineeditorpathshaperadius"*/ STR(3810), sVar(dx), sVar(dy), dragger_width, idVar(global::tl_edit, path_shape_radius), 0.1, 0.01, no_limit, IntType(8), 0.01, ObjType(obj_category, idInt(sVar(tab), path))->tbx_radius, ID_action_tl_path_shape_radius);
			tab_next(self);
			tab_control_dragger(self);
			draw_dragger(self, /*"timelineeditorpathshapetexlength"*/ STR(3811), sVar(dx), sVar(dy), dragger_width, idVar(global::tl_edit, path_shape_tex_length), 0.1, 0.01, no_limit, IntType(16), 0.01, ObjType(obj_category, idInt(sVar(tab), path))->tbx_tex_length, ID_action_tl_path_shape_tex_length, null_, true, false, /*"timelineeditorpathshapetexlengthtip"*/ STR(3812));
			tab_next(self);
			tab_control_switch(self);
			draw_switch(self, /*"timelineeditorpathshapeinvert"*/ STR(3813), sVar(dx), sVar(dy), idVar(global::tl_edit, path_shape_invert), ID_action_tl_path_shape_invert);
			tab_next(self);
			tab_control_switch(self);
			draw_switch(self, /*"timelineeditorpathshapesmoothsegments"*/ STR(3814), sVar(dx), sVar(dy), idVar(global::tl_edit, path_shape_smooth_segments), ID_action_tl_path_shape_smooth_segments, /*"timelineeditorpathshapesmoothsegmentstip"*/ STR(3815));
			tab_next(self);
			tab_control_switch(self);
			draw_button_collapse(self, /*"path_shape_tube"*/ STR(143), DsMap(global::collapse_map).Value(/*"path_shape_tube"*/ STR(143)), ID_action_tl_path_shape_tube, idVar(global::tl_edit, path_shape_tube), /*"timelineeditorpathshapetube"*/ STR(3816));
			tab_next(self);
			if (DsMap(global::collapse_map).Value(/*"path_shape_tube"*/ STR(143)) > 0 && idVar(global::tl_edit, path_shape_tube) > 0)
			{
				tab_collapse_start(self);
				tab_control_dragger(self);
				draw_dragger(self, /*"timelineeditorpathshapedetail"*/ STR(3817), sVar(dx), sVar(dy), dragger_width, idVar(global::tl_edit, path_shape_detail), 1.0 / 4.0, IntType(3), no_limit, IntType(6), IntType(1), ObjType(obj_category, idInt(sVar(tab), path))->tbx_shape_detail, ID_action_tl_path_shape_detail);
				tab_next(self);
				tab_control_switch(self);
				draw_switch(self, /*"timelineeditorpathshapesmoothring"*/ STR(3818), sVar(dx), sVar(dy), idVar(global::tl_edit, path_shape_smooth_ring), ID_action_tl_path_shape_smooth_ring, /*"timelineeditorpathshapesmoothringtip"*/ STR(3819));
				tab_next(self);
				tab_collapse_end(self);
			}
			tab_control_button_label(self);
			if (draw_button_label(self, /*"timelineeditorpathshapesavemap"*/ STR(3820), sVar(dx), sVar(dy), sVar(dw), icons_TEXTURE_EXPORT, e_button_SECONDARY))
			{
				StringType fn = file_dialog_save_image(/*"path"*/ STR(530));
				if (fn != /*""*/ STR(0))
	...
	void temp_event_create(ScopeAny self)
	{
		...
		array_add(VarType::CreateRef(sArr(armor_array)), ArrType::From({ /*"none"*/ STR(919), hex_to_color(/*"#A06540"*/ STR(2029)), /*"none"*/ STR(919), /*"none"*/ STR(919) }));
		array_add(VarType::CreateRef(sArr(armor_array)), ArrType::From({ /*"none"*/ STR(919), hex_to_color(/*"#A06540"*/ STR(2029)), /*"none"*/ STR(919), /*"none"*/ STR(919) }));
		array_add(VarType::CreateRef(sArr(armor_array)), ArrType::From({ /*"none"*/ STR(919), hex_to_color(/*"#A06540"*/ STR(2029)), /*"none"*/ STR(919), /*"none"*/ STR(919) }));
		array_add(VarType::CreateRef(sArr(armor_array)), ArrType::From({ /*"none"*/ STR(919), hex_to_color(/*"#A06540"*/ STR(2029)), /*"none"*/ STR(919), /*"none"*/ STR(919) }));
