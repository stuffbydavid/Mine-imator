...
namespace CppProject
{
	...
	RealType window_draw_export(ScopeAny self)
	{
		...
		VarType text = /*""*/ STR(0);
		if (sStr(window_state) == /*"export_movie"*/ STR(53))
			text = text_get({ /*"exportframe"*/ STR(3953), string(sReal(exportmovie_frame)), string(totalframes) }) + ((usesamples > 0) ? (/*" ("*/ STR(1112) + samplecount + /*")"*/ STR(1088)) : /*""*/ STR(0));
		else
			if (usesamples > 0)
				text = samplecount;
	...
	RealType window_draw_load_assets(ScopeAny self)
	{
		...
		if (global::load_assets_stage == /*"done"*/ STR(1727))
		{
