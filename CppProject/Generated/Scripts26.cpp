...
namespace CppProject
{
	...
	void colorpicker_draw(ScopeAny self)
	{
		...
		if (app_mouse_box(self, bx, by, bw, bh))
		{
			...
			if (sBool(mouse_left))
				sVar(window_busy) = /*"colorpickersatbripick"*/ STR(1008);
		}
		if (sVar(window_busy) == /*"colorpickersatbripick"*/ STR(1008))
		{
			if (!sBool(mouse_left))
			{
		...
		if (app_mouse_box(self, bx - IntType(8), by, bw + IntType(16), bh))
		{
			sInt(mouse_cursor) = cr_handpoint;
			if (sBool(mouse_left))
				sVar(window_busy) = /*"colorpickerhuepick"*/ STR(1009);
		}
		if (sVar(window_busy) == /*"colorpickerhuepick"*/ STR(1009))
		{
			if (!sBool(mouse_left))
			{
				sVar(window_busy) = /*""*/ STR(0);
		...
		togglebutton_add(self, { /*"colorpickerrgb"*/ STR(1010), null_, /*"rgb"*/ STR(1011), ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"rgb"*/ STR(1011), ID_colorpicker_set_mode });
		togglebutton_add(self, { /*"colorpickerhsv"*/ STR(1012), null_, /*"hsv"*/ STR(1013), ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"hsv"*/ STR(1013), ID_colorpicker_set_mode });
		togglebutton_add(self, { /*"colorpickerhex"*/ STR(1014), null_, /*"hex"*/ STR(1015), ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"hex"*/ STR(1015), ID_colorpicker_set_mode });
		draw_togglebutton(self, /*"colorpickermode"*/ STR(1016), sVar(dx), sVar(dy), true, false);
		tab_next(self);
		if (ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"rgb"*/ STR(1011))
		{
			textfield_group_add(self, { /*"colorpickerr"*/ STR(1017), color_get_red((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color)), color_get_red((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def)), ID_colorpicker_red, X_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_red });
			textfield_group_add(self, { /*"colorpickerg"*/ STR(1018), color_get_green((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color)), color_get_green((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def)), ID_colorpicker_green, Y_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_green });
			textfield_group_add(self, { /*"colorpickerb"*/ STR(1019), color_get_blue((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color)), color_get_blue((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def)), ID_colorpicker_blue, Z_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_blue });
			if (draw_textfield_group(self, /*"colorpickerrgb"*/ STR(1010), sVar(dx), sVar(dy), IntType(176), IntType(1), IntType(0), IntType(255), IntType(1), false, false, IntType(3), true, false))
			{
			...
			if (ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"hsv"*/ STR(1013))
			{
				textfield_group_add(self, { /*"colorpickerh"*/ STR(1020), floor(color_get_hue((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color))), floor(color_get_hue((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def))), ID_colorpicker_hue, X_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_hue });
				textfield_group_add(self, { /*"colorpickers"*/ STR(1021), floor(color_get_saturation((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color))), floor(color_get_saturation((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def))), ID_colorpicker_saturation, X_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_saturation });
				textfield_group_add(self, { /*"colorpickerv"*/ STR(1022), floor(color_get_value((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color))), floor(color_get_value((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def))), ID_colorpicker_brightness, X_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_brightness });
				VarType update = draw_textfield_group(self, /*"colorpickerhsv"*/ STR(1012), sVar(dx), sVar(dy), IntType(176), IntType(1), IntType(0), IntType(255), IntType(1), false, false, IntType(0), true, false);
				...
				if (ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"hex"*/ STR(1015))
				{
					if (draw_inputbox(self, { /*"colorpickerhex"*/ STR(1014), sVar(dx), sVar(dy), IntType(176), IntType(24), color_to_hex(ObjType(obj_colorpicker, sInt(colorpicker))->def), ObjType(obj_colorpicker, sInt(colorpicker))->tbx_hexadecimal, null_ }))
	...
	void colorpicker_show(ScopeAny self, VarType name, VarType color, VarType def, IntType script, VarType xx, VarType yy, VarType width, RealType height)
	{
		...
		else
		{
			...
			ObjType(obj_colorpicker, sInt(colorpicker))->mode = /*"rgb"*/ STR(1011);
	...
	void colorpicker_startup()
	{
		...
		withOne (obj_colorpicker, global::_app->colorpicker, global::_app->id)
		{
			...
			self->tbx_red = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1024));
			self->tbx_green = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1024));
			self->tbx_blue = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1024));
			self->tbx_hue = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1024));
			self->tbx_saturation = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1024));
			self->tbx_brightness = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1024));
			self->tbx_hexadecimal = new_textbox_hex();
			self->mode = /*"rgb"*/ STR(1011);
		}
