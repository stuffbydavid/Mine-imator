...
namespace CppProject
{
	...
	void colorpicker_draw(ScopeAny self)
	{
		...
		if (app_mouse_box(self, bx, by, bw, bh))
		{
			...
			if (sBool(mouse_left))
				sVar(window_busy) = /*"colorpickersatbripick"*/ STR(1041);
		}
		if (sVar(window_busy) == /*"colorpickersatbripick"*/ STR(1041))
		{
			if (!sBool(mouse_left))
			{
		...
		if (app_mouse_box(self, bx - IntType(8), by, bw + IntType(16), bh))
		{
			sInt(mouse_cursor) = cr_handpoint;
			if (sBool(mouse_left))
				sVar(window_busy) = /*"colorpickerhuepick"*/ STR(1042);
		}
		if (sVar(window_busy) == /*"colorpickerhuepick"*/ STR(1042))
		{
			if (!sBool(mouse_left))
			{
				sVar(window_busy) = /*""*/ STR(0);
		...
		togglebutton_add(self, { /*"colorpickerrgb"*/ STR(1043), null_, /*"rgb"*/ STR(1044), ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"rgb"*/ STR(1044), ID_colorpicker_set_mode });
		togglebutton_add(self, { /*"colorpickerhsv"*/ STR(1045), null_, /*"hsv"*/ STR(1046), ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"hsv"*/ STR(1046), ID_colorpicker_set_mode });
		togglebutton_add(self, { /*"colorpickerhex"*/ STR(1047), null_, /*"hex"*/ STR(1048), ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"hex"*/ STR(1048), ID_colorpicker_set_mode });
		draw_togglebutton(self, /*"colorpickermode"*/ STR(1049), sVar(dx), sVar(dy), true, false);
		tab_next(self);
		if (ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"rgb"*/ STR(1044))
		{
			textfield_group_add(self, { /*"colorpickerr"*/ STR(1050), color_get_red((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color)), color_get_red((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def)), ID_colorpicker_red, X_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_red });
			textfield_group_add(self, { /*"colorpickerg"*/ STR(1051), color_get_green((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color)), color_get_green((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def)), ID_colorpicker_green, Y_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_green });
			textfield_group_add(self, { /*"colorpickerb"*/ STR(1052), color_get_blue((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color)), color_get_blue((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def)), ID_colorpicker_blue, Z_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_blue });
			if (draw_textfield_group(self, /*"colorpickerrgb"*/ STR(1043), sVar(dx), sVar(dy), IntType(176), IntType(1), IntType(0), IntType(255), IntType(1), false, false, IntType(3), true, false))
			{
			...
			if (ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"hsv"*/ STR(1046))
			{
				textfield_group_add(self, { /*"colorpickerh"*/ STR(1053), floor(color_get_hue((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color))), floor(color_get_hue((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def))), ID_colorpicker_hue, X_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_hue });
				textfield_group_add(self, { /*"colorpickers"*/ STR(1054), floor(color_get_saturation((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color))), floor(color_get_saturation((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def))), ID_colorpicker_saturation, X_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_saturation });
				textfield_group_add(self, { /*"colorpickerv"*/ STR(1055), floor(color_get_value((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->color))), floor(color_get_value((IntType)(ObjType(obj_colorpicker, sInt(colorpicker))->def))), ID_colorpicker_brightness, X_, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_brightness });
				VarType update = draw_textfield_group(self, /*"colorpickerhsv"*/ STR(1045), sVar(dx), sVar(dy), IntType(176), IntType(1), IntType(0), IntType(255), IntType(1), false, false, IntType(0), true, false);
				...
				if (ObjType(obj_colorpicker, sInt(colorpicker))->mode == /*"hex"*/ STR(1048))
				{
					if (draw_inputbox(self, { /*"colorpickerhex"*/ STR(1047), sVar(dx), sVar(dy), IntType(176), IntType(24), color_to_hex(ObjType(obj_colorpicker, sInt(colorpicker))->def), ObjType(obj_colorpicker, sInt(colorpicker))->tbx_hexadecimal, null_ }))
					...
					if (ObjType(obj_textbox, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_hexadecimal)->text == /*""*/ STR(0) && sVar(window_focus) == /*""*/ STR(0))
						ObjType(obj_textbox, ObjType(obj_colorpicker, sInt(colorpicker))->tbx_hexadecimal)->text = /*"000000"*/ STR(639);
				}
	...
	{
		if (sStr(settings_menu_name) == /*"colorpicker"*/ STR(717) && ObjType(obj_colorpicker, sInt(colorpicker))->value_script == script)
			popup_close(self);
		else
		{
			...
			sStr(settings_menu_name) = /*"colorpicker"*/ STR(717);
			...
			ObjType(obj_colorpicker, sInt(colorpicker))->mode = /*"rgb"*/ STR(1044);
	...
	void colorpicker_startup()
	{
		...
		withOne (obj_colorpicker, global::_app->colorpicker, global::_app->id)
		{
			...
			self->tbx_red = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1057));
			self->tbx_green = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1057));
			self->tbx_blue = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1057));
			self->tbx_hue = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1057));
			self->tbx_saturation = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1057));
			self->tbx_brightness = new_textbox(IntType(1), IntType(3), /*"0123456789"*/ STR(1057));
			self->tbx_hexadecimal = new_textbox_hex();
			self->mode = /*"rgb"*/ STR(1044);
		}
	...
	RealType context_menu_area(ScopeAny self, VarArgs argument)
	{
		...
		if (app_mouse_box(self, xx, yy, wid, hei) && sBool(mouse_right_released))
		{
			...
			sVar(window_busy) = /*"contextmenu"*/ STR(1059);
	...
	RealType context_menu_draw(ScopeAny self)
	{
		if (sInt(context_menu_level_amount) == IntType(0) || sInt(context_menu_window) != window_get_current())
			return IntType(0);
		if (ObjType(obj_context_menu_level, DsList(sInt(context_menu_level)).Value(IntType(0)))->ani == IntType(0) && sStr(context_menu_ani) == /*"hide"*/ STR(758))
		{
		...
		if (((sBool(mouse_left_pressed) || sBool(mouse_right_pressed)) && !sBool(context_menu_mouseon)) || (sBool(mouse_left_released) && (!sBool(context_menu_mouseon) || (sInt(context_menu_mouseon_item) != null_ && !(idVar(sInt(context_menu_mouseon_item), disabled) > 0) && idVar(sInt(context_menu_mouseon_item), context_menu_name) == /*""*/ STR(0)))))
			sStr(context_menu_ani) = /*"hide"*/ STR(758);
	...
	RealType context_menu_draw_level(ScopeAny self, IntType argument0)
	{
		...
		if (sStr(context_menu_ani) == /*""*/ STR(0) || sStr(context_menu_ani) == /*"open"*/ STR(933))
		{
		...
		aniease = ease(/*"easeoutexpo"*/ STR(562), ObjType(obj_context_menu_level, level)->ani);
		alphaease = aniease;
		aniease = IntType(1);
	...
	VarType debug(VarArgs argument)
	{
		...
		cap = string_repeat(/*"\t"*/ STR(1060), global::debug_indent) + string(argument[IntType(0)]);
		valstr = /*""*/ STR(0);
	...
	void debug_ds_list(VarType argument0)
	{
		...
		debug({ /*"Elements"*/ STR(1063), ds_list_size((IntType)(list)) });
		for (IntType i = IntType(0); i < ds_list_size(list); i++)
			debug({ /*"    "*/ STR(1064) + string(DsList(list).Value(i)) });
	}
	...
	void debug_ds_map(IntType map)
	{
		...
		debug({ /*"Elements"*/ STR(1063), ds_list_size(keylist) });
		for (IntType i = IntType(0); i < ds_list_size(keylist); i++)
			debug({ /*"   "*/ STR(1065) + string(DsList(keylist).Value(i)) + /*" => "*/ STR(1066) + string(DsMap(map).Value(DsList(keylist).Value(i))) });
	...
	RealType debug_info_draw(ScopeAny self)
	{
		...
		str += /*"fps: "*/ STR(1068) + string(gmlGlobal::fps) + /*" \n"*/ STR(1069);
		str += /*"fps_real: "*/ STR(1070) + string(gmlGlobal::fps_real) + /*" \n"*/ STR(1069);
		str += /*"delta: "*/ STR(1071) + string(global::delta) + /*" \n"*/ STR(1069);
		str += /*"DPI: "*/ STR(1072) + string(display_get_dpi_x()) + /*","*/ STR(1073) + string(display_get_dpi_y()) + /*" \n"*/ STR(1069);
		str += /*"instance_count: "*/ STR(1074) + string(gmlGlobal::instance_count) + /*" \n"*/ STR(1069);
		str += /*"render_world() calls: "*/ STR(1075) + string(global::render_world_count) + /*" \n"*/ STR(1069);
		str += /*"Vertex buffer triangles: "*/ STR(1076) + string(get_vertex_buffer_triangles()) + /*" \n"*/ STR(1069);
		str += /*"Vertex buffer render calls: "*/ STR(1077) + string(get_vertex_buffer_render_calls()) + /*" \n"*/ STR(1069);
		str += /*"Primitive lines: "*/ STR(1078) + string(get_primitive_lines()) + /*" \n"*/ STR(1069);
		str += /*"Primitive triangles: "*/ STR(1079) + string(get_primitive_triangles()) + /*" \n"*/ STR(1069);
		str += /*"Primitive render calls: "*/ STR(1080) + string(get_primitive_render_calls()) + /*" \n"*/ STR(1069);
		str += /*"[F12 to disable]"*/ STR(1081);
	...
	{
		debug({ str, string(current_time() - global::debug_timer) + /*" msec"*/ STR(1082) });
	}
