...
namespace CppProject
{
	...
	void project_backup(ScopeAny self)
	{
		...
		project_save(self, { fn + /*".backup"*/ STR(2098) + ((sReal(setting_backup_amount) > IntType(1)) ? /*"1"*/ STR(1093) : /*""*/ STR(0)) });
	...
	RealType project_load(ScopeAny self, VarArgs argument)
	{
		...
		BoolType legacy;
		ext = filename_ext(fn);
		if (ext == /*".miproject"*/ STR(688) || string_contains(ext, /*".backup"*/ STR(2098)))
		{
	...
	RealType project_load_background(ScopeAny self, VarType map)
	{
		...
		sVar(background_biome) = value_get_string(DsMap(map).Value(/*"biome"*/ STR(1674)), sVar(background_biome));
