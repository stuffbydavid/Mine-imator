...
namespace CppProject
{
	RealType tab_template_editor_particles(ScopeAny self)
	{
		...
		if (draw_button_icon(self, { /*"particleeditorexport"*/ STR(3413), setx, sVar(dy), IntType(24), IntType(24), false, icons_ASSET_EXPORT, null_, false, /*"tooltipparticlesexport"*/ STR(3414) }))
			particles_save(self);
		setx -= 28.0;
		if (draw_button_icon(self, { /*"particleeditorimport"*/ STR(3415), setx, sVar(dy), IntType(24), IntType(24), false, icons_ASSET_IMPORT, null_, false, /*"tooltipparticlesimport"*/ STR(3416) }))
			action_lib_pc_open(self);
		setx -= 4.0;
		draw_divide_vertical(setx, sVar(dy), IntType(24));
		setx -= 28.0;
		tip_set_keybind(self, e_keybind_PARTICLES_CLEAR);
		if (draw_button_icon(self, { /*"particleeditorclear"*/ STR(3417), setx, sVar(dy), IntType(24), IntType(24), false, icons_DELETE, null_, false, /*"tooltipparticlesclear"*/ STR(3418) }))
			action_lib_pc_clear();
		setx -= 28.0;
		if (!(idVar(global::temp_edit, pc_spawn_constant) > 0))
		{
			tip_set_keybind(self, e_keybind_PARTICLES_SPAWN);
			if (draw_button_icon(self, { /*"particleeditorspawn"*/ STR(3419), setx, sVar(dy), IntType(24), IntType(24), false, icons_PARTICLES, null_, false, /*"tooltipparticlesspawn"*/ STR(2041) }))
				action_lib_pc_spawn();
			setx -= 28.0;
		}
		draw_label_value(self, sVar(dx), sVar(dy), setx - sVar(dx), IntType(24), text_get({ /*"particleeditorcount"*/ STR(3420) }), string(instance_number(ID_obj_particle)));
		tab_next(self);
		draw_divide(sVar(content_x), sVar(dy), dividew);
		sVar(dy) += IntType(12);
		tab_control(self, IntType(16));
		draw_label(self, { text_get({ /*"particleeditorspawncaption"*/ STR(3421) }), sVar(dx), sVar(dy) + IntType(8), fa_left, fa_middle, global::c_text_tertiary, global::a_text_tertiary, sInt(font_subheading) });
		tab_next(self);
		tab_control_togglebutton(self);
		togglebutton_add(self, { /*"particleeditorspawnconstant"*/ STR(3422), null_, IntType(1), idVar(global::temp_edit, pc_spawn_constant), ID_action_lib_pc_spawn_constant });
		togglebutton_add(self, { /*"particleeditorspawnburst"*/ STR(3423), null_, IntType(0), !(idVar(global::temp_edit, pc_spawn_constant) > 0), ID_action_lib_pc_spawn_constant });
		draw_togglebutton(self, { /*"particleeditorspawntype"*/ STR(3424), sVar(dx), sVar(dy) });
		tab_next(self);
		if (idVar(global::temp_edit, pc_spawn_constant) > 0)
			draw_tooltip_label(self, /*"particleeditorspawnconstanttip"*/ STR(3425), icons_PARTICLES, e_toast_INFO);
		else
			draw_tooltip_label(self, /*"particleeditorspawnbursttip"*/ STR(3426), icons_PARTICLES, e_toast_INFO);
		
		draw_set_font(sInt(font_label));
		tab_control_dragger(self);
		draw_dragger(self, { /*"particleeditorspawnamount"*/ STR(3427), sVar(dx), sVar(dy), IntType(64), idVar(global::temp_edit, pc_spawn_amount), (idVar(global::temp_edit, pc_spawn_constant) > 0) ? 2.0 : (1.0 / 5.0), IntType(1), no_limit, IntType(100), IntType(1), idInt(sVar(tab), tbx_spawn_amount), ID_action_lib_pc_spawn_amount, string_width(text_get({ /*"particleeditorspawnamount"*/ STR(3427) })) + IntType(8) });
		draw_set_font(sInt(font_label));
		textx = sVar(dx) + IntType(64) + IntType(16) + string_width(text_get({ /*"particleeditorspawnamount"*/ STR(3427) }));
		text = string_limit({ ((idVar(global::temp_edit, pc_spawn_constant) > 0) ? text_get({ /*"particleeditorperminute"*/ STR(3428) }) : text_get({ /*"particleeditorperburst"*/ STR(3429) })), (sVar(dw) - (textx - sVar(dx))) - IntType(8) });
		...
		draw_switch(self, { /*"particleeditorspawnregion"*/ STR(3430), sVar(dx), sVar(dy), idVar(global::temp_edit, pc_spawn_region_use), ID_action_lib_pc_spawn_region_use });
		tab_next(self);
		if (idVar(global::temp_edit, pc_spawn_region_use) > 0)
		{
			...
			draw_button_menu(self, { /*"particleeditorspawnregiontype"*/ STR(1313), e_menu_LIST, sVar(dx), sVar(dy), sVar(dw), IntType(24), idVar(global::temp_edit, pc_spawn_region_type), text_get({ /*"particleeditorspawnregiontype"*/ STR(1313) + idVar(global::temp_edit, pc_spawn_region_type) }), ID_action_lib_pc_spawn_region_type, false, null_, icon });
			tab_next(self);
			switch (StringType(idVar(global::temp_edit, pc_spawn_region_type)).id)
			{
				case 513: // sphere
				...
				{
					tab_control_dragger(self);
					draw_dragger(self, { /*"particleeditorspawnregioncubesize"*/ STR(3432), sVar(dx), sVar(dy), IntType(64), idVar(global::temp_edit, pc_spawn_region_cube_size), (RealType)idVar(global::temp_edit, pc_spawn_region_cube_size) / 100.0, IntType(0), no_limit, IntType(100), IntType(0), idInt(sVar(tab), tbx_spawn_region_cube_size), ID_action_lib_pc_spawn_region_cube_size });
					tab_next(self);
					break;
				}
				...
				{
					global::axis_edit = X_;
					textfield_group_add(self, { /*"particleeditorspawnregionboxxsize"*/ STR(3433), idVar(global::temp_edit, pc_spawn_region_box_size).Value(global::axis_edit), IntType(200), ID_action_lib_pc_spawn_region_box_size, global::axis_edit, idInt(sVar(tab), tbx_spawn_region_box_xsize), null_, idVar(global::temp_edit, pc_spawn_region_box_size).Value(global::axis_edit) / 100.0 });
					global::axis_edit = sn;
					textfield_group_add(self, { /*"particleeditorspawnregionboxysize"*/ STR(3434), idVar(global::temp_edit, pc_spawn_region_box_size).Value(global::axis_edit), IntType(200), ID_action_lib_pc_spawn_region_box_size, global::axis_edit, idInt(sVar(tab), tbx_spawn_region_box_ysize), null_, idVar(global::temp_edit, pc_spawn_region_box_size).Value(global::axis_edit) / 100.0 });
					global::axis_edit = ud;
					textfield_group_add(self, { /*"particleeditorspawnregionboxzsize"*/ STR(3435), idVar(global::temp_edit, pc_spawn_region_box_size).Value(global::axis_edit), IntType(200), ID_action_lib_pc_spawn_region_box_size, global::axis_edit, idInt(sVar(tab), tbx_spawn_region_box_zsize), null_, idVar(global::temp_edit, pc_spawn_region_box_size).Value(global::axis_edit) / 100.0 });
					tab_control_textfield_group(self);
					draw_textfield_group(self, { /*"particleeditorspawnregionboxsize"*/ STR(3436), sVar(dx), sVar(dy), sVar(dw), null_, IntType(0), no_limit, IntType(0), true, true, IntType(1) });
					tab_next(self);
					break;
				}
				...
				case 520: // path
				{
					...
					tab_control_menu(self);
					draw_button_menu(self, { /*"particleeditorspawnregionpath"*/ STR(1319), e_menu_LIST, sVar(dx), sVar(dy), sVar(dw), IntType(24), idVar(global::temp_edit, pc_spawn_region_path), name, ID_action_lib_pc_spawn_region_path });
					tab_next(self);
					tab_control_dragger(self);
					draw_dragger(self, { /*"particleeditorspawnregionpathradius"*/ STR(3437), sVar(dx), sVar(dy), IntType(64), idVar(global::temp_edit, pc_spawn_region_path_radius), (RealType)idVar(global::temp_edit, pc_spawn_region_path_radius) / 100.0, IntType(0), no_limit, IntType(100), IntType(0), idInt(sVar(tab), tbx_spawn_region_path_radius), ID_action_lib_pc_spawn_region_path_radius });
					tab_next(self);
					break;
				}
		...
		tab_control_menu(self);
		draw_button_menu(self, { /*"particleeditorboundingbox"*/ STR(1320), e_menu_LIST, sVar(dx), sVar(dy), sVar(dw), IntType(24), idVar(global::temp_edit, pc_bounding_box_type), text_get({ /*"particleeditorboundingboxtype"*/ STR(3438) + idVar(global::temp_edit, pc_bounding_box_type) }), ID_action_lib_pc_bounding_box_type });
		tab_next(self);
		if (idVar(global::temp_edit, pc_bounding_box_type) == /*"ground"*/ STR(135))
		{
			tab_control_dragger(self);
			draw_dragger(self, { /*"particleeditorboundingboxground"*/ STR(3439) + ((sReal(setting_z_is_up) > 0) ? /*"z"*/ STR(819) : /*"y"*/ STR(801)), sVar(dx), sVar(dy), IntType(64), idVar(global::temp_edit, pc_bounding_box_ground_z), 0.1, -no_limit, no_limit, IntType(0), IntType(0), idInt(sVar(tab), tbx_bounding_box_ground_z), ID_action_lib_pc_bounding_box_ground_z });
			tab_next(self);
		}
		else
			...
			{
				global::axis_edit = X_;
				textfield_group_add(self, { /*"particleeditorboundingboxfromx"*/ STR(3440), idVar(global::temp_edit, pc_bounding_box_custom_start).Value(global::axis_edit), -IntType(100), ID_action_lib_pc_bounding_box_custom_start, global::axis_edit, idInt(sVar(tab), tbx_bounding_box_custom_xstart), null_, IntType(1), -no_limit, idVar(global::temp_edit, pc_bounding_box_custom_end).Value(global::axis_edit) });
				global::axis_edit = sn;
				textfield_group_add(self, { /*"particleeditorboundingboxfromy"*/ STR(3441), idVar(global::temp_edit, pc_bounding_box_custom_start).Value(global::axis_edit), -IntType(100), ID_action_lib_pc_bounding_box_custom_start, global::axis_edit, idInt(sVar(tab), tbx_bounding_box_custom_ystart), null_, IntType(1), -no_limit, idVar(global::temp_edit, pc_bounding_box_custom_end).Value(global::axis_edit) });
				global::axis_edit = ud;
				textfield_group_add(self, { /*"particleeditorboundingboxfromz"*/ STR(3442), idVar(global::temp_edit, pc_bounding_box_custom_start).Value(global::axis_edit), -IntType(100), ID_action_lib_pc_bounding_box_custom_start, global::axis_edit, idInt(sVar(tab), tbx_bounding_box_custom_zstart), null_, IntType(1), -no_limit, idVar(global::temp_edit, pc_bounding_box_custom_end).Value(global::axis_edit) });
				tab_control_textfield_group(self);
				draw_textfield_group(self, { /*"particleeditorboundingboxcustomfrom"*/ STR(3443), sVar(dx), sVar(dy), sVar(dw), IntType(1), IntType(0), no_limit, IntType(0), true, true, IntType(1) });
				tab_next(self);
				global::axis_edit = X_;
				textfield_group_add(self, { /*"particleeditorboundingboxtox"*/ STR(3444), idVar(global::temp_edit, pc_bounding_box_custom_end).Value(global::axis_edit), IntType(100), ID_action_lib_pc_bounding_box_custom_end, global::axis_edit, idInt(sVar(tab), tbx_bounding_box_custom_xend), null_, IntType(1), idVar(global::temp_edit, pc_bounding_box_custom_start).Value(global::axis_edit), no_limit });
				global::axis_edit = sn;
				textfield_group_add(self, { /*"particleeditorboundingboxtoy"*/ STR(3445), idVar(global::temp_edit, pc_bounding_box_custom_end).Value(global::axis_edit), IntType(100), ID_action_lib_pc_bounding_box_custom_end, global::axis_edit, idInt(sVar(tab), tbx_bounding_box_custom_yend), null_, IntType(1), idVar(global::temp_edit, pc_bounding_box_custom_start).Value(global::axis_edit), no_limit });
				global::axis_edit = ud;
				textfield_group_add(self, { /*"particleeditorboundingboxtoz"*/ STR(3446), idVar(global::temp_edit, pc_bounding_box_custom_end).Value(global::axis_edit), IntType(100), ID_action_lib_pc_bounding_box_custom_end, global::axis_edit, idInt(sVar(tab), tbx_bounding_box_custom_zend), null_, IntType(1), idVar(global::temp_edit, pc_bounding_box_custom_start).Value(global::axis_edit), no_limit });
				tab_control_textfield_group(self);
				draw_textfield_group(self, { /*"particleeditorboundingboxcustomto"*/ STR(3447), sVar(dx), sVar(dy), sVar(dw), IntType(1), IntType(0), no_limit, IntType(0), true, true, IntType(1) });
				tab_next(self);
				tab_control_switch(self);
				draw_switch(self, { /*"particleeditorboundingboxrelative"*/ STR(3448), sVar(dx), sVar(dy), idVar(global::temp_edit, pc_bounding_box_relative), ID_action_lib_pc_bounding_box_relative });
				tab_next(self);
			}
		...
		sVar(dy) += IntType(12);
		tab_control(self, IntType(16));
		draw_label(self, { text_get({ /*"particleeditordestruction"*/ STR(3449) }), sVar(dx), sVar(dy) + IntType(8), fa_left, fa_middle, global::c_text_tertiary, global::a_text_tertiary, sInt(font_subheading) });
		tab_next(self);
		tab_control(self, IntType(16));
		draw_label(self, { text_get({ /*"particleeditordestroy"*/ STR(3450) }), sVar(dx), sVar(dy) + IntType(8), fa_left, fa_middle, global::c_text_secondary, global::a_text_secondary, sInt(font_label) });
		tab_next(self);
		tab_control_checkbox(self);
		draw_checkbox(self, /*"particleeditordestroyanimationfinish"*/ STR(3451), sVar(dx), sVar(dy), idVar(global::temp_edit, pc_destroy_at_animation_finish), ID_action_lib_pc_destroy_at_animation_finish);
		tab_next(self, { false });
		tab_control_checkbox(self);
		draw_checkbox(self, /*"particleeditordestroyboundingboxtoggle"*/ STR(3452), sVar(dx), sVar(dy), idVar(global::temp_edit, pc_destroy_at_bounding_box), ID_action_lib_pc_destroy_at_bounding_box);
		tab_next(self, { false });
		tab_control_checkbox(self);
		draw_checkbox(self, /*"particleeditordestroyamount"*/ STR(3453), sVar(dx), sVar(dy), idVar(global::temp_edit, pc_destroy_at_amount), ID_action_lib_pc_destroy_at_amount);
		wid = text_max_width({ /*"particleeditordestroyamount"*/ STR(3453) }) + IntType(8) + IntType(26);
		...
		draw_dragger(self, { /*"particleeditordestroyamountval"*/ STR(3454), sVar(dx) + wid, sVar(dy), IntType(64), idVar(global::temp_edit, pc_destroy_at_amount_val), 1.0 / 4.0, IntType(0), no_limit, IntType(200), IntType(1), idInt(sVar(tab), tbx_destroy_at_amount_val), ID_action_lib_pc_destroy_at_amount_val, wid, false });
		tab_next(self, { wid == IntType(0) });
		tab_control_checkbox(self);
		draw_checkbox(self, /*"particleeditordestroytime"*/ STR(3455), sVar(dx), sVar(dy), idVar(global::temp_edit, pc_destroy_at_time), ID_action_lib_pc_destroy_at_time);
		tab_next(self, { !(idVar(global::temp_edit, pc_destroy_at_time) > 0) });
		if (idVar(global::temp_edit, pc_destroy_at_time) > 0)
		{
			tab_template_editor_particles_value(self, { /*"particleeditordestroylifespan"*/ STR(3456), idVar(global::temp_edit, pc_destroy_at_time_seconds), idVar(global::temp_edit, pc_destroy_at_time_israndom), idVar(global::temp_edit, pc_destroy_at_time_random_min), idVar(global::temp_edit, pc_destroy_at_time_random_max), 1.0 / 20.0, IntType(0), no_limit, ArrType::From({ IntType(5), IntType(5), IntType(10) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_destroy_at_time_seconds), idInt(sVar(tab), tbx_destroy_at_time_random) }), ArrType::From({ ID_action_lib_pc_destroy_at_time_seconds, ID_action_lib_pc_destroy_at_time_israndom, ID_action_lib_pc_destroy_at_time_random_min, ID_action_lib_pc_destroy_at_time_random_max }), null_, false, suffix });
		}
		draw_divide(sVar(content_x), sVar(dy), dividew);
		sVar(dy) += IntType(12);
		tab_control(self, IntType(16));
		draw_label(self, { text_get({ /*"particleeditoremitters"*/ STR(3457) }), sVar(dx), sVar(dy) + IntType(8), fa_left, fa_middle, global::c_text_tertiary, global::a_text_tertiary, sInt(font_subheading) });
		tab_next(self);
		...
		tab_next(self);
		tab_control(self, IntType(24));
		if (draw_button_icon(self, { /*"particleeditortypeadd"*/ STR(3458), sVar(dx), sVar(dy), IntType(24), IntType(24), false, icons_ASSET_ADD, null_, false, /*"tooltipparticlesadd"*/ STR(3459) }))
			action_lib_pc_type_add(self);
		if (draw_button_icon(self, { /*"particleeditortypeduplicate"*/ STR(3460), sVar(dx) + IntType(28), sVar(dy), IntType(24), IntType(24), false, icons_DUPLICATE, null_, global::ptype_edit == null_, /*"tooltipparticlesduplicate"*/ STR(3461) }))
			action_lib_pc_type_duplicate(self);
		if (draw_button_icon(self, { /*"particleeditortypedelete"*/ STR(3462), sVar(dx) + (IntType(28) * IntType(2)), sVar(dy), IntType(24), IntType(24), false, icons_DELETE, null_, global::ptype_edit == null_, /*"tooltipparticlesdelete"*/ STR(3463) }))
			action_lib_pc_type_remove(self);
		tab_next(self);
		if (global::ptype_edit == null_)
			return IntType(0);
		capwid = text_caption_width(self, { /*"particleeditortypename"*/ STR(216), /*"particleeditortypespawnrate"*/ STR(3464), /*"particleeditortypetemp"*/ STR(1326), /*"particleeditortypespritetex"*/ STR(1329), /*"particleeditortypespriteteximage"*/ STR(3465), /*"particleeditortypespritetemplatepack"*/ STR(1330), /*"particleeditortypespritetemplate"*/ STR(1331), /*"particleeditortypetext"*/ STR(3466) });
		...
		if (ds_list_size(idInt(global::temp_edit, pc_type_list)) > IntType(1))
		{
			...
			draw_meter(self, /*"particleeditortypespawnrate"*/ STR(3464), sVar(dx), sVar(dy), sVar(dw), idVar(global::ptype_edit, spawn_rate) * IntType(100), IntType(0), IntType(100), 100.0 / ds_list_size(idInt(global::temp_edit, pc_type_list)), IntType(1), idInt(sVar(tab), tbx_type_spawn_rate), ID_action_lib_pc_type_spawn_rate);
			tab_next(self);
		}
		tab_control_menu(self);
		text = text_get({ /*"particleeditortypespritesheet"*/ STR(1328) });
		if (idVar(global::ptype_edit, temp) == particle_template)
			text = text_get({ /*"particleeditortypetemplate"*/ STR(1327) });
		if (idVar(global::ptype_edit, temp) > 0)
			text = idVar(idVar(global::ptype_edit, temp), display_name);
		draw_button_menu(self, { /*"particleeditortypetemp"*/ STR(1326), e_menu_LIST, sVar(dx), sVar(dy), sVar(dw), IntType(24), idVar(global::ptype_edit, temp), text, ID_action_lib_pc_type_temp });
		tab_next(self);
		if (idVar(global::ptype_edit, temp) < IntType(0))
		{
			if (idVar(global::ptype_edit, temp) == particle_sheet)
			{
				...
				draw_button_menu(self, { /*"particleeditortypespritetex"*/ STR(1329), e_menu_LIST, sVar(dx), sVar(dy), sVar(dw), sReal(ui_large_height), idVar(global::ptype_edit, sprite_tex), idVar(idVar(global::ptype_edit, sprite_tex), display_name), ID_action_lib_pc_type_sprite_tex, false, idArr(idVar(global::ptype_edit, sprite_tex), particles_texture).Value(idVar(global::ptype_edit, sprite_tex_image)) });
				tab_next(self);
				if (idVar(idVar(global::ptype_edit, sprite_tex), type) == e_res_type_PACK)
				{
					tab_control_togglebutton(self);
					togglebutton_add(self, { /*"particleeditortypespriteteximage1"*/ STR(3467), null_, IntType(0), idVar(global::ptype_edit, sprite_tex_image) == IntType(0), ID_action_lib_pc_type_sprite_tex_image });
					togglebutton_add(self, { /*"particleeditortypespriteteximage2"*/ STR(3468), null_, IntType(1), idVar(global::ptype_edit, sprite_tex_image) == IntType(1), ID_action_lib_pc_type_sprite_tex_image });
					draw_togglebutton(self, { /*"particleeditortypespriteteximage"*/ STR(3465), sVar(dx), sVar(dy) });
					tab_next(self);
				}
				tab_template_editor_particles_framebox(self);
				ObjType(obj_textbox, idInt(sVar(tab), tbx_type_sprite_frame_width))->suffix = text_get({ /*"particleeditorpixels"*/ STR(3469) });
				ObjType(obj_textbox, idInt(sVar(tab), tbx_type_sprite_frame_height))->suffix = text_get({ /*"particleeditorpixels"*/ STR(3469) });
				tab_control_textfield_group(self);
				textfield_group_add(self, { /*"particleeditortypespriteframewidth"*/ STR(3470), idVar(global::ptype_edit, sprite_frame_width), IntType(8), ID_action_lib_pc_type_sprite_frame_width, global::axis_edit, idInt(sVar(tab), tbx_type_sprite_frame_width) });
				textfield_group_add(self, { /*"particleeditortypespriteframeheight"*/ STR(3471), idVar(global::ptype_edit, sprite_frame_height), IntType(8), ID_action_lib_pc_type_sprite_frame_height, global::axis_edit, idInt(sVar(tab), tbx_type_sprite_frame_height) });
				draw_textfield_group(self, { /*"particleeditortypespriteframesize"*/ STR(3472), sVar(dx), sVar(dy), sVar(dw), 1.0 / 10.0, IntType(1), no_limit, IntType(1), true, true, IntType(1) });
				tab_next(self);
				tab_control_textfield_group(self);
				textfield_group_add(self, { /*"particleeditortypespriteframestart"*/ STR(3473), idVar(global::ptype_edit, sprite_frame_start), IntType(7), ID_action_lib_pc_type_sprite_frame_start, global::axis_edit, idInt(sVar(tab), tbx_type_sprite_frame_start), null_, 1.0 / 10.0, IntType(0), no_limit, /*"particleeditorfrom"*/ STR(3474) });
				textfield_group_add(self, { /*"particleeditortypespriteframeend"*/ STR(3475), idVar(global::ptype_edit, sprite_frame_end), IntType(0), ID_action_lib_pc_type_sprite_frame_end, global::axis_edit, idInt(sVar(tab), tbx_type_sprite_frame_end), null_, 1.0 / 10.0, IntType(0), no_limit, /*"particleeditorto"*/ STR(3476) });
				draw_textfield_group(self, { /*"particleeditortypespriteframeframes"*/ STR(3477), sVar(dx), sVar(dy), sVar(dw), null_, null_, null_, IntType(1), true, IntType(1) });
				tab_next(self);
			}
			else
			{
				tab_control_menu(self, { sReal(ui_large_height) });
				draw_button_menu(self, { /*"particleeditortypespritetemplatepack"*/ STR(1330), e_menu_LIST, sVar(dx), sVar(dy), sVar(dw), sReal(ui_large_height), idVar(global::ptype_edit, sprite_template_tex), idVar(idVar(global::ptype_edit, sprite_template_tex), display_name), ID_action_lib_pc_type_sprite_template_tex, false, idInt(idVar(global::ptype_edit, sprite_template_tex), block_preview_texture) });
				tab_next(self);
				tab_control_menu(self);
				draw_button_menu(self, { /*"particleeditortypespritetemplate"*/ STR(1331), e_menu_LIST, sVar(dx), sVar(dy), sVar(dw), IntType(24), idVar(global::ptype_edit, sprite_template), text_get({ /*"particleeditortypespritetemplate"*/ STR(1331) + idVar(global::ptype_edit, sprite_template) }), ID_action_lib_pc_type_sprite_template, false });
				tab_next(self);
				tab_control_switch(self);
				draw_switch(self, { /*"particleeditortypespritetemplatestillframe"*/ STR(3478), sVar(dx), sVar(dy), idVar(global::ptype_edit, sprite_template_still_frame), ID_action_lib_pc_type_sprite_template_still_frame });
				tab_next(self);
				if (idVar(global::ptype_edit, sprite_template_still_frame) > 0)
				{
					tab_control_switch(self);
					draw_switch(self, { /*"particleeditortypespritetemplaterandomframe"*/ STR(3479), sVar(dx), sVar(dy), idVar(global::ptype_edit, sprite_template_random_frame), ID_action_lib_pc_type_sprite_template_random_frame });
					tab_next(self);
				}
				else
				{
					tab_control_switch(self);
					draw_switch(self, { /*"particleeditortypespritetemplatereverse"*/ STR(3480), sVar(dx), sVar(dy), idVar(global::ptype_edit, sprite_template_reverse), ID_action_lib_pc_type_sprite_template_reverse });
					tab_next(self);
				}
			...
			{
				tab_template_editor_particles_value(self, { /*"particleeditortypespriteanimationspeed"*/ STR(3481), idVar(global::ptype_edit, sprite_animation_speed), idVar(global::ptype_edit, sprite_animation_speed_israndom), idVar(global::ptype_edit, sprite_animation_speed_random_min), idVar(global::ptype_edit, sprite_animation_speed_random_max), 1.0 / 25.0, IntType(0), no_limit, ArrType::From({ IntType(5), IntType(5), IntType(10) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_sprite_animation_speed), idInt(sVar(tab), tbx_type_sprite_animation_speed_random) }), ArrType::From({ ID_action_lib_pc_type_sprite_animation_speed, ID_action_lib_pc_type_sprite_animation_speed_israndom, ID_action_lib_pc_type_sprite_animation_speed_random_min, ID_action_lib_pc_type_sprite_animation_speed_random_max }), null_, true, text_get({ /*"particleeditorfps"*/ STR(3482) }) });
				tab_control_togglebutton(self);
				togglebutton_add(self, { /*"particleeditortypespriteanimationonendstop"*/ STR(3483), null_, IntType(0), idVar(global::ptype_edit, sprite_animation_onend) == IntType(0), ID_action_lib_pc_type_sprite_animation_onend });
				togglebutton_add(self, { /*"particleeditortypespriteanimationonendloop"*/ STR(3484), null_, IntType(1), idVar(global::ptype_edit, sprite_animation_onend) == IntType(1), ID_action_lib_pc_type_sprite_animation_onend });
				togglebutton_add(self, { /*"particleeditortypespriteanimationonendreverse"*/ STR(3485), null_, IntType(2), idVar(global::ptype_edit, sprite_animation_onend) == IntType(2), ID_action_lib_pc_type_sprite_animation_onend });
				draw_togglebutton(self, { /*"particleeditortypespriteanimationonend"*/ STR(3486), sVar(dx), sVar(dy) });
				tab_next(self);
			}
			...
			if (idVar(idVar(global::ptype_edit, temp), type) == e_temp_type_TEXT)
			{
				...
				draw_textfield(self, { /*"particleeditortypetext"*/ STR(3466), sVar(dx), sVar(dy), sVar(dw), IntType(88), idInt(sVar(tab), tbx_type_text), ID_action_lib_pc_type_text, /*""*/ STR(0), /*"top"*/ STR(187) });
				tab_next(self);
			}
		...
		sVar(dy) += IntType(12);
		tab_control(self, IntType(16));
		draw_label(self, { text_get({ /*"particleeditortypetrajectory"*/ STR(3487) }), sVar(dx), sVar(dy) + IntType(8), fa_left, fa_middle, global::c_text_tertiary, global::a_text_tertiary, sInt(font_subheading) });
		tab_next(self);
		tab_control_switch(self);
		if (draw_button_collapse(self, /*"particleeditortypeangle"*/ STR(3488), !idBool(global::ptype_edit, angle_collapse), null_, true, /*"particleeditortypeangle"*/ STR(3488)))
		...
		if (!idBool(global::ptype_edit, angle_collapse))
		{
			...
			capwid = ((idVar(global::ptype_edit, angle_extend) > 0) ? text_caption_width(self, { /*"particleeditortypeanglex"*/ STR(3489), /*"particleeditortypeangley"*/ STR(3490), /*"particleeditortypeanglez"*/ STR(3491), /*"particleeditortypeanglespeed"*/ STR(3492), /*"particleeditortypeanglespeedadd"*/ STR(3493), /*"particleeditortypeanglespeedmul"*/ STR(3494) }) : text_caption_width(self, { /*"particleeditortypeanglexyz"*/ STR(3495), /*"particleeditortypeanglespeed"*/ STR(3492), /*"particleeditortypeanglespeedadd"*/ STR(3493), /*"particleeditortypeanglespeedmul"*/ STR(3494) }));
			tab_control_switch(self);
			draw_switch(self, { /*"particleeditortypeangleextend"*/ STR(3496), sVar(dx), sVar(dy), idVar(global::ptype_edit, angle_extend), ID_action_lib_pc_type_angle_extend });
			tab_next(self);
			global::axis_edit = X_;
			tab_template_editor_particles_value(self, { /*"particleeditortypeangle"*/ STR(3488) + ((idVar(global::ptype_edit, angle_extend) > 0) ? /*"x"*/ STR(818) : /*"xyz"*/ STR(3497)), idVar(global::ptype_edit, angle).Value(X_), idVar(global::ptype_edit, angle_israndom).Value(X_), idVar(global::ptype_edit, angle_random_min).Value(X_), idVar(global::ptype_edit, angle_random_max).Value(X_), 1.0 / 4.0, -no_limit, no_limit, ArrType::From({ IntType(0), IntType(0), IntType(360) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_xangle), idInt(sVar(tab), tbx_type_xangle_random) }), ArrType::From({ ID_action_lib_pc_type_angle, ID_action_lib_pc_type_angle_israndom, ID_action_lib_pc_type_angle_random_min, ID_action_lib_pc_type_angle_random_max }), capwid });
			if (idVar(global::ptype_edit, angle_extend) > 0)
			{
				global::axis_edit = sn;
				tab_template_editor_particles_value(self, { /*"particleeditortypeangley"*/ STR(3490), idVar(global::ptype_edit, angle).Value(sn), idVar(global::ptype_edit, angle_israndom).Value(sn), idVar(global::ptype_edit, angle_random_min).Value(sn), idVar(global::ptype_edit, angle_random_max).Value(sn), 1.0 / 4.0, -no_limit, no_limit, ArrType::From({ IntType(0), IntType(0), IntType(360) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_yangle), idInt(sVar(tab), tbx_type_yangle_random) }), ArrType::From({ ID_action_lib_pc_type_angle, ID_action_lib_pc_type_angle_israndom, ID_action_lib_pc_type_angle_random_min, ID_action_lib_pc_type_angle_random_max }), capwid });
				global::axis_edit = ud;
				tab_template_editor_particles_value(self, { /*"particleeditortypeanglez"*/ STR(3491), idVar(global::ptype_edit, angle).Value(ud), idVar(global::ptype_edit, angle_israndom).Value(ud), idVar(global::ptype_edit, angle_random_min).Value(ud), idVar(global::ptype_edit, angle_random_max).Value(ud), 1.0 / 4.0, -no_limit, no_limit, ArrType::From({ IntType(0), IntType(0), IntType(360) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_zangle), idInt(sVar(tab), tbx_type_zangle_random) }), ArrType::From({ ID_action_lib_pc_type_angle, ID_action_lib_pc_type_angle_israndom, ID_action_lib_pc_type_angle_random_min, ID_action_lib_pc_type_angle_random_max }), capwid });
			}
			tab_template_editor_particles_value(self, { /*"particleeditortypeanglespeed"*/ STR(3492), idVar(global::ptype_edit, angle_speed), idVar(global::ptype_edit, angle_speed_israndom), idVar(global::ptype_edit, angle_speed_random_min), idVar(global::ptype_edit, angle_speed_random_max), 1.0 / 4.0, -no_limit, no_limit, ArrType::From({ IntType(20), IntType(0), IntType(20) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_angle_speed), idInt(sVar(tab), tbx_type_angle_speed_random) }), ArrType::From({ ID_action_lib_pc_type_angle_speed, ID_action_lib_pc_type_angle_speed_israndom, ID_action_lib_pc_type_angle_speed_random_min, ID_action_lib_pc_type_angle_speed_random_max }), capwid, true, suffix });
			tab_template_editor_particles_value(self, { /*"particleeditortypeanglespeedadd"*/ STR(3493), idVar(global::ptype_edit, angle_speed_add), idVar(global::ptype_edit, angle_speed_add_israndom), idVar(global::ptype_edit, angle_speed_add_random_min), idVar(global::ptype_edit, angle_speed_add_random_max), 1.0 / 4.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(1), IntType(1) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_angle_speed_add), idInt(sVar(tab), tbx_type_angle_speed_add_random) }), ArrType::From({ ID_action_lib_pc_type_angle_speed_add, ID_action_lib_pc_type_angle_speed_add_israndom, ID_action_lib_pc_type_angle_speed_add_random_min, ID_action_lib_pc_type_angle_speed_add_random_max }), capwid, true, suffix });
			tab_template_editor_particles_value(self, { /*"particleeditortypeanglespeedmul"*/ STR(3494), idVar(global::ptype_edit, angle_speed_mul), idVar(global::ptype_edit, angle_speed_mul_israndom), idVar(global::ptype_edit, angle_speed_mul_random_min), idVar(global::ptype_edit, angle_speed_mul_random_max), 1.0 / 4.0, IntType(0), no_limit, ArrType::From({ IntType(1), 0.75, 0.9 }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_angle_speed_mul), idInt(sVar(tab), tbx_type_angle_speed_mul_random) }), ArrType::From({ ID_action_lib_pc_type_angle_speed_mul, ID_action_lib_pc_type_angle_speed_mul_israndom, ID_action_lib_pc_type_angle_speed_mul_random_min, ID_action_lib_pc_type_angle_speed_mul_random_max }), capwid, true, suffix });
			tab_collapse_end(self);
		}
		tab_control_switch(self);
		if (draw_button_collapse(self, /*"particleeditortypespeed"*/ STR(3498), !idBool(global::ptype_edit, spd_collapse), null_, true, /*"particleeditortypespeed"*/ STR(3498)))
			idBool(global::ptype_edit, spd_collapse) = !idBool(global::ptype_edit, spd_collapse);
		tab_next(self);
		if (!idBool(global::ptype_edit, spd_collapse))
		{
			tab_collapse_start(self);
			capwid = ((idVar(global::ptype_edit, spd_extend) > 0) ? text_caption_width(self, { /*"particleeditortypespeedx"*/ STR(3499), /*"particleeditortypespeedy"*/ STR(3500), /*"particleeditortypespeedz"*/ STR(3501), /*"particleeditortypespeedxadd"*/ STR(3502), /*"particleeditortypespeedyadd"*/ STR(3503), /*"particleeditortypespeedzadd"*/ STR(3504), /*"particleeditortypespeedxmul"*/ STR(3505), /*"particleeditortypespeedymul"*/ STR(3506), /*"particleeditortypespeedzmul"*/ STR(3507) }) : text_caption_width(self, { /*"particleeditortypespeedxyz"*/ STR(3508), /*"particleeditortypespeedxyzadd"*/ STR(3509), /*"particleeditortypespeedxyzmul"*/ STR(3510) }));
			tab_control_switch(self);
			draw_switch(self, { /*"particleeditortypespeedextend"*/ STR(3511), sVar(dx), sVar(dy), idVar(global::ptype_edit, spd_extend), ID_action_lib_pc_type_spd_extend });
			tab_next(self);
			global::axis_edit = X_;
			tab_template_editor_particles_value(self, { /*"particleeditortypespeed"*/ STR(3498) + ((idVar(global::ptype_edit, spd_extend) > 0) ? /*"x"*/ STR(818) : /*"xyz"*/ STR(3497)), idVar(global::ptype_edit, spd).Value(X_), idVar(global::ptype_edit, spd_israndom).Value(X_), idVar(global::ptype_edit, spd_random_min).Value(X_), idVar(global::ptype_edit, spd_random_max).Value(X_), 1.0 / 4.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(20), IntType(20) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_xspd), idInt(sVar(tab), tbx_type_xspd_random) }), ArrType::From({ ID_action_lib_pc_type_spd, ID_action_lib_pc_type_spd_israndom, ID_action_lib_pc_type_spd_random_min, ID_action_lib_pc_type_spd_random_max }), capwid, true, suffix });
			if (idVar(global::ptype_edit, spd_extend) > 0)
			{
				global::axis_edit = sn;
				tab_template_editor_particles_value(self, { /*"particleeditortypespeedy"*/ STR(3500), idVar(global::ptype_edit, spd).Value(sn), idVar(global::ptype_edit, spd_israndom).Value(sn), idVar(global::ptype_edit, spd_random_min).Value(sn), idVar(global::ptype_edit, spd_random_max).Value(sn), 1.0 / 4.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(20), IntType(20) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_yspd), idInt(sVar(tab), tbx_type_yspd_random) }), ArrType::From({ ID_action_lib_pc_type_spd, ID_action_lib_pc_type_spd_israndom, ID_action_lib_pc_type_spd_random_min, ID_action_lib_pc_type_spd_random_max }), capwid, true, suffix });
				global::axis_edit = ud;
				tab_template_editor_particles_value(self, { /*"particleeditortypespeedz"*/ STR(3501), idVar(global::ptype_edit, spd).Value(ud), idVar(global::ptype_edit, spd_israndom).Value(ud), idVar(global::ptype_edit, spd_random_min).Value(ud), idVar(global::ptype_edit, spd_random_max).Value(ud), 1.0 / 4.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(20), IntType(20) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_zspd), idInt(sVar(tab), tbx_type_zspd_random) }), ArrType::From({ ID_action_lib_pc_type_spd, ID_action_lib_pc_type_spd_israndom, ID_action_lib_pc_type_spd_random_min, ID_action_lib_pc_type_spd_random_max }), capwid, true, suffix });
			}
			global::axis_edit = X_;
			tab_template_editor_particles_value(self, { /*"particleeditortypespeed"*/ STR(3498) + ((idVar(global::ptype_edit, spd_extend) > 0) ? /*"x"*/ STR(818) : /*"xyz"*/ STR(3497)) + /*"add"*/ STR(602), idVar(global::ptype_edit, spd_add).Value(X_), idVar(global::ptype_edit, spd_add_israndom).Value(X_), idVar(global::ptype_edit, spd_add_random_min).Value(X_), idVar(global::ptype_edit, spd_add_random_max).Value(X_), 1.0 / 10.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(1), IntType(1) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_xspd_add), idInt(sVar(tab), tbx_type_xspd_add_random) }), ArrType::From({ ID_action_lib_pc_type_spd_add, ID_action_lib_pc_type_spd_add_israndom, ID_action_lib_pc_type_spd_add_random_min, ID_action_lib_pc_type_spd_add_random_max }), capwid, true, suffix });
			if (idVar(global::ptype_edit, spd_extend) > 0)
			{
				global::axis_edit = sn;
				tab_template_editor_particles_value(self, { /*"particleeditortypespeedyadd"*/ STR(3503), idVar(global::ptype_edit, spd_add).Value(sn), idVar(global::ptype_edit, spd_add_israndom).Value(sn), idVar(global::ptype_edit, spd_add_random_min).Value(sn), idVar(global::ptype_edit, spd_add_random_max).Value(sn), 1.0 / 10.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(1), IntType(1) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_yspd_add), idInt(sVar(tab), tbx_type_yspd_add_random) }), ArrType::From({ ID_action_lib_pc_type_spd_add, ID_action_lib_pc_type_spd_add_israndom, ID_action_lib_pc_type_spd_add_random_min, ID_action_lib_pc_type_spd_add_random_max }), capwid, true, suffix });
				global::axis_edit = ud;
				tab_template_editor_particles_value(self, { /*"particleeditortypespeedzadd"*/ STR(3504), idVar(global::ptype_edit, spd_add).Value(ud), idVar(global::ptype_edit, spd_add_israndom).Value(ud), idVar(global::ptype_edit, spd_add_random_min).Value(ud), idVar(global::ptype_edit, spd_add_random_max).Value(ud), 1.0 / 10.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(1), IntType(1) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_zspd_add), idInt(sVar(tab), tbx_type_zspd_add_random) }), ArrType::From({ ID_action_lib_pc_type_spd_add, ID_action_lib_pc_type_spd_add_israndom, ID_action_lib_pc_type_spd_add_random_min, ID_action_lib_pc_type_spd_add_random_max }), capwid, true, suffix });
			}
			global::axis_edit = X_;
			tab_template_editor_particles_value(self, { /*"particleeditortypespeed"*/ STR(3498) + ((idVar(global::ptype_edit, spd_extend) > 0) ? /*"x"*/ STR(818) : /*"xyz"*/ STR(3497)) + /*"mul"*/ STR(3512), idVar(global::ptype_edit, spd_mul).Value(X_), idVar(global::ptype_edit, spd_mul_israndom).Value(X_), idVar(global::ptype_edit, spd_mul_random_min).Value(X_), idVar(global::ptype_edit, spd_mul_random_max).Value(X_), 1.0 / 200.0, IntType(0), no_limit, ArrType::From({ IntType(1), 0.75, 0.9 }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_xspd_mul), idInt(sVar(tab), tbx_type_xspd_mul_random) }), ArrType::From({ ID_action_lib_pc_type_spd_mul, ID_action_lib_pc_type_spd_mul_israndom, ID_action_lib_pc_type_spd_mul_random_min, ID_action_lib_pc_type_spd_mul_random_max }), capwid, true, suffix });
			if (idVar(global::ptype_edit, spd_extend) > 0)
			{
				global::axis_edit = sn;
				tab_template_editor_particles_value(self, { /*"particleeditortypespeedymul"*/ STR(3506), idVar(global::ptype_edit, spd_mul).Value(sn), idVar(global::ptype_edit, spd_mul_israndom).Value(sn), idVar(global::ptype_edit, spd_mul_random_min).Value(sn), idVar(global::ptype_edit, spd_mul_random_max).Value(sn), 1.0 / 200.0, IntType(0), no_limit, ArrType::From({ IntType(1), 0.75, 0.9 }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_yspd_mul), idInt(sVar(tab), tbx_type_yspd_mul_random) }), ArrType::From({ ID_action_lib_pc_type_spd_mul, ID_action_lib_pc_type_spd_mul_israndom, ID_action_lib_pc_type_spd_mul_random_min, ID_action_lib_pc_type_spd_mul_random_max }), capwid, true, suffix });
				global::axis_edit = ud;
				tab_template_editor_particles_value(self, { /*"particleeditortypespeedzmul"*/ STR(3507), idVar(global::ptype_edit, spd_mul).Value(ud), idVar(global::ptype_edit, spd_mul_israndom).Value(ud), idVar(global::ptype_edit, spd_mul_random_min).Value(ud), idVar(global::ptype_edit, spd_mul_random_max).Value(ud), 1.0 / 200.0, IntType(0), no_limit, ArrType::From({ IntType(1), 0.75, 0.9 }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_zspd_mul), idInt(sVar(tab), tbx_type_zspd_mul_random) }), ArrType::From({ ID_action_lib_pc_type_spd_mul, ID_action_lib_pc_type_spd_mul_israndom, ID_action_lib_pc_type_spd_mul_random_min, ID_action_lib_pc_type_spd_mul_random_max }), capwid, true, suffix });
			}
		...
		if (idVar(global::ptype_edit, temp) > 0 || (idVar(global::ptype_edit, temp) == particle_sheet || idVar(global::ptype_edit, temp) == particle_template))
		{
			...
			sVar(dy) += IntType(12);
			tab_control(self, IntType(16));
			draw_label(self, { text_get({ /*"particleeditortyperotation"*/ STR(3513) }), sVar(dx), sVar(dy) + IntType(8), fa_left, fa_middle, global::c_text_tertiary, global::a_text_tertiary, sInt(font_subheading) });
			tab_next(self);
			if (idVar(global::ptype_edit, temp) > 0)
			{
				tab_control_switch(self);
				if (draw_button_collapse(self, /*"particleeditortyperotationinitial"*/ STR(3514), !idBool(global::ptype_edit, rot_collapse), null_, true, /*"particleeditortyperotationinitial"*/ STR(3514)))
					idBool(global::ptype_edit, rot_collapse) = !idBool(global::ptype_edit, rot_collapse);
				tab_next(self);
				if (!idBool(global::ptype_edit, rot_collapse))
				{
					tab_collapse_start(self);
					capwid = ((idVar(global::ptype_edit, rot_extend) > 0) ? text_caption_width(self, { /*"particleeditortyperotationx"*/ STR(3515), /*"particleeditortyperotationy"*/ STR(3516), /*"particleeditortyperotationz"*/ STR(3517) }) : text_caption_width(self, { /*"particleeditortyperotationxyz"*/ STR(3518) }));
					tab_control_switch(self);
					draw_switch(self, { /*"particleeditortyperotationextend"*/ STR(3519), sVar(dx), sVar(dy), idVar(global::ptype_edit, rot_extend), ID_action_lib_pc_type_rot_extend });
					tab_next(self);
					global::axis_edit = X_;
					tab_template_editor_particles_value(self, { /*"particleeditortyperotation"*/ STR(3513) + ((idVar(global::ptype_edit, rot_extend) > 0) ? /*"x"*/ STR(818) : /*"xyz"*/ STR(3497)), idVar(global::ptype_edit, rot).Value(X_), idVar(global::ptype_edit, rot_israndom).Value(X_), idVar(global::ptype_edit, rot_random_min).Value(X_), idVar(global::ptype_edit, rot_random_max).Value(X_), 1.0 / 5.0, -no_limit, no_limit, ArrType::From({ IntType(0), IntType(0), IntType(360) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_xrot), idInt(sVar(tab), tbx_type_xrot_random) }), ArrType::From({ ID_action_lib_pc_type_rot, ID_action_lib_pc_type_rot_israndom, ID_action_lib_pc_type_rot_random_min, ID_action_lib_pc_type_rot_random_max }), capwid });
					if (idVar(global::ptype_edit, rot_extend) > 0)
					{
						global::axis_edit = sn;
						tab_template_editor_particles_value(self, { /*"particleeditortyperotationy"*/ STR(3516), idVar(global::ptype_edit, rot).Value(sn), idVar(global::ptype_edit, rot_israndom).Value(sn), idVar(global::ptype_edit, rot_random_min).Value(sn), idVar(global::ptype_edit, rot_random_max).Value(sn), 1.0 / 5.0, -no_limit, no_limit, ArrType::From({ IntType(0), IntType(0), IntType(360) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_yrot), idInt(sVar(tab), tbx_type_yrot_random) }), ArrType::From({ ID_action_lib_pc_type_rot, ID_action_lib_pc_type_rot_israndom, ID_action_lib_pc_type_rot_random_min, ID_action_lib_pc_type_rot_random_max }), capwid });
						global::axis_edit = ud;
						tab_template_editor_particles_value(self, { /*"particleeditortyperotationz"*/ STR(3517), idVar(global::ptype_edit, rot).Value(ud), idVar(global::ptype_edit, rot_israndom).Value(ud), idVar(global::ptype_edit, rot_random_min).Value(ud), idVar(global::ptype_edit, rot_random_max).Value(ud), 1.0 / 5.0, -no_limit, no_limit, ArrType::From({ IntType(0), IntType(0), IntType(360) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_zrot), idInt(sVar(tab), tbx_type_zrot_random) }), ArrType::From({ ID_action_lib_pc_type_rot, ID_action_lib_pc_type_rot_israndom, ID_action_lib_pc_type_rot_random_min, ID_action_lib_pc_type_rot_random_max }), capwid });
					}
					tab_collapse_end(self);
				}
				tab_control_switch(self);
				if (draw_button_collapse(self, /*"particleeditortyperotationspeed"*/ STR(3520), !idBool(global::ptype_edit, rot_spd_collapse), null_, true, /*"particleeditortyperotationspeed"*/ STR(3520)))
				...
				{
					tab_collapse_start(self);
					capwid = ((idVar(global::ptype_edit, rot_spd_extend) > 0) ? text_caption_width(self, { /*"particleeditortyperotationspeedx"*/ STR(3521), /*"particleeditortyperotationspeedy"*/ STR(3522), /*"particleeditortyperotationspeedz"*/ STR(3523), /*"particleeditortyperotationspeedxadd"*/ STR(3524), /*"particleeditortyperotationspeedyadd"*/ STR(3525), /*"particleeditortyperotationspeedzadd"*/ STR(3526), /*"particleeditortyperotationspeedxmul"*/ STR(3527), /*"particleeditortyperotationspeedymul"*/ STR(3528), /*"particleeditortyperotationspeedzmul"*/ STR(3529) }) : text_caption_width(self, { /*"particleeditortyperotationspeedxyz"*/ STR(3530), /*"particleeditortyperotationspeedxyzadd"*/ STR(3531), /*"particleeditortyperotationspeedxyzmul"*/ STR(3532) }));
					tab_control_switch(self);
					draw_switch(self, { /*"particleeditortyperotationspeedextend"*/ STR(3533), sVar(dx), sVar(dy), idVar(global::ptype_edit, rot_spd_extend), ID_action_lib_pc_type_rot_spd_extend });
					tab_next(self);
					global::axis_edit = X_;
					tab_template_editor_particles_value(self, { /*"particleeditortyperotationspeed"*/ STR(3520) + ((idVar(global::ptype_edit, rot_spd_extend) > 0) ? /*"x"*/ STR(818) : /*"xyz"*/ STR(3497)), idVar(global::ptype_edit, rot_spd).Value(X_), idVar(global::ptype_edit, rot_spd_israndom).Value(X_), idVar(global::ptype_edit, rot_spd_random_min).Value(X_), idVar(global::ptype_edit, rot_spd_random_max).Value(X_), 1.0 / 2.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(180), IntType(180) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_xrot_spd), idInt(sVar(tab), tbx_type_xrot_spd_random) }), ArrType::From({ ID_action_lib_pc_type_rot_spd, ID_action_lib_pc_type_rot_spd_israndom, ID_action_lib_pc_type_rot_spd_random_min, ID_action_lib_pc_type_rot_spd_random_max }), capwid, true, suffix });
					if (idVar(global::ptype_edit, rot_spd_extend) > 0)
					{
						global::axis_edit = sn;
						tab_template_editor_particles_value(self, { /*"particleeditortyperotationspeedy"*/ STR(3522), idVar(global::ptype_edit, rot_spd).Value(sn), idVar(global::ptype_edit, rot_spd_israndom).Value(sn), idVar(global::ptype_edit, rot_spd_random_min).Value(sn), idVar(global::ptype_edit, rot_spd_random_max).Value(sn), 1.0 / 2.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(180), IntType(180) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_yrot_spd), idInt(sVar(tab), tbx_type_yrot_spd_random) }), ArrType::From({ ID_action_lib_pc_type_rot_spd, ID_action_lib_pc_type_rot_spd_israndom, ID_action_lib_pc_type_rot_spd_random_min, ID_action_lib_pc_type_rot_spd_random_max }), capwid, true, suffix });
						global::axis_edit = ud;
						tab_template_editor_particles_value(self, { /*"particleeditortyperotationspeedz"*/ STR(3523), idVar(global::ptype_edit, rot_spd).Value(ud), idVar(global::ptype_edit, rot_spd_israndom).Value(ud), idVar(global::ptype_edit, rot_spd_random_min).Value(ud), idVar(global::ptype_edit, rot_spd_random_max).Value(ud), 1.0 / 2.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(180), IntType(180) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_zrot_spd), idInt(sVar(tab), tbx_type_zrot_spd_random) }), ArrType::From({ ID_action_lib_pc_type_rot_spd, ID_action_lib_pc_type_rot_spd_israndom, ID_action_lib_pc_type_rot_spd_random_min, ID_action_lib_pc_type_rot_spd_random_max }), capwid, true, suffix });
					}
					global::axis_edit = X_;
					tab_template_editor_particles_value(self, { /*"particleeditortyperotationspeed"*/ STR(3520) + ((idVar(global::ptype_edit, rot_spd_extend) > 0) ? /*"x"*/ STR(818) : /*"xyz"*/ STR(3497)) + /*"add"*/ STR(602), idVar(global::ptype_edit, rot_spd_add).Value(X_), idVar(global::ptype_edit, rot_spd_add_israndom).Value(X_), idVar(global::ptype_edit, rot_spd_add_random_min).Value(X_), idVar(global::ptype_edit, rot_spd_add_random_max).Value(X_), 1.0 / 10.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(10), IntType(10) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_xrot_spd_add), idInt(sVar(tab), tbx_type_xrot_spd_add_random) }), ArrType::From({ ID_action_lib_pc_type_rot_spd_add, ID_action_lib_pc_type_rot_spd_add_israndom, ID_action_lib_pc_type_rot_spd_add_random_min, ID_action_lib_pc_type_rot_spd_add_random_max }), capwid, true, suffix });
					if (idVar(global::ptype_edit, rot_spd_extend) > 0)
					{
						global::axis_edit = sn;
						tab_template_editor_particles_value(self, { /*"particleeditortyperotationspeedyadd"*/ STR(3525), idVar(global::ptype_edit, rot_spd_add).Value(sn), idVar(global::ptype_edit, rot_spd_add_israndom).Value(sn), idVar(global::ptype_edit, rot_spd_add_random_min).Value(sn), idVar(global::ptype_edit, rot_spd_add_random_max).Value(sn), 1.0 / 20.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(10), IntType(10) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_yrot_spd_add), idInt(sVar(tab), tbx_type_yrot_spd_add_random) }), ArrType::From({ ID_action_lib_pc_type_rot_spd_add, ID_action_lib_pc_type_rot_spd_add_israndom, ID_action_lib_pc_type_rot_spd_add_random_min, ID_action_lib_pc_type_rot_spd_add_random_max }), capwid, true, suffix });
						global::axis_edit = ud;
						tab_template_editor_particles_value(self, { /*"particleeditortyperotationspeedzadd"*/ STR(3526), idVar(global::ptype_edit, rot_spd_add).Value(ud), idVar(global::ptype_edit, rot_spd_add_israndom).Value(ud), idVar(global::ptype_edit, rot_spd_add_random_min).Value(ud), idVar(global::ptype_edit, rot_spd_add_random_max).Value(ud), 1.0 / 10.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(10), IntType(10) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_zrot_spd_add), idInt(sVar(tab), tbx_type_zrot_spd_add_random) }), ArrType::From({ ID_action_lib_pc_type_rot_spd_add, ID_action_lib_pc_type_rot_spd_add_israndom, ID_action_lib_pc_type_rot_spd_add_random_min, ID_action_lib_pc_type_rot_spd_add_random_max }), capwid, true, suffix });
					}
					global::axis_edit = X_;
					tab_template_editor_particles_value(self, { /*"particleeditortyperotationspeed"*/ STR(3520) + ((idVar(global::ptype_edit, rot_spd_extend) > 0) ? /*"x"*/ STR(818) : /*"xyz"*/ STR(3497)) + /*"mul"*/ STR(3512), idVar(global::ptype_edit, rot_spd_mul).Value(X_), idVar(global::ptype_edit, rot_spd_mul_israndom).Value(X_), idVar(global::ptype_edit, rot_spd_mul_random_min).Value(X_), idVar(global::ptype_edit, rot_spd_mul_random_max).Value(X_), 1.0 / 200.0, IntType(0), no_limit, ArrType::From({ IntType(1), 0.75, 0.9 }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_xrot_spd_mul), idInt(sVar(tab), tbx_type_xrot_spd_mul_random) }), ArrType::From({ ID_action_lib_pc_type_rot_spd_mul, ID_action_lib_pc_type_rot_spd_mul_israndom, ID_action_lib_pc_type_rot_spd_mul_random_min, ID_action_lib_pc_type_rot_spd_mul_random_max }), capwid, true, suffix });
					if (idVar(global::ptype_edit, rot_spd_extend) > 0)
					{
						global::axis_edit = sn;
						tab_template_editor_particles_value(self, { /*"particleeditortyperotationspeedymul"*/ STR(3528), idVar(global::ptype_edit, rot_spd_mul).Value(sn), idVar(global::ptype_edit, rot_spd_mul_israndom).Value(sn), idVar(global::ptype_edit, rot_spd_mul_random_min).Value(sn), idVar(global::ptype_edit, rot_spd_mul_random_max).Value(sn), 1.0 / 200.0, IntType(0), no_limit, ArrType::From({ IntType(1), 0.75, 0.9 }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_yrot_spd_mul), idInt(sVar(tab), tbx_type_yrot_spd_mul_random) }), ArrType::From({ ID_action_lib_pc_type_rot_spd_mul, ID_action_lib_pc_type_rot_spd_mul_israndom, ID_action_lib_pc_type_rot_spd_mul_random_min, ID_action_lib_pc_type_rot_spd_mul_random_max }), capwid, true, suffix });
						global::axis_edit = ud;
						tab_template_editor_particles_value(self, { /*"particleeditortyperotationspeedzmul"*/ STR(3529), idVar(global::ptype_edit, rot_spd_mul).Value(ud), idVar(global::ptype_edit, rot_spd_mul_israndom).Value(ud), idVar(global::ptype_edit, rot_spd_mul_random_min).Value(ud), idVar(global::ptype_edit, rot_spd_mul_random_max).Value(ud), 1.0 / 200.0, IntType(0), no_limit, ArrType::From({ IntType(1), 0.75, 0.9 }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_zrot_spd_mul), idInt(sVar(tab), tbx_type_zrot_spd_mul_random) }), ArrType::From({ ID_action_lib_pc_type_rot_spd_mul, ID_action_lib_pc_type_rot_spd_mul_israndom, ID_action_lib_pc_type_rot_spd_mul_random_min, ID_action_lib_pc_type_rot_spd_mul_random_max }), capwid, true, suffix });
					}
					tab_collapse_end(self);
				}
			}
			...
			{
				capwid = text_caption_width(self, { /*"particleeditortypespriteangle"*/ STR(3534), /*"particleeditortypespriteangleadd"*/ STR(3535) });
				tab_template_editor_particles_value(self, { /*"particleeditortypespriteangle"*/ STR(3534), idVar(global::ptype_edit, sprite_angle), idVar(global::ptype_edit, sprite_angle_israndom), idVar(global::ptype_edit, sprite_angle_random_min), idVar(global::ptype_edit, sprite_angle_random_max), 1.0 / 5.0, IntType(0), no_limit, ArrType::From({ IntType(0), IntType(0), IntType(360) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_sprite_angle), idInt(sVar(tab), tbx_type_sprite_angle_random) }), ArrType::From({ ID_action_lib_pc_type_sprite_angle, ID_action_lib_pc_type_sprite_angle_israndom, ID_action_lib_pc_type_sprite_angle_random_min, ID_action_lib_pc_type_sprite_angle_random_max }), capwid });
				tab_template_editor_particles_value(self, { /*"particleeditortypespriteangleadd"*/ STR(3535), idVar(global::ptype_edit, sprite_angle_add), idVar(global::ptype_edit, sprite_angle_add_israndom), idVar(global::ptype_edit, sprite_angle_add_random_min), idVar(global::ptype_edit, sprite_angle_add_random_max), 1.0 / 10.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(90), IntType(90) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_sprite_angle_add), idInt(sVar(tab), tbx_type_sprite_angle_add_random) }), ArrType::From({ ID_action_lib_pc_type_sprite_angle_add, ID_action_lib_pc_type_sprite_angle_add_israndom, ID_action_lib_pc_type_sprite_angle_add_random_min, ID_action_lib_pc_type_sprite_angle_add_random_max }), capwid, true, suffix });
			}
		}
		draw_divide(sVar(content_x), sVar(dy), dividew);
		sVar(dy) += IntType(12);
		tab_control(self, IntType(16));
		draw_label(self, { text_get({ /*"particleeditortypescale"*/ STR(3536) }), sVar(dx), sVar(dy) + IntType(8), fa_left, fa_middle, global::c_text_tertiary, global::a_text_tertiary, sInt(font_subheading) });
		tab_next(self);
		capwid = text_caption_width(self, { /*"particleeditortypeinitialscale"*/ STR(3537), /*"particleeditortypescaleadd"*/ STR(3538) });
		tab_template_editor_particles_value(self, { /*"particleeditortypeinitialscale"*/ STR(3537), idVar(global::ptype_edit, scale), idVar(global::ptype_edit, scale_israndom), idVar(global::ptype_edit, scale_random_min), idVar(global::ptype_edit, scale_random_max), 1.0 / 100.0, IntType(0), no_limit, ArrType::From({ IntType(1), 0.5, IntType(2) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_scale), idInt(sVar(tab), tbx_type_scale_random) }), ArrType::From({ ID_action_lib_pc_type_scale, ID_action_lib_pc_type_scale_israndom, ID_action_lib_pc_type_scale_random_min, ID_action_lib_pc_type_scale_random_max }), capwid });
		tab_template_editor_particles_value(self, { /*"particleeditortypescaleadd"*/ STR(3538), idVar(global::ptype_edit, scale_add), idVar(global::ptype_edit, scale_add_israndom), idVar(global::ptype_edit, scale_add_random_min), idVar(global::ptype_edit, scale_add_random_max), 1.0 / 100.0, -no_limit, no_limit, ArrType::From({ IntType(0), -0.2, -0.1 }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_scale_add), idInt(sVar(tab), tbx_type_scale_add_random) }), ArrType::From({ ID_action_lib_pc_type_scale_add, ID_action_lib_pc_type_scale_add_israndom, ID_action_lib_pc_type_scale_add_random_min, ID_action_lib_pc_type_scale_add_random_max }), capwid, true, suffix });
		sVar(dy) += IntType(10);
		draw_divide(sVar(content_x), sVar(dy), dividew);
		sVar(dy) += IntType(12);
		tab_control(self, IntType(16));
		draw_label(self, { text_get({ /*"particleeditortypeappearance"*/ STR(3539) }), sVar(dx), sVar(dy) + IntType(8), fa_left, fa_middle, global::c_text_tertiary, global::a_text_tertiary, sInt(font_subheading) });
		tab_next(self);
		tab_control_meter(self);
		draw_button_icon(self, { /*"particleeditorrandomalpha"*/ STR(3540), sVar(dx) + sVar(dw) - sReal(ui_small_height), sVar(dy), sReal(ui_small_height), sReal(ui_small_height), idVar(global::ptype_edit, alpha_israndom), icons_RANDOMIZE, ID_action_lib_pc_type_alpha_israndom, false, /*"tooltipparticlesrandom"*/ STR(3541) });
		if (idVar(global::ptype_edit, alpha_israndom) > 0)
			draw_meter_range(self, /*"particleeditortypeopacity"*/ STR(3542), sVar(dx), sVar(dy), sVar(dw) - IntType(36), IntType(0), IntType(100), IntType(1), round(idVar(global::ptype_edit, alpha_random_min) * IntType(100)), round(idVar(global::ptype_edit, alpha_random_max) * IntType(100)), IntType(0), IntType(100), idInt(sVar(tab), tbx_type_alpha), idInt(sVar(tab), tbx_type_alpha_random), ID_action_lib_pc_type_alpha_random_min, ID_action_lib_pc_type_alpha_random_max);
		else
			draw_meter(self, /*"particleeditortypeopacity"*/ STR(3542), sVar(dx), sVar(dy), sVar(dw) - IntType(36), round(idVar(global::ptype_edit, alpha) * IntType(100)), IntType(0), IntType(100), IntType(100), IntType(1), idInt(sVar(tab), tbx_type_alpha), ID_action_lib_pc_type_alpha);
		
		tab_next(self);
		tab_template_editor_particles_value(self, { /*"particleeditortypeopacityadd"*/ STR(3543), idVar(global::ptype_edit, alpha_add) * IntType(100), idVar(global::ptype_edit, alpha_add_israndom), idVar(global::ptype_edit, alpha_add_random_min) * IntType(100), idVar(global::ptype_edit, alpha_add_random_max) * IntType(100), 1.0 / 2.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(10), -IntType(5) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_alpha_add), idInt(sVar(tab), tbx_type_alpha_add_random) }), ArrType::From({ ID_action_lib_pc_type_alpha_add, ID_action_lib_pc_type_alpha_add_israndom, ID_action_lib_pc_type_alpha_add_random_min, ID_action_lib_pc_type_alpha_add_random_max }), null_, true, suffix });
		VarType name;
		RealType colwid;
		wid = (sVar(dw) - IntType(36));
		colwid = floor((wid - IntType(8)) / 2.0);
		tab_control_switch(self);
		draw_switch(self, { /*"particleeditortypecolormixenabled"*/ STR(3544), sVar(dx), sVar(dy), idVar(global::ptype_edit, color_mix_enabled), ID_action_lib_pc_type_color_mix_enabled });
		tab_next(self);
		if (idVar(global::ptype_edit, color_mix_enabled) > 0)
		{
			tab_control(self, IntType(20));
			draw_label(self, { text_get({ /*"particleeditortypecolorstart"*/ STR(3545) }), sVar(dx), sVar(dy) + IntType(10), fa_left, fa_middle, global::c_text_secondary, global::a_text_secondary, sInt(font_label) });
			tab_next(self);
		}
		tab_control_color(self);
		draw_button_icon(self, { /*"particleeditorrandomcolor"*/ STR(3546), sVar(dx) + sVar(dw) - sReal(ui_small_height), sVar(dy) + ((RealType)sVar(tab_control_h) / 2.0) - IntType(12), sReal(ui_small_height), sReal(ui_small_height), idVar(global::ptype_edit, color_israndom), icons_RANDOMIZE, ID_action_lib_pc_type_color_israndom, false, /*"tooltipparticlesrandom"*/ STR(3541) });
		if (idVar(global::ptype_edit, color_israndom) > 0)
		{
			name = (idVar(global::ptype_edit, color_mix_enabled) > 0) ? /*"particleeditortypecolorstartcolor1"*/ STR(3547) : /*"particleeditortypecolorcolor1"*/ STR(3548);
			...
			name = (idVar(global::ptype_edit, color_mix_enabled) > 0) ? /*"particleeditortypecolorstartcolor2"*/ STR(3549) : /*"particleeditortypecolorcolor2"*/ STR(3550);
		...
		{
			name = (idVar(global::ptype_edit, color_mix_enabled) > 0) ? /*"particleeditortypecolorstartcolor"*/ STR(3551) : /*"particleeditortypecolorcolor"*/ STR(3552);
		...
		{
			tab_control(self, IntType(20));
			draw_label(self, { text_get({ /*"particleeditortypecolorend"*/ STR(3553) }), sVar(dx), sVar(dy) + IntType(10), fa_left, fa_middle, global::c_text_secondary, global::a_text_secondary, sInt(font_label) });
			tab_next(self);
			tab_control_color(self);
			draw_button_icon(self, { /*"particleeditorrandommixcolor"*/ STR(3554), sVar(dx) + sVar(dw) - sReal(ui_small_height), sVar(dy) + ((RealType)sVar(tab_control_h) / 2.0) - IntType(12), sReal(ui_small_height), sReal(ui_small_height), idVar(global::ptype_edit, color_mix_israndom), icons_RANDOMIZE, ID_action_lib_pc_type_color_mix_israndom, false, /*"tooltipparticlesrandom"*/ STR(3541) });
			if (idVar(global::ptype_edit, color_mix_israndom) > 0)
			{
				draw_button_color(self, /*"particleeditortypecolorendcolor1"*/ STR(3555), sVar(dx), sVar(dy), colwid, idVar(global::ptype_edit, color_mix_random_start), c_gray, false, ID_action_lib_pc_type_color_mix_random_start);
				draw_button_color(self, /*"particleeditortypecolorendcolor2"*/ STR(3556), sVar(dx) + colwid + IntType(8), sVar(dy), colwid, idVar(global::ptype_edit, color_mix_random_end), c_white, false, ID_action_lib_pc_type_color_mix_random_end);
			}
			else
				draw_button_color(self, /*"particleeditortypecolorendcolor"*/ STR(3557), sVar(dx), sVar(dy), wid, idVar(global::ptype_edit, color_mix), c_black, false, ID_action_lib_pc_type_color_mix);
			
			tab_next(self);
			tab_template_editor_particles_value(self, { /*"particleeditortypecolormixtime"*/ STR(3558), idVar(global::ptype_edit, color_mix_time), idVar(global::ptype_edit, color_mix_time_israndom), idVar(global::ptype_edit, color_mix_time_random_min), idVar(global::ptype_edit, color_mix_time_random_max), 1.0 / 20.0, IntType(0), no_limit, ArrType::From({ IntType(3), IntType(1), IntType(5) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_color_mix_time), idInt(sVar(tab), tbx_type_color_mix_time_random) }), ArrType::From({ ID_action_lib_pc_type_color_mix_time, ID_action_lib_pc_type_color_mix_time_israndom, ID_action_lib_pc_type_color_mix_time_random_min, ID_action_lib_pc_type_color_mix_time_random_max }), null_, true, suffix });
		}
		draw_divide(sVar(content_x), sVar(dy), dividew);
		sVar(dy) += IntType(12);
		tab_control(self, IntType(16));
		draw_label(self, { text_get({ /*"particleeditortypesimulation"*/ STR(3559) }), sVar(dx), sVar(dy) + IntType(8), fa_left, fa_middle, global::c_text_tertiary, global::a_text_tertiary, sInt(font_subheading) });
		tab_next(self);
		tab_control_switch(self);
		draw_switch(self, { /*"particleeditortypespawnregion"*/ STR(3560), sVar(dx), sVar(dy), idVar(global::ptype_edit, spawn_region), ID_action_lib_pc_type_spawn_region });
		tab_next(self);
		tab_control_switch(self);
		draw_switch(self, { /*"particleeditortypeorbit"*/ STR(3561), sVar(dx), sVar(dy), idVar(global::ptype_edit, orbit), ID_action_lib_pc_type_orbit });
		tab_next(self);
		tab_control_switch(self);
		draw_switch(self, { /*"particleeditortypeboundingbox"*/ STR(3562), sVar(dx), sVar(dy), idVar(global::ptype_edit, bounding_box), ID_action_lib_pc_type_bounding_box });
		tab_next(self);
		if (idVar(global::ptype_edit, bounding_box) > 0)
		{
			tab_control_switch(self);
			draw_switch(self, { /*"particleeditortypebounce"*/ STR(3563), sVar(dx), sVar(dy) + IntType(1), idVar(global::ptype_edit, bounce), ID_action_lib_pc_type_bounce });
			tab_next(self);
			if (idVar(global::ptype_edit, bounce) > 0)
			{
				tab_control_dragger(self);
				draw_dragger(self, { /*"particleeditortypebouncefactor"*/ STR(3564), sVar(dx), sVar(dy), IntType(64), idVar(global::ptype_edit, bounce_factor), 1.0 / 100.0, IntType(0), no_limit, 0.5, IntType(0), idInt(sVar(tab), tbx_type_bounce_factor), ID_action_lib_pc_type_bounce_factor });
				tab_next(self);
			}
		}
		return 0.0;
	...
	RealType tab_template_editor_particles_framebox(ScopeAny self)
	{
		...
		if (app_mouse_box(self, xx, yy, size, size) && sBool(content_mouseon))
		{
			...
			{
				sVar(window_busy) = /*"particleeditortypeanimationstartend"*/ STR(3565);
				action_lib_pc_type_sprite_frame_start(self, mouseframe, false);
				action_lib_pc_type_sprite_frame_end(self, mouseframe, false);
			}
		}
		if (sVar(window_busy) == /*"particleeditortypeanimationstartend"*/ STR(3565))
		{
			sInt(mouse_cursor) = cr_handpoint;
			action_lib_pc_type_sprite_frame_end(self, mouseframe, false);
			if (!sBool(mouse_left))
		...
		for (VarType f = min({ idVar(global::ptype_edit, sprite_frame_start), idVar(global::ptype_edit, sprite_frame_end) }); f <= max({ idVar(global::ptype_edit, sprite_frame_start), idVar(global::ptype_edit, sprite_frame_end) }); f++)
		{
			...
			if (f == idVar(global::ptype_edit, sprite_frame_start))
			{
				col = global::c_accent;
				alpha = IntType(1);
				draw_label(self, { text_get({ /*"particleeditortypespriteframeboxstart"*/ STR(3566) }), bx + floor(fwid / 2.0), min({ by + ((reverse > 0) ? 0.0 : fhei), yy + size }), fa_center, (reverse > 0) ? fa_bottom : fa_top, col, IntType(1), sInt(font_label) });
			}
			else
				if (f == idVar(global::ptype_edit, sprite_frame_end))
				{
					col = global::c_error;
					alpha = IntType(1);
					draw_label(self, { text_get({ /*"particleeditortypespriteframeboxend"*/ STR(3567) }), bx + floor(fwid / 2.0), min({ by + (!(reverse > 0) ? 0.0 : fhei), yy + size }), fa_center, !(reverse > 0) ? fa_bottom : fa_top, col, IntType(1), sInt(font_label) });
				}
	...
	RealType tab_template_editor_particles_preview(ScopeAny self)
	{
		...
		{
			if (draw_button_icon(self, { /*"particlesresetpreview"*/ STR(3568), xx + size + IntType(4), yy + size - IntType(24), IntType(24), IntType(24), false, icons_RESET, null_, false, /*"tooltipparticlesresetpreview"*/ STR(3569) }))
	...
	void tab_template_editor_particles_value(ScopeAny self, VarArgs argument)
	{
		...
		tab_control_dragger(self);
		draw_button_icon(self, { /*"particleeditorrandom"*/ STR(3570) + name, sVar(dx) + sVar(dw) - sReal(ui_small_height), sVar(dy), sReal(ui_small_height), sReal(ui_small_height), israndom, icons_RANDOMIZE, scripts.Value(IntType(1)), false, /*"tooltipparticlesrandom"*/ STR(3541) });
		VarType suf1, suf2;
		...
		if (israndom > 0)
		{
			...
			textfield_group_add(self, { name + /*"min"*/ STR(1061), randommin, def.Value(IntType(1)), scripts.Value(IntType(2)), global::axis_edit, tbx.Value(IntType(0)), null_, mul, minval, randommax, /*"particleeditormin"*/ STR(3571) });
			textfield_group_add(self, { name + /*"max"*/ STR(1062), randommax, def.Value(IntType(2)), scripts.Value(IntType(3)), global::axis_edit, tbx.Value(IntType(1)), null_, mul, randommin, maxval, /*"particleeditormax"*/ STR(3572) });
	...
	void tab_timeline(ScopeAny self)
	{
		...
		timelabel = (sReal(timeline_show_frames) > 0) ? text_get({ /*"timelineframe"*/ STR(3573), floor(sVar(timeline_marker)) }) : string_time_seconds((RealType)sVar(timeline_marker) / sVar(project_tempo));
		...
		timelabel = (sReal(timeline_show_frames) > 0) ? /*" / "*/ STR(3574) + string(sVar(timeline_length)) : /*" / "*/ STR(3574) + string_time_seconds((RealType)sVar(timeline_length) / sVar(project_tempo));
		...
		{
			timelabel = /*" ("*/ STR(1101) + ((sReal(timeline_show_frames) > 0) ? VarType(string(sVar(timeline_region_end) - sVar(timeline_region_start))) : string_time_seconds((sVar(timeline_region_end) - sVar(timeline_region_start)) / sVar(project_tempo))) + /*")"*/ STR(1077);
		...
		draw_button_icon(self, { /*"timelinepreviouskeyframe"*/ STR(3575), buttonsx, buttonsy, IntType(24), IntType(24), false, icons_KEYFRAME_PREVIOUS, ID_action_tl_keyframe_previous, sReal(timeline_playing), /*"tooltiptlpreviouskeyframe"*/ STR(3576) });
		buttonsx += IntType(24) + IntType(6);
		if (draw_button_icon(self, { /*"timelinepreviousframe"*/ STR(3577), buttonsx, buttonsy, IntType(24), IntType(24), false, icons_FRAME_PREVIOUS, null_, sReal(timeline_playing), /*"tooltiptlpreviousframe"*/ STR(3578) }))
		...
		buttonsx += IntType(6);
		draw_button_icon(self, { /*"timelinestop"*/ STR(3579), buttonsx, buttonsy, IntType(24), IntType(24), false, icons_STOP, ID_action_tl_play_stop, false, /*"tooltiptlstop"*/ STR(3580) });
		buttonsx += IntType(24) + IntType(6);
		tip_set_keybind(self, e_keybind_PLAY);
		draw_button_icon(self, { /*"timelineplay"*/ STR(3581), buttonsx, buttonsy, IntType(24), IntType(24), false, (sReal(timeline_playing) > 0) ? icons_PAUSE : icons_PLAY, ID_action_tl_play, false, (sReal(timeline_playing) > 0) ? /*"tooltiptlpause"*/ STR(3582) : /*"tooltiptlplay"*/ STR(3583) });
		buttonsx += IntType(24) + IntType(6);
		if (draw_button_icon(self, { /*"timelineplayregion"*/ STR(3584), buttonsx, buttonsy, IntType(24), IntType(24), false, icons_PLAY_REGION, null_, sVar(timeline_region_start) == null_, /*"tooltiptlplayregion"*/ STR(3585) }))
		{
		...
		draw_divide_vertical(buttonsx, buttonsy + IntType(2), IntType(20));
		buttonsx += IntType(6);
		if (draw_button_icon(self, { /*"timelinenextframe"*/ STR(3586), buttonsx, buttonsy, IntType(24), IntType(24), false, icons_FRAME_NEXT, null_, sReal(timeline_playing), /*"tooltiptlnextframe"*/ STR(3587) }))
		...
		buttonsx += IntType(24) + IntType(6);
		draw_button_icon(self, { /*"timelinenextkeyframe"*/ STR(3588), buttonsx, buttonsy, IntType(24), IntType(24), false, icons_KEYFRAME_NEXT, ID_action_tl_keyframe_next, sReal(timeline_playing), /*"tooltiptlnextkeyframe"*/ STR(3589) });
		...
		{
			if (draw_button_icon(self, { /*"timelinewalkcycle"*/ STR(3590), buttonsx, buttonsy, IntType(24), IntType(24), false, icons_WALK_CYCLE, null_, !file_exists_lib(sStr(timeline_settings_walk_fn)), /*"tooltiptlwalk"*/ STR(3591) }))
				action_tl_load_loop(self, sStr(timeline_settings_walk_fn));
			buttonsx += IntType(24) + IntType(6);
			if (draw_button_icon(self, { /*"timelineruncycle"*/ STR(3592), buttonsx, buttonsy, IntType(24), IntType(24), false, icons_RUN_CYCLE, null_, !file_exists_lib(sStr(timeline_settings_run_fn)), /*"tooltiptlrun"*/ STR(3593) }))
		...
		draw_button_icon(self, { /*"timelineintervals"*/ STR(3594), buttonsx, buttonsy, IntType(24), IntType(24), sVar(timeline_intervals_show), icons_STOPWATCH, ID_action_tl_intervals_show, false, (sVar(timeline_intervals_show) > 0) ? /*"timelineintervalshide"*/ STR(3595) : /*"timelineintervalsshow"*/ STR(3596) });
		buttonsx += IntType(24);
		if (draw_button_icon(self, { /*"timelineintervalsettings"*/ STR(3597), buttonsx, buttonsy, IntType(16), IntType(24), sStr(settings_menu_name) == /*"timelineintervalsettings"*/ STR(3597), icons_CHEVRON_DOWN_TINY, null_, false }))
		{
			menu_settings_set(self, buttonsx, buttonsy, /*"timelineintervalsettings"*/ STR(3597), IntType(24));
			sInt(settings_menu_script) = ID_tl_interval_settings_draw;
		}
		if (sStr(settings_menu_name) == /*"timelineintervalsettings"*/ STR(3597) && sStr(settings_menu_ani_type) != /*"hide"*/ STR(719))
		...
		if (!(sVar(timeline_repeat) > 0) && !(sVar(timeline_seamless_repeat) > 0))
			tooltip = /*"tooltiptlenableloop"*/ STR(3598);
		else
			if (sVar(timeline_repeat) > 0 && !(sVar(timeline_seamless_repeat) > 0))
				tooltip = /*"tooltiptlenableseamlessloop"*/ STR(3599);
			else
				tooltip = /*"tooltiptldisableloop"*/ STR(3600);
		
		
		draw_button_icon(self, { /*"timelineloop"*/ STR(3601), buttonsx, buttonsy, IntType(24), IntType(24), sVar(timeline_repeat) > 0 || sVar(timeline_seamless_repeat) > 0, (sVar(timeline_seamless_repeat) > 0) ? icons_REPEAT_SEAMLESS : icons_REPEAT, ID_action_tl_play_repeat, false, tooltip });
		buttonsx += IntType(24) + IntType(4);
		draw_divide_vertical(buttonsx, buttonsy, IntType(24));
		buttonsx += IntType(4);
		if (window_get_current() == e_window_MAIN)
		{
			if (draw_button_icon(self, { /*"tabpopout"*/ STR(3602), buttonsx, buttonsy, IntType(24), IntType(24), false, icons_EXTERNAL, null_, false, /*"tooltiptlpopout"*/ STR(3603) }))
			{
		...
		{
			if (draw_button_icon(self, { /*"tabpopback"*/ STR(3604), buttonsx, buttonsy, IntType(24), IntType(24), false, icons_INTERNAL, null_, false, /*"tooltiptlpopin"*/ STR(3605) }))
		...
		if (sVar(project_file) != /*""*/ STR(0) && !instance_exists(ID_obj_timeline) && sVar(content_height) > IntType(100) && (ds_list_size(sInt(timeline_marker_list)) == IntType(0)))
		{
			...
			textwid = string_width(text_get({ /*"timelineempty"*/ STR(3606) }));
			if (tlw > (textwid + IntType(32)))
				draw_label(self, { text_get({ /*"timelineempty"*/ STR(3606) }), floor(tlx + tlw / 2.0 - textwid / 2.0), floor(tly + tlh / 2.0), fa_left, fa_middle, global::c_text_secondary, global::a_text_secondary });
		}
		sVar(dy) = tly;
		...
		if (sVar(window_busy) == /*"timelineselectkeyframes"*/ STR(3607))
		{
			sInt(mouse_cursor) = cr_handpoint;
		...
		if (markerbarh != IntType(0))
		{
			...
			for (IntType i = IntType(0); i < ds_list_size(sInt(timeline_marker_list)); i++)
			{
				...
				name = idVar(marker, name) + (dev_mode_debug_names ? /*" ["*/ STR(1760) + idVar(marker, save_id) + /*"]"*/ STR(1202) : /*""*/ STR(0));
			...
			{
				context_menu_area(self, { markerbarx, markerbary, markerbarw, markerbarh, /*"timelinemarker"*/ STR(1522), markermouseon, null_, null_, null_ });
				if (sBool(mouse_left_pressed))
				{
					sVar(window_busy) = /*"timelinemovemarker"*/ STR(3608);
			...
			if (sVar(window_busy) == /*"timelinemovemarker"*/ STR(3608))
			{
				BoolType fail;
				RealType mousepos;
				fail = false;
		...
		if (sReal(setting_advanced_mode) > 0)
		{
			if (draw_button_icon(self, { /*"timelinefilter"*/ STR(3609), listx + IntType(8), bary + IntType(4), IntType(24), IntType(24), sVar(setting_timeline_hide_ghosts) > 0 || !array_equals(VarType::CreateRef(sVar(timeline_hide_color_tag)), VarType::CreateRef(array_create({ array_length(VarType::CreateRef(sVar(timeline_hide_color_tag))), false }))), icons_FILTER, null_, false, /*"tooltiptlfilter"*/ STR(3610) }))
			{
				menu_settings_set(self, listx + IntType(8), bary + IntType(4), /*"timelinefilter"*/ STR(3609), IntType(24));
				sInt(settings_menu_script) = ID_tl_filter_draw;
				sBool(settings_menu_above) = true;
			}
			if (sStr(settings_menu_name) == /*"timelinefilter"*/ STR(3609) && sStr(settings_menu_ani_type) != /*"hide"*/ STR(719))
				ObjType(value_animation, ObjType(micro_animation, global::current_microani)->active)->value = true;
		}
		VarType searchx;
		RealType searchwid;
		...
		draw_textfield(self, { /*"timelinesearch"*/ STR(3611), searchx, bary + IntType(4), searchwid, IntType(24), idInt(sVar(timeline), tbx_search), ID_action_tl_search, text_get({ /*"listsearch"*/ STR(2890) }), /*"none"*/ STR(875) });
		if (mouseinnames)
			context_menu_area(self, { listx, listy, listw, listh, /*"timelinelist"*/ STR(1493), mousetl, null_, null_, null_ });
		sVar(dy) = listy;
		RealType itemmaxw;
		tlmaxw = IntType(0);
		for (RealType t = sReal(timeline_list_first); t < ds_list_size(sInt(tree_visible_list)); t++)
		{
			...
			if ((itemhover && sBool(mouse_left)) || idReal(tl, selected) > 0)
				...
				if (idReal(tl, selected) > 0 || itemhover || tl == sVar(context_menu_value) || (sVar(window_busy) == /*"timelineclick"*/ STR(3612) && sVar(timeline_select) == tl))
			...
			if (itemhover || idVar(tl, hide) > 0)
			{
				...
				{
					if (draw_button_icon(self, { /*"timelinehide"*/ STR(256) + string(tl), xx, itemy + buttonpad, buttonsize, buttonsize, idVar(tl, hide), (idVar(tl, hide) > 0) ? icons_HIDDEN_SMALL : icons_VISIBLE_SMALL, null_, false, (idVar(tl, hide) > 0) ? /*"tooltiptlshow"*/ STR(3613) : /*"tooltiptlhide"*/ STR(3614) }))
						action_tl_hide(self, tl);
				}
				else
				{
					if (draw_button_icon(self, { /*"timelinehide"*/ STR(256) + string(tl), xx, itemy + buttonpad, buttonsize, buttonsize, idVar(tl, hide), (idVar(tl, hide) > 0) ? icons_MUTE_SMALL : icons_VOLUME_SMALL, null_, false, (idVar(tl, hide) > 0) ? /*"tooltiptlunmute"*/ STR(3615) : /*"tooltiptlmute"*/ STR(3616) }))
						action_tl_hide(self, tl);
				}
			...
			{
				if (draw_button_icon(self, { /*"timelinelock"*/ STR(3617) + string(tl), xx, itemy + buttonpad, buttonsize, buttonsize, idVar(tl, lock), (idVar(tl, lock) > 0) ? icons_LOCK_SMALL : icons_UNLOCK_SMALL, null_, false, ((idVar(tl, lock) > 0) ? /*"tooltiptlunlock"*/ STR(3618) : /*"tooltiptllock"*/ STR(3619)) }))
			...
			if (!(sVar(setting_timeline_hide_ghosts) > 0) && sReal(setting_advanced_mode) > 0)
			{
				...
				{
					if (draw_button_icon(self, { /*"timelineghosttl"*/ STR(3620) + string(tl), xx, itemy + buttonpad, buttonsize, buttonsize, idVar(tl, ghost), icons_GHOST_SMALL, null_, false, ((idVar(tl, ghost) > 0) ? /*"tooltiptlunghost"*/ STR(3621) : /*"tooltiptlghost"*/ STR(3622)) }))
			...
			if (itemhover)
			{
				if (draw_button_icon(self, { /*"timelineselectkeyframes"*/ STR(3607) + string(tl), xx, itemy + buttonpad, buttonsize, buttonsize, false, icons_KEYFRAME_SMALL, null_, false, /*"contextmenutlselectkeyframes"*/ STR(1495) }))
			...
			if (tlhierarchy)
			{
				...
				{
					if (draw_button_icon(self, { /*"timelineexpand"*/ STR(3623) + string(tl), xx, itemy + buttonpad, buttonsize, buttonsize, idVar(tl, tree_extend), null_, null_, false, ((idVar(tl, tree_extend) > 0) ? /*"tooltiptlcollapse"*/ STR(1657) : /*"tooltiptlexpand"*/ STR(1658)), ID_spr_chevron_ani }))
			...
			if (!(sReal(setting_timeline_compact) > 0))
			{
				VarType iconcolor;
				RealType iconalpha;
				if (idReal(tl, selected) > 0 || (sVar(window_busy) == /*"timelineclick"*/ STR(3612) && sVar(timeline_select) == tl) || ((itemhover && !buttonhover) && (sBool(mouse_left) || sBool(mouse_left_released))))
				{
					if (idVar(tl, color_tag) == null_)
			...
			else
			{
				...
				if (dev_mode_debug_saveid)
					name += /*" ["*/ STR(1760) + string(idVar(tl, save_id)) + /*"]"*/ STR(1202);
				if (name != /*""*/ STR(0))
				{
					if (idVar(tl, color_tag) != null_)
			...
			if (sVar(window_busy) == /*"timelineclick"*/ STR(3612))
			{
				sVar(window_busy) = /*""*/ STR(0);
				if (app_mouse_box(self, xx - IntType(28), itemy, string_width(name) + IntType(28), itemh))
					mousetlname = tl;
				sVar(window_busy) = /*"timelineclick"*/ STR(3612);
			}
		...
		if (app_mouse_box(self, tlx - IntType(5), tly - barh, IntType(5), sVar(content_height) - headerh))
		{
			...
			if (sBool(mouse_left_pressed))
			{
				sVar(window_busy) = /*"timelinelistresize"*/ STR(3624);
				sVar(timeline_list_resize_start) = listw;
			}
		}
		if (sVar(window_busy) == /*"timelinelistresize"*/ STR(3624))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (mousekfend > 0)
		{
			...
			if (sBool(mouse_left_pressed))
			{
				...
				sVar(window_busy) = /*"timelinesetsoundend"*/ STR(3625);
			}
		}
		if (sVar(window_busy) == /*""*/ STR(0) && mouseintl && !(mousekfstart > 0) && !(mousekfend > 0))
		{
			...
			if (sBool(mouse_left_pressed))
			{
				...
				{
					sVar(window_busy) = /*"timelineclickkeyframes"*/ STR(3626);
			...
			{
				sVar(window_focus) = /*"timeline"*/ STR(119);
				sVar(window_busy) = /*"timelinedrag"*/ STR(3627);
			}
		}
		...
		if (sVar(window_busy) == /*"timelinesetsoundend"*/ STR(3625))
		{
		...
		if (sVar(window_busy) == /*"timelineclickkeyframes"*/ STR(3626))
		{
			sInt(mouse_cursor) = cr_handpoint;
			if (sReal(mouse_move) > IntType(5))
			{
				if (!keyboard_check(vk_shift) && !keyboard_check(vk_control))
					action_tl_deselect_all(self);
				sVar(window_busy) = /*"timelineselectkeyframes"*/ STR(3607);
			}
			if (!sBool(mouse_left))
			{
				if (sVar(timeline_select) > 0)
		...
		if (app_mouse_box(self, barx, bary + IntType(5) * (IntType)(idInt(sVar(tab), panel) == DsMap(sInt(panel_map)).Value(/*"bottom"*/ STR(186))), barw, barh - IntType(5) * (IntType)(idInt(sVar(tab), panel) == DsMap(sInt(panel_map)).Value(/*"bottom"*/ STR(186)))) && !sBool(popup_mouseon) && !sBool(context_menu_mouseon) && !sBool(toast_mouseon))
		{
			...
			if (sVar(timeline_region_start) != null_)
			{
				if (app_mouse_box(self, barx + regionx1 - IntType(8), bary, IntType(8), barh))
				{
					...
					{
						sVar(window_focus) = /*"timeline"*/ STR(119);
						sVar(window_busy) = /*"timelinesetregionstart"*/ STR(3628);
					...
					if (app_mouse_box(self, barx + regionx2, bary, IntType(8), barh))
					{
						...
						{
							sVar(window_focus) = /*"timeline"*/ STR(119);
							sVar(window_busy) = /*"timelinesetregionend"*/ STR(3629);
			...
			{
				sVar(window_focus) = /*"timeline"*/ STR(119);
				sVar(window_busy) = /*"timelinemarker"*/ STR(1522);
			}
			if (sBool(mouse_right_pressed))
			{
				sVar(window_focus) = /*"timeline"*/ STR(119);
				sVar(window_busy) = /*"timelinecreateregion"*/ STR(3630);
				sVar(timeline_region_pos) = sVar(timeline_mouse_pos);
				action_tl_play_break(self);
			}
		}
		if (sVar(window_busy) == /*"timelinecreateregion"*/ STR(3630) || sVar(window_busy) == /*"timelinesetregionstart"*/ STR(3628) || sVar(window_busy) == /*"timelinesetregionend"*/ STR(3629))
		{
			BoolType release;
			if (sVar(window_busy) == /*"timelinecreateregion"*/ STR(3630))
			{
				sInt(mouse_cursor) = cr_handpoint;
			...
			if (sVar(window_busy) == /*"timelinesetregionend"*/ STR(3629))
			{
		...
		if (sVar(window_busy) == /*"timelinemarker"*/ STR(1522))
		{
			sInt(mouse_cursor) = cr_handpoint;
		...
		if (sStr(window_scroll_focus_prev) == /*"timelinezoom"*/ STR(3631) && sVar(window_busy) == /*""*/ STR(0) && sReal(mouse_wheel) != IntType(0))
		{
		...
		if (sVar(window_busy) == /*"timelinedrag"*/ STR(3627))
		{
			sInt(mouse_cursor) = cr_size_all;
		...
		if (sVar(window_busy) == /*"timelineselectkeyframes"*/ STR(3607) || sVar(window_busy) == /*"timelinemovekeyframes"*/ STR(45) || sVar(window_busy) == /*"timelinecreateregion"*/ STR(3630) || sVar(window_busy) == /*"timelinesetregionstart"*/ STR(3628) || sVar(window_busy) == /*"timelinesetregionend"*/ STR(3629) || sVar(window_busy) == /*"timelineresizesounds"*/ STR(46) || sVar(window_busy) == /*"timelinesetsoundend"*/ STR(3625) || sVar(window_busy) == /*"timelinemovemarker"*/ STR(3608))
		{
		...
		if (sBool(content_mouseon))
		{
			...
			if (mouseintl)
				sStr(shortcut_bar_state) = /*"timelinekeyframes"*/ STR(2860);
			if (mouseinnames)
				sStr(shortcut_bar_state) = /*"timelinenames"*/ STR(2866);
			if (mouseinbar)
				sStr(shortcut_bar_state) = /*"timelinebar"*/ STR(2872);
			...
			if (keyboard_check(vk_control))
				sStr(window_scroll_focus) = /*"timelinezoom"*/ STR(3631);
		}
	}
