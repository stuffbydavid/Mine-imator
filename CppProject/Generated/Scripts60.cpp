...
namespace CppProject
{
	RealType tab_template_editor_particles(ScopeAny self)
	{
		...
		if (!(idVar(global::temp_edit, pc_spawn_constant) > 0))
		{
			...
			if (draw_button_icon(self, { /*"particleeditorspawn"*/ STR(3416), setx, sVar(dy), IntType(24), IntType(24), false, icons_PARTICLES, null_, false, /*"tooltipparticlesspawn"*/ STR(2039) }))
				action_lib_pc_spawn();
			setx -= 28.0;
		}
		...
		tab_control_menu(self);
		draw_button_menu(self, { /*"particleeditorboundingbox"*/ STR(1319), e_menu_LIST, sVar(dx), sVar(dy), sVar(dw), IntType(24), idVar(global::temp_edit, pc_bounding_box_type), text_get({ /*"particleeditorboundingboxtype"*/ STR(3435) + idVar(global::temp_edit, pc_bounding_box_type) }), ID_action_lib_pc_bounding_box_type });
		tab_next(self);
		if (idVar(global::temp_edit, pc_bounding_box_type) == /*"ground"*/ STR(135))
		{
			tab_control_dragger(self);
			draw_dragger(self, { /*"particleeditorboundingboxground"*/ STR(3436) + ((sReal(setting_z_is_up) > 0) ? /*"z"*/ STR(818) : /*"y"*/ STR(800)), sVar(dx), sVar(dy), IntType(64), idVar(global::temp_edit, pc_bounding_box_ground_z), 0.1, -no_limit, no_limit, IntType(0), IntType(0), idInt(sVar(tab), tbx_bounding_box_ground_z), ID_action_lib_pc_bounding_box_ground_z });
			tab_next(self);
		}
		else
		...
		if (global::ptype_edit == null_)
			return IntType(0);
		capwid = text_caption_width(self, { /*"particleeditortypename"*/ STR(216), /*"particleeditortypespawnrate"*/ STR(3461), /*"particleeditortypetemp"*/ STR(1325), /*"particleeditortypespritetex"*/ STR(1328), /*"particleeditortypespriteteximage"*/ STR(3462), /*"particleeditortypespritetemplatepack"*/ STR(1329), /*"particleeditortypespritetemplate"*/ STR(1330), /*"particleeditortypetext"*/ STR(3463) });
		...
		if (!idBool(global::ptype_edit, spd_collapse))
		{
			...
			tab_next(self);
			global::axis_edit = X_;
			tab_template_editor_particles_value(self, { /*"particleeditortypespeed"*/ STR(3495) + ((idVar(global::ptype_edit, spd_extend) > 0) ? /*"x"*/ STR(817) : /*"xyz"*/ STR(3494)), idVar(global::ptype_edit, spd).Value(X_), idVar(global::ptype_edit, spd_israndom).Value(X_), idVar(global::ptype_edit, spd_random_min).Value(X_), idVar(global::ptype_edit, spd_random_max).Value(X_), 1.0 / 4.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(20), IntType(20) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_xspd), idInt(sVar(tab), tbx_type_xspd_random) }), ArrType::From({ ID_action_lib_pc_type_spd, ID_action_lib_pc_type_spd_israndom, ID_action_lib_pc_type_spd_random_min, ID_action_lib_pc_type_spd_random_max }), capwid, true, suffix });
			...
			global::axis_edit = X_;
			tab_template_editor_particles_value(self, { /*"particleeditortypespeed"*/ STR(3495) + ((idVar(global::ptype_edit, spd_extend) > 0) ? /*"x"*/ STR(817) : /*"xyz"*/ STR(3494)) + /*"add"*/ STR(601), idVar(global::ptype_edit, spd_add).Value(X_), idVar(global::ptype_edit, spd_add_israndom).Value(X_), idVar(global::ptype_edit, spd_add_random_min).Value(X_), idVar(global::ptype_edit, spd_add_random_max).Value(X_), 1.0 / 10.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(1), IntType(1) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_xspd_add), idInt(sVar(tab), tbx_type_xspd_add_random) }), ArrType::From({ ID_action_lib_pc_type_spd_add, ID_action_lib_pc_type_spd_add_israndom, ID_action_lib_pc_type_spd_add_random_min, ID_action_lib_pc_type_spd_add_random_max }), capwid, true, suffix });
			if (idVar(global::ptype_edit, spd_extend) > 0)
			{
				global::axis_edit = sn;
			...
			global::axis_edit = X_;
			tab_template_editor_particles_value(self, { /*"particleeditortypespeed"*/ STR(3495) + ((idVar(global::ptype_edit, spd_extend) > 0) ? /*"x"*/ STR(817) : /*"xyz"*/ STR(3494)) + /*"mul"*/ STR(3509), idVar(global::ptype_edit, spd_mul).Value(X_), idVar(global::ptype_edit, spd_mul_israndom).Value(X_), idVar(global::ptype_edit, spd_mul_random_min).Value(X_), idVar(global::ptype_edit, spd_mul_random_max).Value(X_), 1.0 / 200.0, IntType(0), no_limit, ArrType::From({ IntType(1), 0.75, 0.9 }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_xspd_mul), idInt(sVar(tab), tbx_type_xspd_mul_random) }), ArrType::From({ ID_action_lib_pc_type_spd_mul, ID_action_lib_pc_type_spd_mul_israndom, ID_action_lib_pc_type_spd_mul_random_min, ID_action_lib_pc_type_spd_mul_random_max }), capwid, true, suffix });
			if (idVar(global::ptype_edit, spd_extend) > 0)
			{
				global::axis_edit = sn;
		...
		if (idVar(global::ptype_edit, temp) > 0 || (idVar(global::ptype_edit, temp) == particle_sheet || idVar(global::ptype_edit, temp) == particle_template))
		{
			...
			if (idVar(global::ptype_edit, temp) > 0)
			{
				...
				if (!idBool(global::ptype_edit, rot_spd_collapse))
				{
					...
					tab_next(self);
					global::axis_edit = X_;
					tab_template_editor_particles_value(self, { /*"particleeditortyperotationspeed"*/ STR(3517) + ((idVar(global::ptype_edit, rot_spd_extend) > 0) ? /*"x"*/ STR(817) : /*"xyz"*/ STR(3494)), idVar(global::ptype_edit, rot_spd).Value(X_), idVar(global::ptype_edit, rot_spd_israndom).Value(X_), idVar(global::ptype_edit, rot_spd_random_min).Value(X_), idVar(global::ptype_edit, rot_spd_random_max).Value(X_), 1.0 / 2.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(180), IntType(180) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_xrot_spd), idInt(sVar(tab), tbx_type_xrot_spd_random) }), ArrType::From({ ID_action_lib_pc_type_rot_spd, ID_action_lib_pc_type_rot_spd_israndom, ID_action_lib_pc_type_rot_spd_random_min, ID_action_lib_pc_type_rot_spd_random_max }), capwid, true, suffix });
					...
					global::axis_edit = X_;
					tab_template_editor_particles_value(self, { /*"particleeditortyperotationspeed"*/ STR(3517) + ((idVar(global::ptype_edit, rot_spd_extend) > 0) ? /*"x"*/ STR(817) : /*"xyz"*/ STR(3494)) + /*"add"*/ STR(601), idVar(global::ptype_edit, rot_spd_add).Value(X_), idVar(global::ptype_edit, rot_spd_add_israndom).Value(X_), idVar(global::ptype_edit, rot_spd_add_random_min).Value(X_), idVar(global::ptype_edit, rot_spd_add_random_max).Value(X_), 1.0 / 10.0, -no_limit, no_limit, ArrType::From({ IntType(0), -IntType(10), IntType(10) }), IntType(0), ArrType::From({ idInt(sVar(tab), tbx_type_xrot_spd_add), idInt(sVar(tab), tbx_type_xrot_spd_add_random) }), ArrType::From({ ID_action_lib_pc_type_rot_spd_add, ID_action_lib_pc_type_rot_spd_add_israndom, ID_action_lib_pc_type_rot_spd_add_random_min, ID_action_lib_pc_type_rot_spd_add_random_max }), capwid, true, suffix });
					if (idVar(global::ptype_edit, rot_spd_extend) > 0)
					{
						global::axis_edit = sn;
	...
	void tab_template_editor_particles_value(ScopeAny self, VarArgs argument)
	{
		...
		if (israndom > 0)
		{
			...
			textfield_group_add(self, { name + /*"min"*/ STR(1060), randommin, def.Value(IntType(1)), scripts.Value(IntType(2)), global::axis_edit, tbx.Value(IntType(0)), null_, mul, minval, randommax, /*"particleeditormin"*/ STR(3568) });
			textfield_group_add(self, { name + /*"max"*/ STR(1061), randommax, def.Value(IntType(2)), scripts.Value(IntType(3)), global::axis_edit, tbx.Value(IntType(1)), null_, mul, randommin, maxval, /*"particleeditormax"*/ STR(3569) });
	...
	void tab_timeline(ScopeAny self)
	{
		...
		if (sStr(settings_menu_name) == /*"timelineintervalsettings"*/ STR(3594) && sStr(settings_menu_ani_type) != /*"hide"*/ STR(718))
		...
		if (sReal(setting_advanced_mode) > 0)
		{
			...
			if (sStr(settings_menu_name) == /*"timelinefilter"*/ STR(3606) && sStr(settings_menu_ani_type) != /*"hide"*/ STR(718))
				ObjType(value_animation, ObjType(micro_animation, global::current_microani)->active)->value = true;
		}
		VarType searchx;
		RealType searchwid;
		...
		draw_textfield(self, { /*"timelinesearch"*/ STR(3608), searchx, bary + IntType(4), searchwid, IntType(24), idInt(sVar(timeline), tbx_search), ID_action_tl_search, text_get({ /*"listsearch"*/ STR(2888) }), /*"none"*/ STR(874) });
		if (mouseinnames)
		...
		for (RealType t = sReal(timeline_list_first); t < ds_list_size(sInt(tree_visible_list)); t++)
		{
			...
			if (itemhover)
			{
				if (draw_button_icon(self, { /*"timelineselectkeyframes"*/ STR(3604) + string(tl), xx, itemy + buttonpad, buttonsize, buttonsize, false, icons_KEYFRAME_SMALL, null_, false, /*"contextmenutlselectkeyframes"*/ STR(1494) }))
			...
			if (tlhierarchy)
			{
				...
				{
					if (draw_button_icon(self, { /*"timelineexpand"*/ STR(3620) + string(tl), xx, itemy + buttonpad, buttonsize, buttonsize, idVar(tl, tree_extend), null_, null_, false, ((idVar(tl, tree_extend) > 0) ? /*"tooltiptlcollapse"*/ STR(1656) : /*"tooltiptlexpand"*/ STR(1657)), ID_spr_chevron_ani }))
