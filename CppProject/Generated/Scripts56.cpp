...
namespace CppProject
{
	void shader_material_uniforms(Scope<obj_shader> self)
	{
		...
		new_shader_uniform(self, /*"uUseNormalMap"*/ STR(2866));
	}
	...
	void shader_use(ScopeAny self)
	{
		...
		render_set_uniform(/*"uTAAMatrix"*/ STR(1929), global::taa_matrix);
		render_set_uniform(/*"uSampleIndex"*/ STR(1930), global::render_sample_current);
		render_set_uniform_int(/*"uAlphaHash"*/ STR(1931), global::render_alpha_hash);
		render_set_uniform_int(/*"uUseNormalMap"*/ STR(2866), dev_mode_skip_tangents ? IntType(0) : IntType(1));
		if (!is_undefined(DsMap(sInt(uniform_map)).Value(/*"uTime"*/ STR(1915))) && DsMap(sInt(uniform_map)).Value(/*"uTime"*/ STR(1915)) > -IntType(1))
		{
			render_set_uniform(/*"uTime"*/ STR(1915), global::_app->background_time);
			render_set_uniform(/*"uWindEnable"*/ STR(1916), IntType(0));
			render_set_uniform(/*"uWindTerrain"*/ STR(1917), IntType(1));
			render_set_uniform(/*"uWindSpeed"*/ STR(1918), global::_app->background_wind * global::_app->background_wind_speed);
			render_set_uniform(/*"uWindStrength"*/ STR(1919), global::_app->background_wind_strength * (IntType)global::_app->setting_wind_enable);
			render_set_uniform_vec2(/*"uWindDirection"*/ STR(1920), sin(degtorad(global::_app->background_wind_direction)), cos(degtorad(global::_app->background_wind_direction)));
			render_set_uniform(/*"uWindDirectionalSpeed"*/ STR(1921), global::_app->background_wind * global::_app->background_wind_directional_speed * .1 * global::_app->background_time);
			render_set_uniform(/*"uWindDirectionalStrength"*/ STR(1922), global::_app->background_wind * global::_app->background_wind_directional_strength * (IntType)global::_app->setting_wind_enable);
		}
		if (!is_undefined(DsMap(sInt(uniform_map)).Value(/*"uFogShow"*/ STR(1923))) && DsMap(sInt(uniform_map)).Value(/*"uFogShow"*/ STR(1923)) > -IntType(1))
		{
			BoolType fog = (global::_app->background_fog_show > 0 && global::render_mode != e_render_mode_COLOR);
			render_set_uniform_int(/*"uFogShow"*/ STR(1923), bool_to_float(fog));
			render_set_uniform_color(/*"uFogColor"*/ STR(1924), global::_app->background_fog_object_color_final, IntType(1));
			render_set_uniform(/*"uFogDistance"*/ STR(1925), global::_app->background_fog_distance);
			render_set_uniform(/*"uFogSize"*/ STR(1926), global::_app->background_fog_size);
			render_set_uniform(/*"uFogHeight"*/ STR(1927), global::_app->background_fog_height);
		}
		if (!is_undefined(DsMap(sInt(uniform_map)).Value(/*"uCameraPosition"*/ STR(1928))) && DsMap(sInt(uniform_map)).Value(/*"uCameraPosition"*/ STR(1928)) > -IntType(1))
			render_set_uniform_vec3(/*"uCameraPosition"*/ STR(1928), global::cam_from.Real(X_), global::cam_from.Real(Y_), global::cam_from.Real(Z_));
