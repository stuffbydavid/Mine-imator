...
namespace CppProject
{
	...
	void app_startup_keybinds()
	{
		...
		keybind_register(/*"projectnew"*/ STR(238), e_keybind_PROJECT_NEW, keybind_new(/*"N"*/ STR(239), true));
		keybind_register(/*"projectopen"*/ STR(240), e_keybind_PROJECT_OPEN, keybind_new(/*"O"*/ STR(241), true));
		keybind_register(/*"projectsave"*/ STR(242), e_keybind_PROJECT_SAVE, keybind_new(/*"S"*/ STR(243), true));
		keybind_register(/*"projectsaveas"*/ STR(244), e_keybind_PROJECT_SAVE_AS, keybind_new(/*"S"*/ STR(243), true, true));
		keybind_register(/*"importasset"*/ STR(245), e_keybind_IMPORT_ASSET, keybind_new(/*"I"*/ STR(246), true));
		keybind_register(/*"undo"*/ STR(247), e_keybind_UNDO, keybind_new(/*"Z"*/ STR(248), true));
		keybind_register(/*"redo"*/ STR(249), e_keybind_REDO, keybind_new(/*"Y"*/ STR(250), true));
		keybind_register(/*"timelinedelete"*/ STR(251), e_keybind_TIMELINE_DELETE, keybind_new(/*"R"*/ STR(252), true));
		keybind_register(/*"timelineduplicate"*/ STR(253), e_keybind_TIMELINE_DUPLICATE, keybind_new(/*"D"*/ STR(254), true));
		keybind_register(/*"timelineselect"*/ STR(255), e_keybind_TIMELINE_SELECT, keybind_new(/*"A"*/ STR(256), true));
		keybind_register(/*"timelinehide"*/ STR(257), e_keybind_TIMELINE_HIDE, keybind_new(/*"H"*/ STR(258), true));
		keybind_register(/*"timelineshowhidden"*/ STR(259), e_keybind_TIMELINE_SHOW_HIDDEN, keybind_new(/*"H"*/ STR(258), true, false, true));
		keybind_register(/*"createfolder"*/ STR(260), e_keybind_CREATE_FOLDER, keybind_new(/*"F"*/ STR(261), true));
		keybind_register(/*"keyframescreate"*/ STR(262), e_keybind_KEYFRAMES_CREATE, keybind_new(/*"Q"*/ STR(263), true));
		keybind_register(/*"keyframescopy"*/ STR(264), e_keybind_KEYFRAMES_COPY, keybind_new(/*"C"*/ STR(265), true));
		keybind_register(/*"keyframescut"*/ STR(266), e_keybind_KEYFRAMES_CUT, keybind_new(/*"X"*/ STR(267), true));
		keybind_register(/*"keyframespaste"*/ STR(268), e_keybind_KEYFRAMES_PASTE, keybind_new(/*"V"*/ STR(269), true));
		keybind_register(/*"keyframesdelete"*/ STR(270), e_keybind_KEYFRAMES_DELETE, keybind_new(vk_delete));
		keybind_register(/*"play"*/ STR(271), e_keybind_PLAY, keybind_new(vk_space));
		keybind_register(/*"playbeginning"*/ STR(272), e_keybind_PLAY_BEGINNING, keybind_new(vk_enter));
		keybind_register(/*"markerleft"*/ STR(273), e_keybind_MARKER_LEFT, keybind_new(vk_left), true);
		keybind_register(/*"markerright"*/ STR(274), e_keybind_MARKER_RIGHT, keybind_new(vk_right), true);
		keybind_register(/*"rendermode"*/ STR(275), e_keybind_RENDER_MODE, keybind_new(vk_f5));
		keybind_register(/*"particlesspawn"*/ STR(276), e_keybind_PARTICLES_SPAWN, keybind_new(/*"X"*/ STR(267)));
		keybind_register(/*"particlesclear"*/ STR(277), e_keybind_PARTICLES_CLEAR, keybind_new(/*"C"*/ STR(265)));
		keybind_register(/*"secondaryview"*/ STR(278), e_keybind_SECONDARY_VIEW, keybind_new(vk_f6));
		keybind_register(/*"toolselect"*/ STR(279), e_keybind_TOOL_SELECT, keybind_new(/*"W"*/ STR(280)));
		keybind_register(/*"toolmove"*/ STR(281), e_keybind_TOOL_MOVE, keybind_new(/*"G"*/ STR(282)));
		keybind_register(/*"toolrotate"*/ STR(283), e_keybind_TOOL_ROTATE, keybind_new(/*"R"*/ STR(252)));
		keybind_register(/*"toolscale"*/ STR(284), e_keybind_TOOL_SCALE, keybind_new(/*"S"*/ STR(243)));
		keybind_register(/*"toolbend"*/ STR(285), e_keybind_TOOL_BEND, keybind_new(/*"B"*/ STR(286)));
		keybind_register(/*"tooltransform"*/ STR(287), e_keybind_TOOL_TRANSFORM, keybind_new(/*"T"*/ STR(288)));
		keybind_register(/*"snap"*/ STR(289), e_keybind_SNAP, keybind_new(/*"F"*/ STR(261)));
		keybind_register(/*"camforward"*/ STR(290), e_keybind_CAM_FORWARD, keybind_new(/*"W"*/ STR(280)), true);
		keybind_register(/*"camleft"*/ STR(291), e_keybind_CAM_LEFT, keybind_new(/*"A"*/ STR(256)), true);
		keybind_register(/*"camback"*/ STR(292), e_keybind_CAM_BACK, keybind_new(/*"S"*/ STR(243)), true);
		keybind_register(/*"camright"*/ STR(293), e_keybind_CAM_RIGHT, keybind_new(/*"D"*/ STR(254)), true);
		keybind_register(/*"camascend"*/ STR(294), e_keybind_CAM_ASCEND, keybind_new(/*"E"*/ STR(295)), true);
		keybind_register(/*"camdescend"*/ STR(296), e_keybind_CAM_DESCEND, keybind_new(/*"Q"*/ STR(263)), true);
		keybind_register(/*"camrollforward"*/ STR(297), e_keybind_CAM_ROLL_FORWARD, keybind_new(/*"Z"*/ STR(248)), true);
		keybind_register(/*"camrollback"*/ STR(298), e_keybind_CAM_ROLL_BACK, keybind_new(/*"C"*/ STR(265)), true);
		keybind_register(/*"camrollreset"*/ STR(299), e_keybind_CAM_ROLL_RESET, keybind_new(/*"X"*/ STR(267)), true);
		keybind_register(/*"camreset"*/ STR(300), e_keybind_CAM_RESET, keybind_new(/*"R"*/ STR(252)), true);
		keybind_register(/*"camfast"*/ STR(301), e_keybind_CAM_FAST, keybind_new(vk_space), true);
		keybind_register(/*"camslow"*/ STR(302), e_keybind_CAM_SLOW, keybind_new(null_, false, true), true);
		keybind_register(/*"camviewtimeline"*/ STR(303), e_keybind_CAM_VIEW_TIMELINE, keybind_new(/*"V"*/ STR(269)), false);
	...
	void app_startup_lists(ScopeAny self)
	{
		...
		ds_list_add({ global::value_name_list, /*"POS_X"*/ STR(304), /*"POS_Y"*/ STR(305), /*"POS_Z"*/ STR(306), /*"ROT_X"*/ STR(307), /*"ROT_Y"*/ STR(308), /*"ROT_Z"*/ STR(309), /*"SCA_X"*/ STR(310), /*"SCA_Y"*/ STR(311), /*"SCA_Z"*/ STR(312), /*"BEND_ANGLE"*/ STR(313), /*"BEND_ANGLE_X"*/ STR(314), /*"BEND_ANGLE_Y"*/ STR(315), /*"BEND_ANGLE_Z"*/ STR(316), /*"ALPHA"*/ STR(317), /*"RGB_ADD"*/ STR(318), /*"RGB_SUB"*/ STR(319), /*"RGB_MUL"*/ STR(320), /*"HSB_ADD"*/ STR(321), /*"HSB_SUB"*/ STR(322), /*"HSB_MUL"*/ STR(323), /*"MIX_COLOR"*/ STR(324), /*"GLOW_COLOR"*/ STR(325), /*"MIX_PERCENT"*/ STR(326), /*"EMISSIVE"*/ STR(327), /*"METALLIC"*/ STR(328), /*"ROUGHNESS"*/ STR(329), /*"SUBSURFACE"*/ STR(330), /*"SUBSURFACE_RADIUS_RED"*/ STR(331), /*"SUBSURFACE_RADIUS_GREEN"*/ STR(332), /*"SUBSURFACE_RADIUS_BLUE"*/ STR(333), /*"SUBSURFACE_COLOR"*/ STR(334), /*"WIND_INFLUENCE"*/ STR(335), /*"SPAWN"*/ STR(336), /*"FREEZE"*/ STR(337), /*"CLEAR"*/ STR(338), /*"CUSTOM_SEED"*/ STR(339), /*"SEED"*/ STR(340), /*"ATTRACTOR"*/ STR(341), /*"FORCE"*/ STR(342), /*"FORCE_DIRECTIONAL"*/ STR(343), /*"FORCE_VORTEX"*/ STR(344), /*"LIGHT_COLOR"*/ STR(345), /*"LIGHT_STRENGTH"*/ STR(346), /*"LIGHT_SPECULAR_STRENGTH"*/ STR(347), /*"LIGHT_SIZE"*/ STR(348), /*"LIGHT_RANGE"*/ STR(349), /*"LIGHT_FADE_SIZE"*/ STR(350), /*"LIGHT_SPOT_RADIUS"*/ STR(351), /*"LIGHT_SPOT_SHARPNESS"*/ STR(352), /*"CAM_FOV"*/ STR(353), /*"CAM_BLADE_AMOUNT"*/ STR(354), /*"CAM_BLADE_ANGLE"*/ STR(355), /*"CAM_LIGHT_MANAGEMENT"*/ STR(356), /*"CAM_TONEMAPPER"*/ STR(357), /*"CAM_EXPOSURE"*/ STR(358), /*"CAM_GAMMA"*/ STR(359), /*"CAM_ROTATE"*/ STR(360), /*"CAM_ROTATE_DISTANCE"*/ STR(361), /*"CAM_ROTATE_ANGLE_XY"*/ STR(362), /*"CAM_ROTATE_ANGLE_Z"*/ STR(363), /*"CAM_SHAKE"*/ STR(364), /*"CAM_SHAKE_MODE"*/ STR(365), /*"CAM_SHAKE_STRENGTH_X"*/ STR(366), /*"CAM_SHAKE_STRENGTH_Y"*/ STR(367), /*"CAM_SHAKE_STRENGTH_Z"*/ STR(368), /*"CAM_SHAKE_SPEED_X"*/ STR(369), /*"CAM_SHAKE_SPEED_Y"*/ STR(370), /*"CAM_SHAKE_SPEED_Z"*/ STR(371), /*"CAM_DOF"*/ STR(372), /*"CAM_DOF_DEPTH"*/ STR(373), /*"CAM_DOF_RANGE"*/ STR(374), /*"CAM_DOF_FADE_SIZE"*/ STR(375), /*"CAM_DOF_BLUR_SIZE"*/ STR(376), /*"CAM_DOF_BLUR_RATIO"*/ STR(377), /*"CAM_DOF_BIAS"*/ STR(378), /*"CAM_DOF_THRESHOLD"*/ STR(379), /*"CAM_DOF_GAIN"*/ STR(380), /*"CAM_DOF_FRINGE"*/ STR(381), /*"CAM_DOF_FRINGE_ANGLE_RED"*/ STR(382), /*"CAM_DOF_FRINGE_ANGLE_GREEN"*/ STR(383), /*"CAM_DOF_FRINGE_ANGLE_BLUE"*/ STR(384), /*"CAM_DOF_FRINGE_RED"*/ STR(385), /*"CAM_DOF_FRINGE_GREEN"*/ STR(386), /*"CAM_DOF_FRINGE_BLUE"*/ STR(387), /*"CAM_BLOOM"*/ STR(388), /*"CAM_BLOOM_THRESHOLD"*/ STR(389), /*"CAM_BLOOM_INTENSITY"*/ STR(390), /*"CAM_BLOOM_RADIUS"*/ STR(391), /*"CAM_BLOOM_RATIO"*/ STR(392), /*"CAM_BLOOM_BLEND"*/ STR(393), /*"CAM_LENS_DIRT"*/ STR(394), /*"CAM_LENS_DIRT_BLOOM"*/ STR(395), /*"CAM_LENS_DIRT_GLOW"*/ STR(396), /*"CAM_LENS_DIRT_RADIUS"*/ STR(397), /*"CAM_LENS_DIRT_INTENSITY"*/ STR(398), /*"CAM_LENS_DIRT_POWER"*/ STR(399), /*"CAM_COLOR_CORRECTION"*/ STR(400), /*"CAM_CONTRAST"*/ STR(401), /*"CAM_BRIGHTNESS"*/ STR(402), /*"CAM_SATURATION"*/ STR(403), /*"CAM_VIBRANCE"*/ STR(404), /*"CAM_COLOR_BURN"*/ STR(405), /*"CAM_GRAIN"*/ STR(406), /*"CAM_GRAIN_STRENGTH"*/ STR(407), /*"CAM_GRAIN_SATURATION"*/ STR(408), /*"CAM_GRAIN_SIZE"*/ STR(409), /*"CAM_VIGNETTE"*/ STR(410), /*"CAM_VIGNETTE_RADIUS"*/ STR(411), /*"CAM_VIGNETTE_SOFTNESS"*/ STR(412), /*"CAM_VIGNETTE_STRENGTH"*/ STR(413), /*"CAM_VIGNETTE_COLOR"*/ STR(414), /*"CAM_CA"*/ STR(415), /*"CAM_CA_BLUR_AMOUNT"*/ STR(416), /*"CAM_CA_DISTORT_CHANNELS"*/ STR(417), /*"CAM_CA_RED_OFFSET"*/ STR(418), /*"CAM_CA_GREEN_OFFSET"*/ STR(419), /*"CAM_CA_BLUE_OFFSET"*/ STR(420), /*"CAM_DISTORT"*/ STR(421), /*"CAM_DISTORT_REPEAT"*/ STR(422), /*"CAM_DISTORT_ZOOM_AMOUNT"*/ STR(423), /*"CAM_DISTORT_AMOUNT"*/ STR(424), /*"CAM_SIZE_USE_PROJECT"*/ STR(425), /*"CAM_SIZE_KEEP_ASPECT_RATIO"*/ STR(426), /*"CAM_WIDTH"*/ STR(427), /*"CAM_HEIGHT"*/ STR(428), /*"BG_IMAGE_SHOW"*/ STR(429), /*"BG_IMAGE_ROTATION"*/ STR(430), /*"BG_SKY_MOON_PHASE"*/ STR(431), /*"BG_SKY_TIME"*/ STR(432), /*"BG_SKY_ROTATION"*/ STR(433), /*"BG_SUNLIGHT_STRENGTH"*/ STR(434), /*"BG_SUNLIGHT_ANGLE"*/ STR(435), /*"BG_SKY_SUN_ANGLE"*/ STR(436), /*"BG_SKY_SUN_SCALE"*/ STR(437), /*"BG_SKY_MOON_ANGLE"*/ STR(438), /*"BG_SKY_MOON_SCALE"*/ STR(439), /*"BG_TWILIGHT"*/ STR(440), /*"BG_SKY_CLOUDS_SHOW"*/ STR(441), /*"BG_SKY_CLOUDS_SPEED"*/ STR(442), /*"BG_SKY_CLOUDS_HEIGHT"*/ STR(443), /*"BG_SKY_CLOUDS_OFFSET"*/ STR(444), /*"BG_GROUND_SHOW"*/ STR(445), /*"BG_GROUND_SLOT"*/ STR(446), /*"BG_BIOME"*/ STR(447), /*"BG_SKY_COLOR"*/ STR(448), /*"BG_SKY_CLOUDS_COLOR"*/ STR(449), /*"BG_SUNLIGHT_COLOR"*/ STR(450), /*"BG_AMBIENT_COLOR"*/ STR(451), /*"BG_NIGHT_COLOR"*/ STR(452), /*"BG_GRASS_COLOR"*/ STR(453), /*"BG_FOLIAGE_COLOR"*/ STR(454), /*"BG_WATER_COLOR"*/ STR(455), /*"BG_LEAVES_OAK_COLOR"*/ STR(456), /*"BG_LEAVES_SPRUCE_COLOR"*/ STR(457), /*"BG_LEAVES_BIRCH_COLOR"*/ STR(458), /*"BG_LEAVES_JUNGLE_COLOR"*/ STR(459), /*"BG_LEAVES_ACACIA_COLOR"*/ STR(460), /*"BG_LEAVES_DARK_OAK_COLOR"*/ STR(461), /*"BG_LEAVES_MANGROVE_COLOR"*/ STR(462), /*"BG_FOG_SHOW"*/ STR(463), /*"BG_FOG_SKY"*/ STR(464), /*"BG_FOG_CUSTOM_COLOR"*/ STR(465), /*"BG_FOG_COLOR"*/ STR(466), /*"BG_FOG_CUSTOM_OBJECT_COLOR"*/ STR(467), /*"BG_FOG_OBJECT_COLOR"*/ STR(468), /*"BG_FOG_DISTANCE"*/ STR(469), /*"BG_FOG_SIZE"*/ STR(470), /*"BG_FOG_HEIGHT"*/ STR(471), /*"BG_WIND"*/ STR(472), /*"BG_WIND_SPEED"*/ STR(473), /*"BG_WIND_STRENGTH"*/ STR(474), /*"BG_WIND_DIRECTION"*/ STR(475), /*"BG_WIND_DIRECTIONAL_SPEED"*/ STR(476), /*"BG_WIND_DIRECTIONAL_STRENGTH"*/ STR(477), /*"BG_TEXTURE_ANI_SPEED"*/ STR(478), /*"TEXTURE_OBJ"*/ STR(479), /*"TEXTURE_MATERIAL_OBJ"*/ STR(480), /*"TEXTURE_NORMAL_OBJ"*/ STR(481), /*"SOUND_OBJ"*/ STR(482), /*"SOUND_VOLUME"*/ STR(483), /*"SOUND_PITCH"*/ STR(484), /*"SOUND_START"*/ STR(485), /*"SOUND_END"*/ STR(486), /*"TEXT"*/ STR(487), /*"TEXT_FONT"*/ STR(488), /*"TEXT_HALIGN"*/ STR(489), /*"TEXT_VALIGN"*/ STR(490), /*"TEXT_AA"*/ STR(491), /*"TEXT_OUTLINE"*/ STR(492), /*"TEXT_OUTLINE_COLOR"*/ STR(493), /*"CUSTOM_ITEM_SLOT"*/ STR(494), /*"ITEM_SLOT"*/ STR(495), /*"ITEM_NAME"*/ STR(496), /*"PATH_OBJ"*/ STR(497), /*"PATH_OFFSET"*/ STR(498), /*"PATH_POINT_ANGLE"*/ STR(499), /*"PATH_POINT_SCALE"*/ STR(500), /*"IK_TARGET"*/ STR(501), /*"IK_BLEND"*/ STR(502), /*"IK_TARGET_ANGLE"*/ STR(503), /*"IK_ANGLE_OFFSET"*/ STR(504), /*"VISIBLE"*/ STR(505), /*"TRANSITION"*/ STR(506), /*"EASE_IN_X"*/ STR(507), /*"EASE_IN_Y"*/ STR(508), /*"EASE_OUT_X"*/ STR(509), /*"EASE_OUT_Y"*/ STR(510) });
		...
		ds_list_add({ global::temp_type_name_list, /*"char"*/ STR(511), /*"spblock"*/ STR(512), /*"scenery"*/ STR(513), /*"item"*/ STR(514), /*"block"*/ STR(515), /*"bodypart"*/ STR(516), /*"particles"*/ STR(517), /*"text"*/ STR(99), /*"cube"*/ STR(3), /*"cone"*/ STR(518), /*"cylinder"*/ STR(519), /*"sphere"*/ STR(520), /*"surface"*/ STR(521), /*"model"*/ STR(522) });
		global::tl_type_name_list = ds_list_create();
		ds_list_add({ global::tl_type_name_list, /*"char"*/ STR(511), /*"spblock"*/ STR(512), /*"scenery"*/ STR(513), /*"item"*/ STR(514), /*"block"*/ STR(515), /*"bodypart"*/ STR(516), /*"particles"*/ STR(517), /*"text"*/ STR(99), /*"cube"*/ STR(3), /*"cone"*/ STR(518), /*"cylinder"*/ STR(519), /*"sphere"*/ STR(520), /*"surface"*/ STR(521), /*"model"*/ STR(522), /*"camera"*/ STR(120), /*"spotlight"*/ STR(523), /*"pointlight"*/ STR(524), /*"folder"*/ STR(525), /*"background"*/ STR(210), /*"audio"*/ STR(526), /*"path"*/ STR(527), /*"pathpoint"*/ STR(528), /*"shape"*/ STR(529), /*"lightsource"*/ STR(530) });
		global::res_type_name_list = ds_list_create();
		ds_list_add({ global::res_type_name_list, /*"pack"*/ STR(531), /*"packunzipped"*/ STR(532), /*"skin"*/ STR(533), /*"downloadskin"*/ STR(196), /*"itemsheet"*/ STR(534), /*"legacyblocksheet"*/ STR(535), /*"blocksheet"*/ STR(536), /*"scenery"*/ STR(513), /*"fromworld"*/ STR(537), /*"particlesheet"*/ STR(538), /*"texture"*/ STR(539), /*"font"*/ STR(540), /*"sound"*/ STR(541), /*"model"*/ STR(522) });
		global::transition_list = ds_list_create();
		ds_list_add({ global::transition_list, /*"linear"*/ STR(542), /*"instant"*/ STR(543), /*"bezier"*/ STR(544), /*"easeinquad"*/ STR(545), /*"easeoutquad"*/ STR(546), /*"easeinoutquad"*/ STR(547), /*"easeincubic"*/ STR(548), /*"easeoutcubic"*/ STR(549), /*"easeinoutcubic"*/ STR(550), /*"easeinquart"*/ STR(551), /*"easeoutquart"*/ STR(552), /*"easeinoutquart"*/ STR(553), /*"easeinquint"*/ STR(554), /*"easeoutquint"*/ STR(555), /*"easeinoutquint"*/ STR(556), /*"easeinsine"*/ STR(557), /*"easeoutsine"*/ STR(558), /*"easeinoutsine"*/ STR(559), /*"easeinexpo"*/ STR(560), /*"easeoutexpo"*/ STR(561), /*"easeinoutexpo"*/ STR(562), /*"easeincirc"*/ STR(563), /*"easeoutcirc"*/ STR(564), /*"easeinoutcirc"*/ STR(565), /*"easeinelastic"*/ STR(566), /*"easeoutelastic"*/ STR(567), /*"easeinoutelastic"*/ STR(568), /*"easeinback"*/ STR(569), /*"easeoutback"*/ STR(570), /*"easeinoutback"*/ STR(571), /*"easeinbounce"*/ STR(572), /*"easeoutbounce"*/ STR(573), /*"easeinoutbounce"*/ STR(574) });
		log({ /*"Make transitions"*/ STR(575) });
		...
		log({ /*"Transitions OK"*/ STR(576) });
		global::videotemplate_list = ds_list_create();
		ds_list_add({ global::videotemplate_list, new_videotemplate(/*"avatar"*/ STR(577), IntType(512), IntType(512)), new_videotemplate(/*"hd_720p"*/ STR(578), IntType(1280), IntType(720)), new_videotemplate(/*"fhd_1080p"*/ STR(579), IntType(1920), IntType(1080)), new_videotemplate(/*"qhd_1440p"*/ STR(580), IntType(2560), IntType(1440)), new_videotemplate(/*"uhd_4k"*/ STR(581), IntType(3840), IntType(2160)), new_videotemplate(/*"hd_720p_cinematic"*/ STR(582), IntType(1680), IntType(720)), new_videotemplate(/*"fhd_1080p_cinematic"*/ STR(583), IntType(2560), IntType(1080)), new_videotemplate(/*"qhd_1440p_cinematic"*/ STR(584), IntType(3440), IntType(1440)), new_videotemplate(/*"uhd_4k_cinematic"*/ STR(585), IntType(5120), IntType(2160)) });
		global::videoquality_list = ds_list_create();
		ds_list_add({ global::videoquality_list, new_videoquality(/*"best"*/ STR(586), IntType(5000000)), new_videoquality(/*"high"*/ STR(587), IntType(2500000)), new_videoquality(/*"medium"*/ STR(588), IntType(1200000)), new_videoquality(/*"low"*/ STR(589), IntType(700000)), new_videoquality(/*"verylow"*/ STR(590), IntType(350000)) });
		...
		ds_list_add({ global::biome_list, new_biome(/*"custom"*/ STR(591), IntType(0), IntType(0), true, c_plains_biome_grass, c_plains_biome_foliage, c_plains_biome_water, null_) });
		...
		ds_list_add({ global::minecraft_color_name_list, /*"white"*/ STR(592), /*"orange"*/ STR(593), /*"magenta"*/ STR(594), /*"light_blue"*/ STR(595), /*"yellow"*/ STR(596), /*"lime"*/ STR(597), /*"pink"*/ STR(598), /*"gray"*/ STR(599), /*"light_gray"*/ STR(600), /*"cyan"*/ STR(601), /*"purple"*/ STR(602), /*"blue"*/ STR(603), /*"brown"*/ STR(604), /*"green"*/ STR(605), /*"red"*/ STR(606), /*"black"*/ STR(607) });
		...
		ds_list_add({ global::minecraft_glowing_sign_list, ArrType::From({ hex_to_color(/*"FCFCFC"*/ STR(608)), hex_to_color(/*"656565"*/ STR(609)) }), ArrType::From({ hex_to_color(/*"FC671F"*/ STR(610)), hex_to_color(/*"65280C"*/ STR(611)) }), ArrType::From({ hex_to_color(/*"FC00FC"*/ STR(612)), hex_to_color(/*"650065"*/ STR(613)) }), ArrType::From({ hex_to_color(/*"98BECB"*/ STR(614)), hex_to_color(/*"3C4B51"*/ STR(615)) }), ArrType::From({ hex_to_color(/*"FCFC00"*/ STR(616)), hex_to_color(/*"656500"*/ STR(617)) }), ArrType::From({ hex_to_color(/*"8DFC00"*/ STR(618)), hex_to_color(/*"4B6500"*/ STR(619)) }), ArrType::From({ hex_to_color(/*"FC68B2"*/ STR(620)), hex_to_color(/*"652947"*/ STR(621)) }), ArrType::From({ hex_to_color(/*"7E7E7E"*/ STR(622)), hex_to_color(/*"323232"*/ STR(623)) }), ArrType::From({ hex_to_color(/*"D0D0D0"*/ STR(624)), hex_to_color(/*"535353"*/ STR(625)) }), ArrType::From({ hex_to_color(/*"00D6D6"*/ STR(626)), hex_to_color(/*"006565"*/ STR(627)) }), ArrType::From({ hex_to_color(/*"9E20ED"*/ STR(628)), hex_to_color(/*"3F0C5F"*/ STR(629)) }), ArrType::From({ hex_to_color(/*"0000FC"*/ STR(630)), hex_to_color(/*"000065"*/ STR(631)) }), ArrType::From({ hex_to_color(/*"894413"*/ STR(632)), hex_to_color(/*"361B07"*/ STR(633)) }), ArrType::From({ hex_to_color(/*"00FC00"*/ STR(634)), hex_to_color(/*"006500"*/ STR(635)) }), ArrType::From({ hex_to_color(/*"FC0000"*/ STR(636)), hex_to_color(/*"650000"*/ STR(637)) }), ArrType::From({ hex_to_color(/*"000000"*/ STR(638)), hex_to_color(/*"EDE8CA"*/ STR(639)) }) });
		...
		ds_list_add({ global::blend_mode_list, /*"normal"*/ STR(640), /*"add"*/ STR(641), /*"subtract"*/ STR(642), /*"multiply"*/ STR(643), /*"screen"*/ STR(644) });
		global::blend_mode_map = ds_map_create();
		ds_map_add(global::blend_mode_map, /*"normal"*/ STR(640), bm_normal);
		ds_map_add(global::blend_mode_map, /*"add"*/ STR(641), bm_add);
		ds_map_add(global::blend_mode_map, /*"subtract"*/ STR(642), bm_subtract);
		ds_map_add(global::blend_mode_map, /*"multiply"*/ STR(643), ArrType::From({ bm_zero, bm_src_color }));
		ds_map_add(global::blend_mode_map, /*"screen"*/ STR(644), ArrType::From({ bm_one, bm_inv_src_color }));
		...
		ds_list_add({ global::render_pass_list, /*"combined"*/ STR(645), /*"diffuse"*/ STR(646), /*"specular"*/ STR(647), /*"ao"*/ STR(648), /*"shadows"*/ STR(123), /*"indirect"*/ STR(125), /*"indirectshadows"*/ STR(649), /*"reflections"*/ STR(126), /*"depth"*/ STR(650), /*"normal"*/ STR(640), /*"material"*/ STR(651) });
	}
	...
	{
		sStr(recent_display_mode) = /*"grid"*/ STR(652);
	...
	void app_startup_themes(ScopeAny self)
	{
		...
		{
			self->name = /*"light"*/ STR(653);
			self->dark = false;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DB3030"*/ STR(654)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D85B00"*/ STR(655)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D68E02"*/ STR(656)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"34A100"*/ STR(657)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"0D8E41"*/ STR(658)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"048E8E"*/ STR(659)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"2144F1"*/ STR(660)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"982BCB"*/ STR(661)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"E93983"*/ STR(662)));
			self->level_top = hex_to_color(/*"F7FAFC"*/ STR(663));
			self->level_middle = hex_to_color(/*"ECEFF1"*/ STR(664));
			self->level_bottom = hex_to_color(/*"D7DFE2"*/ STR(665));
			self->viewport_top = hex_to_color(/*"F0FFFF"*/ STR(666));
			self->viewport_bottom = hex_to_color(/*"B5E8F2"*/ STR(667));
			self->text_main = hex_to_color(/*"0D1214"*/ STR(668));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"FFFFFF"*/ STR(669));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .15;
			self->red_error = hex_to_color(/*"FF1D0F"*/ STR(670));
			self->yellow_warning = hex_to_color(/*"FFC01E"*/ STR(671));
			self->green_success = hex_to_color(/*"61C159"*/ STR(672));
			self->red = hex_to_color(/*"FF5656"*/ STR(673));
			self->green = hex_to_color(/*"4AB758"*/ STR(674));
			self->blue = hex_to_color(/*"1370FB"*/ STR(675));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(676));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(677));
			self->yellow = hex_to_color(/*"F4CC5D"*/ STR(678));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(679));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"158AF5"*/ STR(680));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64A56B"*/ STR(681));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"D09522"*/ STR(682));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF1D0F"*/ STR(670));
		}
		
		global::theme_dark = (new obj_theme)->id;
		withOne (obj_theme, global::theme_dark, self->id)
		{
			self->name = /*"dark"*/ STR(683);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(684)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFA360"*/ STR(685)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFF065"*/ STR(686)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"8BFF6D"*/ STR(687)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"4EF390"*/ STR(688)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"49EED9"*/ STR(689)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"98BBFF"*/ STR(690)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(691)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(692)));
			self->level_top = hex_to_color(/*"37444A"*/ STR(693));
			self->level_middle = hex_to_color(/*"2B373D"*/ STR(694));
			self->level_bottom = hex_to_color(/*"18242A"*/ STR(695));
			self->viewport_top = hex_to_color(/*"2B373D"*/ STR(694));
			self->viewport_bottom = hex_to_color(/*"839096"*/ STR(696));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(669));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"000000"*/ STR(638));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .25;
			self->red_error = hex_to_color(/*"FF7A72"*/ STR(697));
			self->yellow_warning = hex_to_color(/*"FFEB36"*/ STR(698));
			self->green_success = hex_to_color(/*"64E879"*/ STR(699));
			self->red = hex_to_color(/*"FF5656"*/ STR(673));
			self->green = hex_to_color(/*"23FF88"*/ STR(700));
			self->blue = hex_to_color(/*"1370FB"*/ STR(675));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(676));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(677));
			self->yellow = hex_to_color(/*"FFD969"*/ STR(701));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(679));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"7EC1FF"*/ STR(702));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64E879"*/ STR(699));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"FFEB36"*/ STR(698));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF7A72"*/ STR(697));
		}
		
		global::theme_darker = (new obj_theme)->id;
		withOne (obj_theme, global::theme_darker, self->id)
		{
			self->name = /*"darker"*/ STR(703);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(684)));
			...
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(691)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(692)));
			self->level_top = hex_to_color(/*"1C1C1C"*/ STR(704));
			self->level_middle = hex_to_color(/*"101010"*/ STR(705));
			self->level_bottom = hex_to_color(/*"050505"*/ STR(706));
			self->viewport_top = hex_to_color(/*"484848"*/ STR(707));
			self->viewport_bottom = hex_to_color(/*"2B2B2B"*/ STR(708));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(669));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
	...
	void app_update_animate(ScopeAny self)
	{
		...
		if (bgobject > 0)
		{
			...
			if (sVar(background_biome) == /*"custom"*/ STR(591) || sVar(background_biome_prev) != sVar(background_biome))
			{
		...
		sInt(background_sky_color_final) = merge_color((IntType)(sVar(background_sky_color)), (IntType)(hex_to_color(/*"020204"*/ STR(710))), background_sky_night_alpha());
	...
	void app_update_caption()
	{
		if (global::_app->project_name != /*""*/ STR(0))
			window_set_caption(global::_app->project_name + string_repeat(/*" * "*/ STR(711), global::_app->project_changed) + /*" - Mine-imator"*/ STR(712));
		else
			window_set_caption(/*"Mine-imator"*/ STR(19));
	...
	void app_update_keybinds()
	{
		...
		for (IntType i = IntType(0); i < e_keybind_amount; i++)
		{
			...
			check = keybind_check(obj, /*"keyboard_check"*/ STR(713));
			idBool(obj, released) = false;
			if (idVar(obj, active) > 0)
				idBool(obj, released) = keybind_check(obj, /*"keyboard_check_released"*/ STR(714));
			idBool(obj, pressed) = keybind_check(obj, /*"keyboard_check_pressed"*/ STR(715));
	...
	void app_update_keyboard(ScopeAny self)
	{
		...
		if (sStr(window_state) == /*""*/ STR(0) && (sVar(window_busy) == /*""*/ STR(0) || sStr(settings_menu_name) == /*"colorpicker"*/ STR(716)) && !sBool(textbox_isediting))
		{
