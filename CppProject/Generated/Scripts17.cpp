...
namespace CppProject
{
	...
	void app_startup_keybinds()
	{
		...
		keybind_register(/*"projectnew"*/ STR(239), e_keybind_PROJECT_NEW, keybind_new(/*"N"*/ STR(240), true));
		keybind_register(/*"projectopen"*/ STR(241), e_keybind_PROJECT_OPEN, keybind_new(/*"O"*/ STR(242), true));
		keybind_register(/*"projectsave"*/ STR(243), e_keybind_PROJECT_SAVE, keybind_new(/*"S"*/ STR(244), true));
		keybind_register(/*"projectsaveas"*/ STR(245), e_keybind_PROJECT_SAVE_AS, keybind_new(/*"S"*/ STR(244), true, true));
		keybind_register(/*"importasset"*/ STR(246), e_keybind_IMPORT_ASSET, keybind_new(/*"I"*/ STR(247), true));
		keybind_register(/*"undo"*/ STR(248), e_keybind_UNDO, keybind_new(/*"Z"*/ STR(249), true));
		keybind_register(/*"redo"*/ STR(250), e_keybind_REDO, keybind_new(/*"Y"*/ STR(251), true));
		keybind_register(/*"timelinedelete"*/ STR(252), e_keybind_TIMELINE_DELETE, keybind_new(/*"R"*/ STR(253), true));
		keybind_register(/*"timelineduplicate"*/ STR(254), e_keybind_TIMELINE_DUPLICATE, keybind_new(/*"D"*/ STR(255), true));
		keybind_register(/*"timelineselect"*/ STR(256), e_keybind_TIMELINE_SELECT, keybind_new(/*"A"*/ STR(257), true));
		keybind_register(/*"timelinehide"*/ STR(258), e_keybind_TIMELINE_HIDE, keybind_new(/*"H"*/ STR(259), true));
		keybind_register(/*"timelineshowhidden"*/ STR(260), e_keybind_TIMELINE_SHOW_HIDDEN, keybind_new(/*"H"*/ STR(259), true, false, true));
		keybind_register(/*"createfolder"*/ STR(261), e_keybind_CREATE_FOLDER, keybind_new(/*"F"*/ STR(262), true));
		keybind_register(/*"keyframescreate"*/ STR(263), e_keybind_KEYFRAMES_CREATE, keybind_new(/*"Q"*/ STR(264), true));
		keybind_register(/*"keyframescopy"*/ STR(265), e_keybind_KEYFRAMES_COPY, keybind_new(/*"C"*/ STR(266), true));
		keybind_register(/*"keyframescut"*/ STR(267), e_keybind_KEYFRAMES_CUT, keybind_new(/*"X"*/ STR(268), true));
		keybind_register(/*"keyframespaste"*/ STR(269), e_keybind_KEYFRAMES_PASTE, keybind_new(/*"V"*/ STR(270), true));
		keybind_register(/*"keyframesdelete"*/ STR(271), e_keybind_KEYFRAMES_DELETE, keybind_new(vk_delete));
		keybind_register(/*"play"*/ STR(272), e_keybind_PLAY, keybind_new(vk_space));
		keybind_register(/*"playbeginning"*/ STR(273), e_keybind_PLAY_BEGINNING, keybind_new(vk_enter));
		keybind_register(/*"markerleft"*/ STR(274), e_keybind_MARKER_LEFT, keybind_new(vk_left), true);
		keybind_register(/*"markerright"*/ STR(275), e_keybind_MARKER_RIGHT, keybind_new(vk_right), true);
		keybind_register(/*"rendermode"*/ STR(276), e_keybind_RENDER_MODE, keybind_new(vk_f5));
		keybind_register(/*"particlesspawn"*/ STR(277), e_keybind_PARTICLES_SPAWN, keybind_new(/*"X"*/ STR(268)));
		keybind_register(/*"particlesclear"*/ STR(278), e_keybind_PARTICLES_CLEAR, keybind_new(/*"C"*/ STR(266)));
		keybind_register(/*"secondaryview"*/ STR(279), e_keybind_SECONDARY_VIEW, keybind_new(vk_f6));
		keybind_register(/*"toolselect"*/ STR(280), e_keybind_TOOL_SELECT, keybind_new(/*"W"*/ STR(281)));
		keybind_register(/*"toolmove"*/ STR(282), e_keybind_TOOL_MOVE, keybind_new(/*"G"*/ STR(283)));
		keybind_register(/*"toolrotate"*/ STR(284), e_keybind_TOOL_ROTATE, keybind_new(/*"R"*/ STR(253)));
		keybind_register(/*"toolscale"*/ STR(285), e_keybind_TOOL_SCALE, keybind_new(/*"S"*/ STR(244)));
		keybind_register(/*"toolbend"*/ STR(286), e_keybind_TOOL_BEND, keybind_new(/*"B"*/ STR(287)));
		keybind_register(/*"tooltransform"*/ STR(288), e_keybind_TOOL_TRANSFORM, keybind_new(/*"T"*/ STR(289)));
		keybind_register(/*"snap"*/ STR(290), e_keybind_SNAP, keybind_new(/*"F"*/ STR(262)));
		keybind_register(/*"camforward"*/ STR(291), e_keybind_CAM_FORWARD, keybind_new(/*"W"*/ STR(281)), true);
		keybind_register(/*"camleft"*/ STR(292), e_keybind_CAM_LEFT, keybind_new(/*"A"*/ STR(257)), true);
		keybind_register(/*"camback"*/ STR(293), e_keybind_CAM_BACK, keybind_new(/*"S"*/ STR(244)), true);
		keybind_register(/*"camright"*/ STR(294), e_keybind_CAM_RIGHT, keybind_new(/*"D"*/ STR(255)), true);
		keybind_register(/*"camascend"*/ STR(295), e_keybind_CAM_ASCEND, keybind_new(/*"E"*/ STR(296)), true);
		keybind_register(/*"camdescend"*/ STR(297), e_keybind_CAM_DESCEND, keybind_new(/*"Q"*/ STR(264)), true);
		keybind_register(/*"camrollforward"*/ STR(298), e_keybind_CAM_ROLL_FORWARD, keybind_new(/*"Z"*/ STR(249)), true);
		keybind_register(/*"camrollback"*/ STR(299), e_keybind_CAM_ROLL_BACK, keybind_new(/*"C"*/ STR(266)), true);
		keybind_register(/*"camrollreset"*/ STR(300), e_keybind_CAM_ROLL_RESET, keybind_new(/*"X"*/ STR(268)), true);
		keybind_register(/*"camreset"*/ STR(301), e_keybind_CAM_RESET, keybind_new(/*"R"*/ STR(253)), true);
		keybind_register(/*"camfast"*/ STR(302), e_keybind_CAM_FAST, keybind_new(vk_space), true);
		keybind_register(/*"camslow"*/ STR(303), e_keybind_CAM_SLOW, keybind_new(null_, false, true), true);
		keybind_register(/*"camviewtimeline"*/ STR(304), e_keybind_CAM_VIEW_TIMELINE, keybind_new(/*"V"*/ STR(270)), false);
	...
	void app_startup_lists(ScopeAny self)
	{
		...
		ds_list_add({ global::value_name_list, /*"POS_X"*/ STR(305), /*"POS_Y"*/ STR(306), /*"POS_Z"*/ STR(307), /*"ROT_X"*/ STR(308), /*"ROT_Y"*/ STR(309), /*"ROT_Z"*/ STR(310), /*"SCA_X"*/ STR(311), /*"SCA_Y"*/ STR(312), /*"SCA_Z"*/ STR(313), /*"BEND_ANGLE"*/ STR(314), /*"BEND_ANGLE_X"*/ STR(315), /*"BEND_ANGLE_Y"*/ STR(316), /*"BEND_ANGLE_Z"*/ STR(317), /*"ALPHA"*/ STR(318), /*"RGB_ADD"*/ STR(319), /*"RGB_SUB"*/ STR(320), /*"RGB_MUL"*/ STR(321), /*"HSB_ADD"*/ STR(322), /*"HSB_SUB"*/ STR(323), /*"HSB_MUL"*/ STR(324), /*"MIX_COLOR"*/ STR(325), /*"GLOW_COLOR"*/ STR(326), /*"MIX_PERCENT"*/ STR(327), /*"EMISSIVE"*/ STR(328), /*"METALLIC"*/ STR(329), /*"ROUGHNESS"*/ STR(330), /*"SUBSURFACE"*/ STR(331), /*"SUBSURFACE_RADIUS_RED"*/ STR(332), /*"SUBSURFACE_RADIUS_GREEN"*/ STR(333), /*"SUBSURFACE_RADIUS_BLUE"*/ STR(334), /*"SUBSURFACE_COLOR"*/ STR(335), /*"WIND_INFLUENCE"*/ STR(336), /*"SPAWN"*/ STR(337), /*"FREEZE"*/ STR(338), /*"CLEAR"*/ STR(339), /*"CUSTOM_SEED"*/ STR(340), /*"SEED"*/ STR(341), /*"ATTRACTOR"*/ STR(342), /*"FORCE"*/ STR(343), /*"FORCE_DIRECTIONAL"*/ STR(344), /*"FORCE_VORTEX"*/ STR(345), /*"LIGHT_COLOR"*/ STR(346), /*"LIGHT_STRENGTH"*/ STR(347), /*"LIGHT_SPECULAR_STRENGTH"*/ STR(348), /*"LIGHT_SIZE"*/ STR(349), /*"LIGHT_RANGE"*/ STR(350), /*"LIGHT_FADE_SIZE"*/ STR(351), /*"LIGHT_SPOT_RADIUS"*/ STR(352), /*"LIGHT_SPOT_SHARPNESS"*/ STR(353), /*"CAM_FOV"*/ STR(354), /*"CAM_BLADE_AMOUNT"*/ STR(355), /*"CAM_BLADE_ANGLE"*/ STR(356), /*"CAM_LIGHT_MANAGEMENT"*/ STR(357), /*"CAM_TONEMAPPER"*/ STR(358), /*"CAM_EXPOSURE"*/ STR(359), /*"CAM_GAMMA"*/ STR(360), /*"CAM_ROTATE"*/ STR(361), /*"CAM_ROTATE_DISTANCE"*/ STR(362), /*"CAM_ROTATE_ANGLE_XY"*/ STR(363), /*"CAM_ROTATE_ANGLE_Z"*/ STR(364), /*"CAM_SHAKE"*/ STR(365), /*"CAM_SHAKE_MODE"*/ STR(366), /*"CAM_SHAKE_STRENGTH_X"*/ STR(367), /*"CAM_SHAKE_STRENGTH_Y"*/ STR(368), /*"CAM_SHAKE_STRENGTH_Z"*/ STR(369), /*"CAM_SHAKE_SPEED_X"*/ STR(370), /*"CAM_SHAKE_SPEED_Y"*/ STR(371), /*"CAM_SHAKE_SPEED_Z"*/ STR(372), /*"CAM_DOF"*/ STR(373), /*"CAM_DOF_DEPTH"*/ STR(374), /*"CAM_DOF_RANGE"*/ STR(375), /*"CAM_DOF_FADE_SIZE"*/ STR(376), /*"CAM_DOF_BLUR_SIZE"*/ STR(377), /*"CAM_DOF_BLUR_RATIO"*/ STR(378), /*"CAM_DOF_BIAS"*/ STR(379), /*"CAM_DOF_THRESHOLD"*/ STR(380), /*"CAM_DOF_GAIN"*/ STR(381), /*"CAM_DOF_FRINGE"*/ STR(382), /*"CAM_DOF_FRINGE_ANGLE_RED"*/ STR(383), /*"CAM_DOF_FRINGE_ANGLE_GREEN"*/ STR(384), /*"CAM_DOF_FRINGE_ANGLE_BLUE"*/ STR(385), /*"CAM_DOF_FRINGE_RED"*/ STR(386), /*"CAM_DOF_FRINGE_GREEN"*/ STR(387), /*"CAM_DOF_FRINGE_BLUE"*/ STR(388), /*"CAM_BLOOM"*/ STR(389), /*"CAM_BLOOM_THRESHOLD"*/ STR(390), /*"CAM_BLOOM_INTENSITY"*/ STR(391), /*"CAM_BLOOM_RADIUS"*/ STR(392), /*"CAM_BLOOM_RATIO"*/ STR(393), /*"CAM_BLOOM_BLEND"*/ STR(394), /*"CAM_LENS_DIRT"*/ STR(395), /*"CAM_LENS_DIRT_BLOOM"*/ STR(396), /*"CAM_LENS_DIRT_GLOW"*/ STR(397), /*"CAM_LENS_DIRT_RADIUS"*/ STR(398), /*"CAM_LENS_DIRT_INTENSITY"*/ STR(399), /*"CAM_LENS_DIRT_POWER"*/ STR(400), /*"CAM_COLOR_CORRECTION"*/ STR(401), /*"CAM_CONTRAST"*/ STR(402), /*"CAM_BRIGHTNESS"*/ STR(403), /*"CAM_SATURATION"*/ STR(404), /*"CAM_VIBRANCE"*/ STR(405), /*"CAM_COLOR_BURN"*/ STR(406), /*"CAM_GRAIN"*/ STR(407), /*"CAM_GRAIN_STRENGTH"*/ STR(408), /*"CAM_GRAIN_SATURATION"*/ STR(409), /*"CAM_GRAIN_SIZE"*/ STR(410), /*"CAM_VIGNETTE"*/ STR(411), /*"CAM_VIGNETTE_RADIUS"*/ STR(412), /*"CAM_VIGNETTE_SOFTNESS"*/ STR(413), /*"CAM_VIGNETTE_STRENGTH"*/ STR(414), /*"CAM_VIGNETTE_COLOR"*/ STR(415), /*"CAM_CA"*/ STR(416), /*"CAM_CA_BLUR_AMOUNT"*/ STR(417), /*"CAM_CA_DISTORT_CHANNELS"*/ STR(418), /*"CAM_CA_RED_OFFSET"*/ STR(419), /*"CAM_CA_GREEN_OFFSET"*/ STR(420), /*"CAM_CA_BLUE_OFFSET"*/ STR(421), /*"CAM_DISTORT"*/ STR(422), /*"CAM_DISTORT_REPEAT"*/ STR(423), /*"CAM_DISTORT_ZOOM_AMOUNT"*/ STR(424), /*"CAM_DISTORT_AMOUNT"*/ STR(425), /*"CAM_SIZE_USE_PROJECT"*/ STR(426), /*"CAM_SIZE_KEEP_ASPECT_RATIO"*/ STR(427), /*"CAM_WIDTH"*/ STR(428), /*"CAM_HEIGHT"*/ STR(429), /*"BG_IMAGE_SHOW"*/ STR(430), /*"BG_IMAGE_ROTATION"*/ STR(431), /*"BG_SKY_MOON_PHASE"*/ STR(432), /*"BG_SKY_TIME"*/ STR(433), /*"BG_SKY_ROTATION"*/ STR(434), /*"BG_SUNLIGHT_STRENGTH"*/ STR(435), /*"BG_SUNLIGHT_ANGLE"*/ STR(436), /*"BG_SKY_SUN_ANGLE"*/ STR(437), /*"BG_SKY_SUN_SCALE"*/ STR(438), /*"BG_SKY_MOON_ANGLE"*/ STR(439), /*"BG_SKY_MOON_SCALE"*/ STR(440), /*"BG_TWILIGHT"*/ STR(441), /*"BG_SKY_CLOUDS_SHOW"*/ STR(442), /*"BG_SKY_CLOUDS_SPEED"*/ STR(443), /*"BG_SKY_CLOUDS_HEIGHT"*/ STR(444), /*"BG_SKY_CLOUDS_OFFSET"*/ STR(445), /*"BG_GROUND_SHOW"*/ STR(446), /*"BG_GROUND_SLOT"*/ STR(447), /*"BG_BIOME"*/ STR(448), /*"BG_SKY_COLOR"*/ STR(449), /*"BG_SKY_CLOUDS_COLOR"*/ STR(450), /*"BG_SUNLIGHT_COLOR"*/ STR(451), /*"BG_AMBIENT_COLOR"*/ STR(452), /*"BG_NIGHT_COLOR"*/ STR(453), /*"BG_GRASS_COLOR"*/ STR(454), /*"BG_FOLIAGE_COLOR"*/ STR(455), /*"BG_WATER_COLOR"*/ STR(456), /*"BG_LEAVES_OAK_COLOR"*/ STR(457), /*"BG_LEAVES_SPRUCE_COLOR"*/ STR(458), /*"BG_LEAVES_BIRCH_COLOR"*/ STR(459), /*"BG_LEAVES_JUNGLE_COLOR"*/ STR(460), /*"BG_LEAVES_ACACIA_COLOR"*/ STR(461), /*"BG_LEAVES_DARK_OAK_COLOR"*/ STR(462), /*"BG_LEAVES_MANGROVE_COLOR"*/ STR(463), /*"BG_FOG_SHOW"*/ STR(464), /*"BG_FOG_SKY"*/ STR(465), /*"BG_FOG_CUSTOM_COLOR"*/ STR(466), /*"BG_FOG_COLOR"*/ STR(467), /*"BG_FOG_CUSTOM_OBJECT_COLOR"*/ STR(468), /*"BG_FOG_OBJECT_COLOR"*/ STR(469), /*"BG_FOG_DISTANCE"*/ STR(470), /*"BG_FOG_SIZE"*/ STR(471), /*"BG_FOG_HEIGHT"*/ STR(472), /*"BG_WIND"*/ STR(473), /*"BG_WIND_SPEED"*/ STR(474), /*"BG_WIND_STRENGTH"*/ STR(475), /*"BG_WIND_DIRECTION"*/ STR(476), /*"BG_WIND_DIRECTIONAL_SPEED"*/ STR(477), /*"BG_WIND_DIRECTIONAL_STRENGTH"*/ STR(478), /*"BG_TEXTURE_ANI_SPEED"*/ STR(479), /*"TEXTURE_OBJ"*/ STR(480), /*"TEXTURE_MATERIAL_OBJ"*/ STR(481), /*"TEXTURE_NORMAL_OBJ"*/ STR(482), /*"SOUND_OBJ"*/ STR(483), /*"SOUND_VOLUME"*/ STR(484), /*"SOUND_PITCH"*/ STR(485), /*"SOUND_START"*/ STR(486), /*"SOUND_END"*/ STR(487), /*"TEXT"*/ STR(488), /*"TEXT_FONT"*/ STR(489), /*"TEXT_HALIGN"*/ STR(490), /*"TEXT_VALIGN"*/ STR(491), /*"TEXT_AA"*/ STR(492), /*"TEXT_OUTLINE"*/ STR(493), /*"TEXT_OUTLINE_COLOR"*/ STR(494), /*"CUSTOM_ITEM_SLOT"*/ STR(495), /*"ITEM_SLOT"*/ STR(496), /*"ITEM_NAME"*/ STR(497), /*"PATH_OBJ"*/ STR(498), /*"PATH_OFFSET"*/ STR(499), /*"PATH_POINT_ANGLE"*/ STR(500), /*"PATH_POINT_SCALE"*/ STR(501), /*"IK_TARGET"*/ STR(502), /*"IK_BLEND"*/ STR(503), /*"IK_TARGET_ANGLE"*/ STR(504), /*"IK_ANGLE_OFFSET"*/ STR(505), /*"VISIBLE"*/ STR(506), /*"TRANSITION"*/ STR(507), /*"EASE_IN_X"*/ STR(508), /*"EASE_IN_Y"*/ STR(509), /*"EASE_OUT_X"*/ STR(510), /*"EASE_OUT_Y"*/ STR(511) });
		...
		ds_list_add({ global::temp_type_name_list, /*"char"*/ STR(512), /*"spblock"*/ STR(513), /*"scenery"*/ STR(514), /*"item"*/ STR(515), /*"block"*/ STR(516), /*"bodypart"*/ STR(517), /*"particles"*/ STR(518), /*"text"*/ STR(99), /*"cube"*/ STR(3), /*"cone"*/ STR(519), /*"cylinder"*/ STR(520), /*"sphere"*/ STR(521), /*"surface"*/ STR(522), /*"model"*/ STR(523) });
		global::tl_type_name_list = ds_list_create();
		ds_list_add({ global::tl_type_name_list, /*"char"*/ STR(512), /*"spblock"*/ STR(513), /*"scenery"*/ STR(514), /*"item"*/ STR(515), /*"block"*/ STR(516), /*"bodypart"*/ STR(517), /*"particles"*/ STR(518), /*"text"*/ STR(99), /*"cube"*/ STR(3), /*"cone"*/ STR(519), /*"cylinder"*/ STR(520), /*"sphere"*/ STR(521), /*"surface"*/ STR(522), /*"model"*/ STR(523), /*"camera"*/ STR(120), /*"spotlight"*/ STR(524), /*"pointlight"*/ STR(525), /*"folder"*/ STR(526), /*"background"*/ STR(211), /*"audio"*/ STR(527), /*"path"*/ STR(528), /*"pathpoint"*/ STR(529), /*"shape"*/ STR(530), /*"lightsource"*/ STR(531) });
		global::res_type_name_list = ds_list_create();
		ds_list_add({ global::res_type_name_list, /*"pack"*/ STR(532), /*"packunzipped"*/ STR(533), /*"skin"*/ STR(534), /*"downloadskin"*/ STR(196), /*"itemsheet"*/ STR(535), /*"legacyblocksheet"*/ STR(536), /*"blocksheet"*/ STR(537), /*"scenery"*/ STR(514), /*"fromworld"*/ STR(538), /*"particlesheet"*/ STR(539), /*"texture"*/ STR(540), /*"font"*/ STR(541), /*"sound"*/ STR(542), /*"model"*/ STR(523) });
		global::transition_list = ds_list_create();
		ds_list_add({ global::transition_list, /*"linear"*/ STR(543), /*"instant"*/ STR(544), /*"bezier"*/ STR(545), /*"easeinquad"*/ STR(546), /*"easeoutquad"*/ STR(547), /*"easeinoutquad"*/ STR(548), /*"easeincubic"*/ STR(549), /*"easeoutcubic"*/ STR(550), /*"easeinoutcubic"*/ STR(551), /*"easeinquart"*/ STR(552), /*"easeoutquart"*/ STR(553), /*"easeinoutquart"*/ STR(554), /*"easeinquint"*/ STR(555), /*"easeoutquint"*/ STR(556), /*"easeinoutquint"*/ STR(557), /*"easeinsine"*/ STR(558), /*"easeoutsine"*/ STR(559), /*"easeinoutsine"*/ STR(560), /*"easeinexpo"*/ STR(561), /*"easeoutexpo"*/ STR(562), /*"easeinoutexpo"*/ STR(563), /*"easeincirc"*/ STR(564), /*"easeoutcirc"*/ STR(565), /*"easeinoutcirc"*/ STR(566), /*"easeinelastic"*/ STR(567), /*"easeoutelastic"*/ STR(568), /*"easeinoutelastic"*/ STR(569), /*"easeinback"*/ STR(570), /*"easeoutback"*/ STR(571), /*"easeinoutback"*/ STR(572), /*"easeinbounce"*/ STR(573), /*"easeoutbounce"*/ STR(574), /*"easeinoutbounce"*/ STR(575) });
		log({ /*"Make transitions"*/ STR(576) });
		...
		log({ /*"Transitions OK"*/ STR(577) });
		global::videotemplate_list = ds_list_create();
		ds_list_add({ global::videotemplate_list, new_videotemplate(/*"avatar"*/ STR(578), IntType(512), IntType(512)), new_videotemplate(/*"hd_720p"*/ STR(579), IntType(1280), IntType(720)), new_videotemplate(/*"fhd_1080p"*/ STR(580), IntType(1920), IntType(1080)), new_videotemplate(/*"qhd_1440p"*/ STR(581), IntType(2560), IntType(1440)), new_videotemplate(/*"uhd_4k"*/ STR(582), IntType(3840), IntType(2160)), new_videotemplate(/*"hd_720p_cinematic"*/ STR(583), IntType(1680), IntType(720)), new_videotemplate(/*"fhd_1080p_cinematic"*/ STR(584), IntType(2560), IntType(1080)), new_videotemplate(/*"qhd_1440p_cinematic"*/ STR(585), IntType(3440), IntType(1440)), new_videotemplate(/*"uhd_4k_cinematic"*/ STR(586), IntType(5120), IntType(2160)) });
		global::videoquality_list = ds_list_create();
		ds_list_add({ global::videoquality_list, new_videoquality(/*"best"*/ STR(587), IntType(5000000)), new_videoquality(/*"high"*/ STR(588), IntType(2500000)), new_videoquality(/*"medium"*/ STR(589), IntType(1200000)), new_videoquality(/*"low"*/ STR(590), IntType(700000)), new_videoquality(/*"verylow"*/ STR(591), IntType(350000)) });
		...
		ds_list_add({ global::biome_list, new_biome(/*"custom"*/ STR(592), IntType(0), IntType(0), true, c_plains_biome_grass, c_plains_biome_foliage, c_plains_biome_water, null_) });
		...
		ds_list_add({ global::minecraft_color_name_list, /*"white"*/ STR(593), /*"orange"*/ STR(594), /*"magenta"*/ STR(595), /*"light_blue"*/ STR(596), /*"yellow"*/ STR(597), /*"lime"*/ STR(598), /*"pink"*/ STR(599), /*"gray"*/ STR(600), /*"light_gray"*/ STR(601), /*"cyan"*/ STR(602), /*"purple"*/ STR(603), /*"blue"*/ STR(604), /*"brown"*/ STR(605), /*"green"*/ STR(606), /*"red"*/ STR(607), /*"black"*/ STR(608) });
		...
		ds_list_add({ global::minecraft_glowing_sign_list, ArrType::From({ hex_to_color(/*"FCFCFC"*/ STR(609)), hex_to_color(/*"656565"*/ STR(610)) }), ArrType::From({ hex_to_color(/*"FC671F"*/ STR(611)), hex_to_color(/*"65280C"*/ STR(612)) }), ArrType::From({ hex_to_color(/*"FC00FC"*/ STR(613)), hex_to_color(/*"650065"*/ STR(614)) }), ArrType::From({ hex_to_color(/*"98BECB"*/ STR(615)), hex_to_color(/*"3C4B51"*/ STR(616)) }), ArrType::From({ hex_to_color(/*"FCFC00"*/ STR(617)), hex_to_color(/*"656500"*/ STR(618)) }), ArrType::From({ hex_to_color(/*"8DFC00"*/ STR(619)), hex_to_color(/*"4B6500"*/ STR(620)) }), ArrType::From({ hex_to_color(/*"FC68B2"*/ STR(621)), hex_to_color(/*"652947"*/ STR(622)) }), ArrType::From({ hex_to_color(/*"7E7E7E"*/ STR(623)), hex_to_color(/*"323232"*/ STR(624)) }), ArrType::From({ hex_to_color(/*"D0D0D0"*/ STR(625)), hex_to_color(/*"535353"*/ STR(626)) }), ArrType::From({ hex_to_color(/*"00D6D6"*/ STR(627)), hex_to_color(/*"006565"*/ STR(628)) }), ArrType::From({ hex_to_color(/*"9E20ED"*/ STR(629)), hex_to_color(/*"3F0C5F"*/ STR(630)) }), ArrType::From({ hex_to_color(/*"0000FC"*/ STR(631)), hex_to_color(/*"000065"*/ STR(632)) }), ArrType::From({ hex_to_color(/*"894413"*/ STR(633)), hex_to_color(/*"361B07"*/ STR(634)) }), ArrType::From({ hex_to_color(/*"00FC00"*/ STR(635)), hex_to_color(/*"006500"*/ STR(636)) }), ArrType::From({ hex_to_color(/*"FC0000"*/ STR(637)), hex_to_color(/*"650000"*/ STR(638)) }), ArrType::From({ hex_to_color(/*"000000"*/ STR(639)), hex_to_color(/*"EDE8CA"*/ STR(640)) }) });
		...
		ds_list_add({ global::blend_mode_list, /*"normal"*/ STR(641), /*"add"*/ STR(642), /*"subtract"*/ STR(643), /*"multiply"*/ STR(644), /*"screen"*/ STR(645) });
		global::blend_mode_map = ds_map_create();
		ds_map_add(global::blend_mode_map, /*"normal"*/ STR(641), bm_normal);
		ds_map_add(global::blend_mode_map, /*"add"*/ STR(642), bm_add);
		ds_map_add(global::blend_mode_map, /*"subtract"*/ STR(643), bm_subtract);
		ds_map_add(global::blend_mode_map, /*"multiply"*/ STR(644), ArrType::From({ bm_zero, bm_src_color }));
		ds_map_add(global::blend_mode_map, /*"screen"*/ STR(645), ArrType::From({ bm_one, bm_inv_src_color }));
		...
		ds_list_add({ global::render_pass_list, /*"combined"*/ STR(646), /*"diffuse"*/ STR(647), /*"specular"*/ STR(648), /*"ao"*/ STR(649), /*"shadows"*/ STR(123), /*"indirect"*/ STR(125), /*"indirectshadows"*/ STR(650), /*"reflections"*/ STR(126), /*"depth"*/ STR(651), /*"normal"*/ STR(641), /*"material"*/ STR(652) });
	}
	...
	{
		sStr(recent_display_mode) = /*"grid"*/ STR(653);
	...
	void app_startup_themes(ScopeAny self)
	{
		...
		{
			self->name = /*"light"*/ STR(654);
			self->dark = false;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DB3030"*/ STR(655)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D85B00"*/ STR(656)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D68E02"*/ STR(657)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"34A100"*/ STR(658)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"0D8E41"*/ STR(659)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"048E8E"*/ STR(660)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"2144F1"*/ STR(661)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"982BCB"*/ STR(662)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"E93983"*/ STR(663)));
			self->level_top = hex_to_color(/*"F7FAFC"*/ STR(664));
			self->level_middle = hex_to_color(/*"ECEFF1"*/ STR(665));
			self->level_bottom = hex_to_color(/*"D7DFE2"*/ STR(666));
			self->viewport_top = hex_to_color(/*"F0FFFF"*/ STR(667));
			self->viewport_bottom = hex_to_color(/*"B5E8F2"*/ STR(668));
			self->text_main = hex_to_color(/*"0D1214"*/ STR(669));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"FFFFFF"*/ STR(670));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .15;
			self->red_error = hex_to_color(/*"FF1D0F"*/ STR(671));
			self->yellow_warning = hex_to_color(/*"FFC01E"*/ STR(672));
			self->green_success = hex_to_color(/*"61C159"*/ STR(673));
			self->red = hex_to_color(/*"FF5656"*/ STR(674));
			self->green = hex_to_color(/*"4AB758"*/ STR(675));
			self->blue = hex_to_color(/*"1370FB"*/ STR(676));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(677));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(678));
			self->yellow = hex_to_color(/*"F4CC5D"*/ STR(679));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(680));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"158AF5"*/ STR(681));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64A56B"*/ STR(682));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"D09522"*/ STR(683));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF1D0F"*/ STR(671));
		}
		
		global::theme_dark = (new obj_theme)->id;
		withOne (obj_theme, global::theme_dark, self->id)
		{
			self->name = /*"dark"*/ STR(684);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(685)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFA360"*/ STR(686)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFF065"*/ STR(687)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"8BFF6D"*/ STR(688)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"4EF390"*/ STR(689)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"49EED9"*/ STR(690)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"98BBFF"*/ STR(691)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(692)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(693)));
			self->level_top = hex_to_color(/*"37444A"*/ STR(694));
			self->level_middle = hex_to_color(/*"2B373D"*/ STR(695));
			self->level_bottom = hex_to_color(/*"18242A"*/ STR(696));
			self->viewport_top = hex_to_color(/*"2B373D"*/ STR(695));
			self->viewport_bottom = hex_to_color(/*"839096"*/ STR(697));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(670));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"000000"*/ STR(639));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .25;
			self->red_error = hex_to_color(/*"FF7A72"*/ STR(698));
			self->yellow_warning = hex_to_color(/*"FFEB36"*/ STR(699));
			self->green_success = hex_to_color(/*"64E879"*/ STR(700));
			self->red = hex_to_color(/*"FF5656"*/ STR(674));
			self->green = hex_to_color(/*"23FF88"*/ STR(701));
			self->blue = hex_to_color(/*"1370FB"*/ STR(676));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(677));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(678));
			self->yellow = hex_to_color(/*"FFD969"*/ STR(702));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(680));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"7EC1FF"*/ STR(703));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64E879"*/ STR(700));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"FFEB36"*/ STR(699));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF7A72"*/ STR(698));
		}
		
		global::theme_darker = (new obj_theme)->id;
		withOne (obj_theme, global::theme_darker, self->id)
		{
			self->name = /*"darker"*/ STR(704);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(685)));
			...
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(692)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(693)));
			self->level_top = hex_to_color(/*"1C1C1C"*/ STR(705));
			self->level_middle = hex_to_color(/*"101010"*/ STR(706));
			self->level_bottom = hex_to_color(/*"050505"*/ STR(707));
			self->viewport_top = hex_to_color(/*"484848"*/ STR(708));
			self->viewport_bottom = hex_to_color(/*"2B2B2B"*/ STR(709));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(670));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
	...
	void app_startup_window(ScopeAny self)
	{
		...
		sStr(popup_block_ani_ease) = /*"easeoutcirc"*/ STR(565);
	...
	void app_update_animate(ScopeAny self)
	{
		...
		if (bgobject > 0)
		{
			...
			if (sVar(background_biome) == /*"custom"*/ STR(592) || sVar(background_biome_prev) != sVar(background_biome))
			{
		...
		sInt(background_sky_color_final) = merge_color((IntType)(sVar(background_sky_color)), (IntType)(hex_to_color(/*"020204"*/ STR(711))), background_sky_night_alpha());
	...
	void app_update_caption()
	{
		if (global::_app->project_name != /*""*/ STR(0))
			window_set_caption(global::_app->project_name + string_repeat(/*" * "*/ STR(712), global::_app->project_changed) + /*" - Mine-imator"*/ STR(713));
		else
			window_set_caption(/*"Mine-imator"*/ STR(19));
	...
	void app_update_keybinds()
	{
		...
		for (IntType i = IntType(0); i < e_keybind_amount; i++)
		{
			...
			check = keybind_check(obj, /*"keyboard_check"*/ STR(714));
			idBool(obj, released) = false;
			if (idVar(obj, active) > 0)
				idBool(obj, released) = keybind_check(obj, /*"keyboard_check_released"*/ STR(715));
			idBool(obj, pressed) = keybind_check(obj, /*"keyboard_check_pressed"*/ STR(716));
	...
	void app_update_keyboard(ScopeAny self)
	{
		...
		if (sStr(window_state) == /*""*/ STR(0) && (sVar(window_busy) == /*""*/ STR(0) || sStr(settings_menu_name) == /*"colorpicker"*/ STR(717)) && !sBool(textbox_isediting))
		{
