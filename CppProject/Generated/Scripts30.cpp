...
namespace CppProject
{
	...
	{
		return file_dialog_save(/*" * "*/ STR(712) + exts + /*"|*"*/ STR(1216) + exts, filename_get_valid(fn), /*""*/ STR(0), text_get({ /*"filedialogsaveresourcecaption"*/ STR(1217) }));
	}
	...
	ArrType file_find(StringType dir, StringType exts)
	{
		...
		StringType f;
		ret = ArrType();
		f = file_find_first(dir + /*"*"*/ STR(1128), IntType(0));
		while (f != /*""*/ STR(0))
		{
	...
	{
		StringType str, hex;
		str = string_replace(oldstr, /*"#"*/ STR(868), /*""*/ STR(0));
		str = string_upper(str + string_repeat(/*"0"*/ STR(1083), (IntType)(IntType(6) - string_length(oldstr))));
