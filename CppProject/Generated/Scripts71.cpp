...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3874) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3875) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3876))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3877) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3876))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3876))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3878))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3879))
		{
			sInt(mouse_cursor) = cr_size_ns;
