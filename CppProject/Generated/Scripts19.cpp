...
namespace CppProject
{
	...
	BoolType asset_load(ScopeAny self, VarArgs argument)
	{
		...
		{
			log({ /*"Opening legacy asset"*/ STR(713), fn });
		...
		switch (StringType(ext).id)
		{
			...
			case 685: // .miparticles
			{
				...
				withOne (obj_template, temp, self->id)
				{
					...
					project_load_particles(ScopeAny(self), DsMap(rootmap).Value(/*"particles"*/ STR(523)));
	...
	void background_ground_startup()
	{
		...
		log({ /*"Ground vbuffer init"*/ STR(717) });
