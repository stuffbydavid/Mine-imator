...
namespace CppProject
{
	...
	void popup_about_draw(ScopeAny self)
	{
		...
		ArrType list = ArrType::From({ /*"9redwoods"*/ STR(1976), /*"Alpha Toostrr"*/ STR(1977), /*"AnxiousCynic"*/ STR(1978), /*"Cade [CaZaKoJa]"*/ STR(1979), /*"Hozq"*/ STR(1980), /*"Jnick"*/ STR(1981), /*"Jossamations"*/ STR(1982), /*"KeepOnChucking"*/ STR(1983), /*"Rollo"*/ STR(1984), /*"SKIBBZ"*/ STR(1985), /*"SoundsDotZip"*/ STR(1986), /*"UpgradedMoon"*/ STR(1987), /*"Vash"*/ STR(1988), /*"__Mine__"*/ STR(1989) });
		sVar(dy) += IntType(12);
