...
namespace CppProject
{
	...
	void popup_about_draw(ScopeAny self)
	{
		...
		ArrType list = ArrType::From({ /*"9redwoods"*/ STR(1975), /*"Alpha Toostrr"*/ STR(1976), /*"AnxiousCynic"*/ STR(1977), /*"Cade [CaZaKoJa]"*/ STR(1978), /*"Hozq"*/ STR(1979), /*"Jnick"*/ STR(1980), /*"Jossamations"*/ STR(1981), /*"KeepOnChucking"*/ STR(1982), /*"Rollo"*/ STR(1983), /*"SKIBBZ"*/ STR(1984), /*"SoundsDotZip"*/ STR(1985), /*"UpgradedMoon"*/ STR(1986), /*"Vash"*/ STR(1987), /*"__Mine__"*/ STR(1988) });
		sVar(dy) += IntType(12);
