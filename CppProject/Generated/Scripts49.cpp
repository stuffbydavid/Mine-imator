...
namespace CppProject
{
	...
	void render_startup(ScopeAny self)
	{
		...
		if (!file_exists_lib(render_default_file))
		{
			...
			project_save_done();
			log({ /*"Saved default render settings"*/ STR(2458), render_default_file });
		}
	}
	...
	RealType render_world_block(VarType vbuffer, VarType res, BoolType rotate, VarType size, VarType temp)
	{
		...
		render_set_texture(texnormal, /*"Normal"*/ STR(2461));
		if (rotate)
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1878), color_multiply(blend, idVar(res.Value(IntType(0)), color_grass)), global::shader_blend_alpha);
			vbuffer_render({ vbuffer[e_block_depth_DEPTH0][e_block_vbuffer_GRASS] });
			render_set_uniform_color(/*"uBlendColor"*/ STR(1878), blend, global::shader_blend_alpha);
		}
		if (!vbuffer_is_empty(vbuffer[e_block_depth_DEPTH0][e_block_vbuffer_ANIMATED]))
		{
			...
			{
				render_set_texture(texanimat, /*"Material"*/ STR(2460));
				texmatprev = texanimat;
			}
			if (texaninormal != texnormalprev)
			{
				render_set_texture(texaninormal, /*"Normal"*/ STR(2461));
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1878), color_multiply(blend, idVar(res.Value(IntType(0)), color_foliage)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1878), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_oak)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1878), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_spruce)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1878), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_birch)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1878), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_jungle)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1878), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_acacia)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1878), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_dark_oak)), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1878), color_multiply(blend, idVar(res.Value(IntType(0)), color_leaves_mangrove)), global::shader_blend_alpha);
		...
		if (!vbuffer_is_empty(vbuffer[e_block_depth_DEPTH2][e_block_vbuffer_WATER]))
		{
			...
			{
				render_set_texture(texani);
				render_set_uniform_color(/*"uBlendColor"*/ STR(1878), color_multiply(blend, idVar(res.Value(IntType(0)), color_water)), global::shader_blend_alpha);
				render_set_uniform_int(/*"uIsWater"*/ STR(2465), IntType(1));
