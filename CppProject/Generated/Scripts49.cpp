...
namespace CppProject
{
	...
	void render_update_text()
	{
		...
		withAll (obj_preview, noone)
			if (instance_exists(self->select) && Obj(self->select)->subAssetId != ID_obj_resource && idVar(self->select, type) == e_temp_type_TEXT)
				render_generate_text(ScopeAny(self), { /*"AaBbCc"*/ STR(2039), idVar(self->select, text_font), idVar(self->select, text_3d) });
	...
	RealType render_world_block(VarArgs argument)
	{
		...
		render_set_uniform_int(/*"uMaterialFormat"*/ STR(2457), ObjType(obj_resource, res.Value(IntType(1)))->material_format);
		texprev = tex;
		texmatprev = texmat;
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1875), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_grass), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1875), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_foliage), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1875), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_leaves_oak), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1875), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_leaves_spruce), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1875), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_leaves_birch), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1875), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_leaves_jungle), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1875), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_leaves_acacia), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1875), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_leaves_dark_oak), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1875), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_leaves_mangrove), global::shader_blend_alpha);
		...
		if (!vbuffer_is_empty(vbuffer[e_block_depth_DEPTH2][e_block_vbuffer_WATER]))
		{
			...
			{
				render_set_texture(texani);
				render_set_uniform_color(/*"uBlendColor"*/ STR(1875), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_water), global::shader_blend_alpha);
