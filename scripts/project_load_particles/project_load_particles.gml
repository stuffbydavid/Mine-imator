...
pc_spawn_region_box_size = value_get_array(map[?"spawn_region_box_size"], pc_spawn_region_box_size)
...
pc_bounding_box_custom_start = value_get_array(map[?"bounding_box_custom_start"], pc_bounding_box_custom_start)
pc_bounding_box_custom_end = value_get_array(map[?"bounding_box_custom_end"], pc_bounding_box_custom_end)
...
for (var i = 0; i < ds_list_size(ptypeslist); i++)
{
	...
	with (new(obj_particle_type))
	{
		...
		spd = value_get_array(ptypemap[?"spd"], spd)
		spd_israndom = value_get_array(ptypemap[?"spd_israndom"], spd_israndom)
		spd_random_min = value_get_array(ptypemap[?"spd_random_min"], spd_random_min)
		spd_random_max = value_get_array(ptypemap[?"spd_random_max"], spd_random_max)
		spd_add = value_get_array(ptypemap[?"spd_add"], spd_add)
		spd_add_israndom = value_get_array(ptypemap[?"spd_add_israndom"], spd_add_israndom)
		spd_add_random_min = value_get_array(ptypemap[?"spd_add_random_min"], spd_add_random_min)
		spd_add_random_max = value_get_array(ptypemap[?"spd_add_random_max"], spd_add_random_max)
		spd_mul = value_get_array(ptypemap[?"spd_mul"], spd_mul)
		spd_mul_israndom = value_get_array(ptypemap[?"spd_mul_israndom"], spd_mul_israndom)
		spd_mul_random_min = value_get_array(ptypemap[?"spd_mul_random_min"], spd_mul_random_min)
		spd_mul_random_max = value_get_array(ptypemap[?"spd_mul_random_max"], spd_mul_random_max)
		
		rot_extend = value_get_real(ptypemap[?"rot_extend"], rot_extend)
		rot = value_get_array(ptypemap[?"rot"], rot)
		rot_israndom = value_get_array(ptypemap[?"rot_israndom"], rot_israndom)
		rot_random_min = value_get_array(ptypemap[?"rot_random_min"], rot_random_min)
		rot_random_max = value_get_array(ptypemap[?"rot_random_max"], rot_random_max)
				
		rot_spd_extend = value_get_real(ptypemap[?"rot_spd_extend"], rot_spd_extend)
		rot_spd = value_get_array(ptypemap[?"rot_spd"], rot_spd)
		rot_spd_israndom = value_get_array(ptypemap[?"rot_spd_israndom"], rot_spd_israndom)
		rot_spd_random_min = value_get_array(ptypemap[?"rot_spd_random_min"], rot_spd_random_min)
		rot_spd_random_max= value_get_array(ptypemap[?"rot_spd_random_max"], rot_spd_random_max)
		rot_spd_add = value_get_array(ptypemap[?"rot_spd_add"], rot_spd_add)
		rot_spd_add_israndom = value_get_array(ptypemap[?"rot_spd_add_israndom"], rot_spd_add_israndom)
		rot_spd_add_random_min = value_get_array(ptypemap[?"rot_spd_add_random_min"], rot_spd_add_random_min)
		rot_spd_add_random_max = value_get_array(ptypemap[?"rot_spd_add_random_max"], rot_spd_add_random_max)
		rot_spd_mul = value_get_array(ptypemap[?"rot_spd_mul"], rot_spd_mul)
		rot_spd_mul_israndom = value_get_array(ptypemap[?"rot_spd_mul_israndom"], rot_spd_mul_israndom)
		rot_spd_mul_random_min = value_get_array(ptypemap[?"rot_spd_mul_random_min"], rot_spd_mul_random_min)
		rot_spd_mul_random_max = value_get_array(ptypemap[?"rot_spd_mul_random_max"], rot_spd_mul_random_max)
		...
		color_mix_time = value_get_color(ptypemap[?"color_mix_time"], color_mix_time)
		color_mix_time_israndom = value_get_real(ptypemap[?"color_mix_time_israndom"], color_mix_time_israndom)
		color_mix_time_random_min = value_get_color(ptypemap[?"color_mix_time_random_min"], color_mix_time_random_min)
		color_mix_time_random_max = value_get_color(ptypemap[?"color_mix_time_random_max"], color_mix_time_random_max)
