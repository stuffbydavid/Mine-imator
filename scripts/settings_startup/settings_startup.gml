...
font_main = font_import(data_directory + "opensans.ttf", 12, false, false)
font_main_bold = font_import(data_directory + "opensansbold.ttf", 12, false, false)
font_main_big = font_import(data_directory + "opensansbold.ttf", 18, false, false)
