...
{
	tab_control_dragger()
	draw_dragger("frameeditorscalexyz", dx, dy, dragger_width, tl_edit.value[e_value.SCA_X], max(0.0001, tl_edit.value[e_value.SCA_X] / 50), snapval, no_limit, 1, snapval, tab.scale.tbx_x, action_tl_frame_scale_all)
	tab_next()
}
else
{
