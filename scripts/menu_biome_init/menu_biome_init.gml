...
function menu_biome_init(menu)
{
	...
	for (var b = 0; b < ds_list_size(biome_list); b++)
	{
		...
		{
			list_item_add_action(list_item_last, string(biome) + "extend", menu_item_extend, biome.variants_extend, biome, null, "left", biome.variants_extend ? "tooltiptlcollapse" : "tooltiptlexpand", spr_chevron_ani)
