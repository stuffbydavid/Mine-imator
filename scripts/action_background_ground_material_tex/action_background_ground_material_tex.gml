/// action_background_ground_material_tex(resource)
/// @arg resource

function action_background_ground_material_tex(res)
{
	var fn;
	fn = ""
	...
	else
	{
		...
		history_set_res(action_background_ground_material_tex, fn, background_ground_material_tex, res)
	}
