...
var view, mat, coord, radius, radius2D, alpha;
view = argument0
mat = argument1
radius = argument2
...
// Check mouse
if (content_mouseon && (abs(point_distance(mouse_x - content_x, mouse_y - content_y, coord[X], coord[Y]) - radius2D) < view_3d_control_width/2))
