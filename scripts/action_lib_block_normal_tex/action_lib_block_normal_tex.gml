/// action_lib_block_normal_tex(resource)
/// @arg resource

function action_lib_block_normal_tex(res)
{
	var fn;
	fn = ""
	...
	else
	{
		...
		history_set_res(action_lib_block_normal_tex, fn, temp_edit.block_normal_tex, res)
	}
