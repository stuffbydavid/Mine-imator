/// action_bench_model_normal_tex(resource)
/// @arg resource
/// @desc Sets the character skin of the workbench settings.

function action_bench_model_normal_tex(res)
{
	var fn = "";
	...
	else
	{
		...
		history_set_res(action_bench_model_normal_tex, fn, bench_settings.model_normal_tex, res)
	}
