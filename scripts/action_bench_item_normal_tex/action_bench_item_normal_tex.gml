/// action_bench_item_normal_tex(resource)
/// @arg resource

function action_bench_item_normal_tex(res)
{
	if (history_undo)
	...
	else
	{
		...
		switch (res)
		{
			case e_option.BROWSE: // Load new
			{
				...
				if (filename_ext(fn) = ".zip")
				{
					...
					popup_importitemsheet_show(fn, action_bench_item_normal_tex)
		...
		var hobj = history_set_res(action_bench_item_normal_tex, fn, bench_settings.item_normal_tex, res);
