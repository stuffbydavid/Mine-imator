...
globalvar load_queue, temp_edit, ptype_edit, tl_edit_amount, tl_edit, res_edit, axis_edit,
		  temp_creator, res_creator, save_id_seed;
...
camera_set_view_mat(cam_window, IDENTITY)
camera_set_proj_mat(cam_window, IDENTITY)
camera_set_view_mat(cam_render, IDENTITY)
camera_set_proj_mat(cam_render, IDENTITY)
