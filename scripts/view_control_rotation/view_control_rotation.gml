...
// Draw each axis
view_control_rotation_axis(view, e_view_control.ROT_X, e_value.ROT_X, c_axisred, xrot, len)
view_control_rotation_axis(view, e_view_control.ROT_Y, e_value.ROT_Y, (setting_z_is_up ? c_axisgreen : c_axisblue), yrot, len)
view_control_rotation_axis(view, e_view_control.ROT_Z, e_value.ROT_Z, (setting_z_is_up ? c_axisblue : c_axisgreen), zrot, len)
