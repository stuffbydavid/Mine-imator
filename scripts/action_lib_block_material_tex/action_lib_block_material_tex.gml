/// action_lib_block_material_tex(resource)
/// @arg resource

function action_lib_block_material_tex(res)
{
	var fn;
	fn = ""
	...
	else
	{
		...
		history_set_res(action_lib_block_material_tex, fn, temp_edit.block_material_tex, res)
	}
