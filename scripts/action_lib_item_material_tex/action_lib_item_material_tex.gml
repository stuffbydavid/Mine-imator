/// action_lib_item_material_tex(resource)
/// @arg resource

function action_lib_item_material_tex(res)
{
	var fn;
	fn = ""
	...
	else
	{
		...
		switch (res)
		{
			case e_option.BROWSE: // Load new
			{
				...
				if (filename_ext(fn) = ".zip")
				{
					...
					popup_importitemsheet_show(fn, action_lib_item_material_tex)
		...
		var hobj = history_set_res(action_lib_item_tex, fn, temp_edit.item_material_tex, res);
