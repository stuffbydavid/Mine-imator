...
draw_label(text_get("language"), dx + capwid, dy)
draw_label(text_get("translator"), dx + capwid, dy + 18 * 1)
draw_label(text_get("forversion"), dx + capwid, dy + 18 * 2)
draw_label(text_get("lastchange"), dx + capwid, dy + 18 * 3)
