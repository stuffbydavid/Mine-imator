...
capwid = text_caption_width("frameeditorposx", "frameeditorposy", "frameeditorposz")

axis_edit = X
tab_control_dragger()
draw_dragger("frameeditorposx", dx, dy, dw, tl_edit.value[XPOS], mul / tl_edit.value_inherit[XSCA], -no_limit, no_limit, 0, snapval, tab.position.tbx_x, action_tl_frame_pos, capwid)
tab_next()

axis_edit = test(setting_z_is_up, Y, Z)
tab_control_dragger()
draw_dragger("frameeditorposy", dx, dy, dw, tl_edit.value[XPOS + axis_edit], mul / tl_edit.value_inherit[XSCA + axis_edit], -no_limit, no_limit, 0, snapval, tab.position.tbx_y, action_tl_frame_pos, capwid)
tab_next()

axis_edit = test(setting_z_is_up, Z, Y)
tab_control_dragger()
draw_dragger("frameeditorposz", dx, dy, dw, tl_edit.value[XPOS + axis_edit], mul / tl_edit.value_inherit[XSCA + axis_edit], -no_limit, no_limit, 0, snapval, tab.position.tbx_z, action_tl_frame_pos, capwid)
tab_next()
