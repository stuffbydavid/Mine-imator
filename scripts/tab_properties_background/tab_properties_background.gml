...
if (background_ground_show)
{
	...
	if (background_ground_ani)
		draw_texture_slot(res.block_sheet_ani_texture[block_texture_get_frame()], background_ground_slot, dx + capwid, dy + 4, 16, 32, block_texture_get_blend(background_ground_name, res))
	else
		draw_texture_slot(res.block_sheet_texture, background_ground_slot, dx + capwid, dy + 4, 16, 32, block_texture_get_blend(background_ground_name, res))
