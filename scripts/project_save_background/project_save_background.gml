...
json_export_object_start("background")
	...
	json_export_var_save_id("image", background_image)
	...
	json_export_var_save_id("sky_sun_tex", background_sky_sun_tex)
	json_export_var_save_id("sky_moon_tex", background_sky_moon_tex)
	...
	json_export_var_save_id("sky_clouds_tex", background_sky_clouds_tex)
	...
	json_export_var_save_id("ground_tex", background_ground_tex)

	json_export_var("biome", background_biome.name)
