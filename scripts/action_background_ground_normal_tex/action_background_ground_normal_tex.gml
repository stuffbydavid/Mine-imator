/// action_background_ground_normal_tex(resource)
/// @arg resource

function action_background_ground_normal_tex(res)
{
	var fn;
	fn = ""
	...
	else
	{
		...
		history_set_res(action_background_ground_normal_tex, fn, background_ground_normal_tex, res)
	}
