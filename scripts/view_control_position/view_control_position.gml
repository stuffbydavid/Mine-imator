...
var view, len, arrowstart, arrowend, mat;
view = argument0
...
// Draw axis arrows
view_control_position_axis(view, e_view_control.POS_X, e_value.POS_X, c_axisred, point3D_mul_matrix(vec3(arrowstart, 0, 0), mat), point3D_mul_matrix(vec3(arrowend, 0, 0), mat))//, mat)
view_control_position_axis(view, e_view_control.POS_Y, e_value.POS_Y, (setting_z_is_up ? c_axisgreen : c_axisblue), point3D_mul_matrix(vec3(0, arrowstart, 0), mat), point3D_mul_matrix(vec3(0, arrowend, 0), mat))//, mat)
view_control_position_axis(view, e_view_control.POS_Z, e_value.POS_Z, (setting_z_is_up ? c_axisblue : c_axisgreen), point3D_mul_matrix(vec3(0, 0, arrowstart), mat), point3D_mul_matrix(vec3(0, 0, arrowend), mat))//, mat)
...
view_control_position_pan(view, len / 10)
view_control_position_plane(view, e_view_control.POS_XY, point3D(1, 1, 0), (setting_z_is_up ? c_axisblue : c_axisgreen), mat, vec3(0, 0, 1), point3D(ps, ps, 0), point3D(pe, ps, 0), point3D(pe, pe, 0), point3D(ps, pe, 0)) // XY
view_control_position_plane(view, e_view_control.POS_XZ, point3D(1, 0, 1), (setting_z_is_up ? c_axisgreen : c_axisblue), mat, vec3(0, 1, 0), point3D(ps, 0, ps), point3D(pe, 0, ps), point3D(pe, 0, pe), point3D(ps, 0, pe)) // XZ
view_control_position_plane(view, e_view_control.POS_YZ, point3D(0, 1, 1), c_axisred, mat, vec3(1, 0, 0), point3D(0, ps, ps), point3D(0, pe, ps), point3D(0, pe, pe), point3D(0, ps, pe)) // YZ
