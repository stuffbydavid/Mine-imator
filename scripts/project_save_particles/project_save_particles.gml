...
json_save_object_start("particles")
	...
	json_save_var("spawn_region_box_size", pc_spawn_region_box_size)

	json_save_var_bool("bounding_box_type", pc_bounding_box_type)
	json_save_var("bounding_box_ground_z", pc_bounding_box_ground_z)
	json_save_var("bounding_box_custom_start", pc_bounding_box_custom_start)
	json_save_var("bounding_box_custom_end", pc_bounding_box_custom_end)
	...
	json_save_array_start("types")
		...
		for (var t = 0; t < ds_list_size(pc_type_list); t++) 
		{
			...
			with (pc_type_list[|t])
			{
				...
				json_save_var("spd", spd)
				json_save_var("spd_israndom", spd_israndom)
				json_save_var("spd_random_min", spd_random_min)
				json_save_var("spd_random_max", spd_random_max)
				json_save_var("spd_add", spd_add)
				json_save_var("spd_add_israndom", spd_add_israndom)
				json_save_var("spd_add_random_min", spd_add_random_min)
				json_save_var("spd_add_random_max", spd_add_random_max)
				json_save_var("spd_mul", spd_mul)
				json_save_var("spd_mul_israndom", spd_mul_israndom)
				json_save_var("spd_mul_random_min", spd_mul_random_min)
				json_save_var("spd_mul_random_max", spd_mul_random_max)
			
				json_save_var_bool("rot_extend", rot_extend)
				json_save_var("rot", rot)
				json_save_var("rot_israndom", rot_israndom)
				json_save_var("rot_random_min", rot_random_min)
				json_save_var("rot_random_max", rot_random_max)
				
				json_save_var_bool("rot_spd_extend", rot_spd_extend)
				json_save_var("rot_spd", rot_spd)
				json_save_var("rot_spd_israndom", rot_spd_israndom)
				json_save_var("rot_spd_random_min", rot_spd_random_min)
				json_save_var("rot_spd_random_max", rot_spd_random_max)
				json_save_var("rot_spd_add", rot_spd_add)
				json_save_var("rot_spd_add_israndom", rot_spd_add_israndom)
				json_save_var("rot_spd_add_random_min", rot_spd_add_random_min)
				json_save_var("rot_spd_add_random_max", rot_spd_add_random_max)
				json_save_var("rot_spd_mul", rot_spd_mul)
				json_save_var("rot_spd_mul_israndom", rot_spd_mul_israndom)
				json_save_var("rot_spd_mul_random_min", rot_spd_mul_random_min)
				json_save_var("rot_spd_mul_random_max", rot_spd_mul_random_max)
