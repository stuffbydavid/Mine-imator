	...
	json_save_array_start("types")
		...
		for (var t = 0; t < ds_list_size(pc_type_list); t++) 
		{
			...
			with (pc_type_list[|t])
			{
				...
				json_save_var("angle_strength", angle_strength)
				json_save_var("angle_strength_israndom", angle_strength_israndom)
				json_save_var("angle_strength_random_min", angle_strength_random_min)
				json_save_var("angle_strength_random_max", angle_strength_random_max)
				json_save_var("angle_strength_add", angle_strength_add)
				json_save_var("angle_strength_add_israndom", angle_strength_add_israndom)
				json_save_var("angle_strength_add_random_min", angle_strength_add_random_min)
				json_save_var("angle_strength_add_random_max", angle_strength_add_random_max)
				json_save_var("angle_strength_mul", angle_strength_mul)
				json_save_var("angle_strength_mul_israndom", angle_strength_mul_israndom)
				json_save_var("angle_strength_mul_random_min", angle_strength_mul_random_min)
				json_save_var("angle_strength_mul_random_max", angle_strength_mul_random_max)
