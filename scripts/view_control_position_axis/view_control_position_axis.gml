/// view_control_position_axis(view, control, valueid, color, start, end, [fade])
/// @arg view
/// @arg control
/// @arg valueid
/// @arg color
...
var alpha = fade ? percent(abs(vec3_dot(vec3_normalize(vec3_sub(end3D, center3D)), vec3_normalize(vec3_sub(cam_from, center3D)))), .9, .8) : 1;
