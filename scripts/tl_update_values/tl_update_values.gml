...
if (value_type[e_value_type.BACKGROUND])
{
	...
	tl_update_values_ease(e_value.BG_VOLUMETRIC_RAYS, trans, p)
	tl_update_values_ease(e_value.BG_VOLUMETRIC_RAYS_SKY, trans, p)
	tl_update_values_ease(e_value.BG_VOLUMETRIC_RAYS_SCATTER, trans, p)
	tl_update_values_ease(e_value.BG_VOLUMETRIC_RAYS_DENSITY, trans, p)
	tl_update_values_ease(e_value.BG_VOLUMETRIC_RAYS_COLOR, trans, p)
	tl_update_values_ease(e_value.BG_VOLUMETRIC_RAYS_EMISSIVE, trans, p)
