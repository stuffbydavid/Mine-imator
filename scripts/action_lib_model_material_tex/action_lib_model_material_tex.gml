/// action_lib_model_material_tex(resource)
/// @arg resource
/// @desc Sets the model texture of the given library item.

function action_lib_model_material_tex(res)
{
	var fn;
	fn = ""
	...
	else
	{
		...
		history_set_res(action_lib_model_material_tex, fn, temp_edit.model_material_tex, res)
	}
	
	with (temp_edit)
	{
		if (model_material_tex != null)
