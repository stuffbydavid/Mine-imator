/// render_world_model_file_parts(modelfile, resource, texturenamemap, hidelist, shapevbuffermap)
/// @arg modelfile
/// @arg resource
/// @arg texturenamemap
/// @arg hidelist
...
var modelfile, res, texnamemap, hidelist, shapevbuffermap, mat;
modelfile = argument0
res = argument1
...
for (var p = 0; p < ds_list_size(modelfile.part_list); p++) 
{
	...
	render_world_model_part(part, res, texnamemap, shapevbuffermap)
	if (part.part_list != null && ds_list_size(part.part_list) > 0)
		render_world_model_file_parts(part, res, texnamemap, hidelist, shapevbuffermap)
}
