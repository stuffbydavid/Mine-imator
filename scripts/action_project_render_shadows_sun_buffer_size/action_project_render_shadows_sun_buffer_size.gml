...
function action_project_render_shadows_sun_buffer_size(size)
{
	...
	if (!history_undo && !history_redo)
		history_set_var(action_project_render_shadows_sun_buffer_size, project_render_shadows_sun_buffer_size, size, 1)
	
	project_render_shadows_sun_buffer_size = size
	render_samples = -1
}
