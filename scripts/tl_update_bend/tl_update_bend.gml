...
if (type != "bodypart" || value[e_value.BEND_ANGLE] = 0)
	return 0
...
// No change
if (!force && bend_angle_last = value[e_value.BEND_ANGLE] && bend_model_part_last = model_part)
	return 0
	
bend_angle_last = value[e_value.BEND_ANGLE]
...
for (var s = 0; s < ds_list_size(model_part.shape_list); s++)
	ds_list_add(bend_vbuffer_list, model_shape_bend_vbuffer(model_part.shape_list[|s], value[e_value.BEND_ANGLE], round_bending))