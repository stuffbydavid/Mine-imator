...
switch (culldir)
{
	case e_dir.EAST:
	{
		...
		if (mc_builder.block_current.type = "leaves" && mc_builder.block_face_min_depth_xp > e_block_depth.DEPTH0)
			return false
	...
	case e_dir.WEST:
	{
		...
		if (mc_builder.block_current.type = "leaves" && mc_builder.block_face_min_depth_xn > e_block_depth.DEPTH0)
			return false
	...
	case e_dir.SOUTH:
	{
		...
		if (mc_builder.block_current.type = "leaves" && mc_builder.block_face_min_depth_yp > e_block_depth.DEPTH0)
			return false
	...
	case e_dir.NORTH:
	{
		...
		if (mc_builder.block_current.type = "leaves" && mc_builder.block_face_min_depth_yn > e_block_depth.DEPTH0)
			return false
	...
	case e_dir.UP:
	{
		...
		if (mc_builder.block_current.type = "leaves" && mc_builder.block_face_min_depth_zp > e_block_depth.DEPTH0)
			return false
	...
	case e_dir.DOWN:
	{
		...
		if (mc_builder.block_current.type = "leaves" && mc_builder.block_face_min_depth_zn > e_block_depth.DEPTH0)
			return 0
