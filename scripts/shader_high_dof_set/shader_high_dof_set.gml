...
shader_set_uniform_f(uDepth, render_camera.value[e_value.CAM_DOF_DEPTH])
shader_set_uniform_f(uRange, render_camera.value[e_value.CAM_DOF_RANGE])
shader_set_uniform_f(uFadeSize, render_camera.value[e_value.CAM_DOF_FADE_SIZE])
