...
/// CppSeparate IntType surface_create_ext(IntType, IntType, BoolType, BoolType)
/// Creates a new surface with additional settings to toggle the depth buffer and HDR color modes (floating points).
function surface_create_ext(width, height, depth = true, hdr = false)
{
}
...
/// CppSeparate void builder_add_face(Scope<obj_builder_thread>, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, IntType, VarType)
...
/// CppSeparate void builder_add_triangle(Scope<obj_builder_thread>, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, RealType, IntType, VarType)
function builder_add_triangle()
{
	...
	*/
	...
	vbuffer_add_triangle(
		...
		argument[15], 1, false, argument[16]
	)
}
