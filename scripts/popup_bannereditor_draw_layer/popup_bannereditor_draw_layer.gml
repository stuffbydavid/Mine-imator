...
function popup_bannereditor_draw_layer(xx, yy, width, height, index, base)
{
	...
	draw_sprite_ext(popup_bannereditor.pattern_sprites[array_length(popup_bannereditor.pattern_sprites) - 1], 0, xx + 4, yy + 4, (1 / popup_bannereditor.res_ratio), (1 / popup_bannereditor.res_ratio), 0, c_white, 1)
