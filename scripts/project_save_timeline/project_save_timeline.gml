...
json_export_object_start()
	...
	json_export_var_obj("temp", temp)
	json_export_var("text", string_escape(text))
	...
	if (type = "bodypart")
	{
		...
		json_export_var_obj("part_of", part_of)
	}
	...
	json_export_var_bool("inherit_position", inherit_position)
	json_export_var_bool("inherit_rotation", inherit_rotation)
	json_export_var_bool("inherit_scale", inherit_scale)
	json_export_var_bool("inherit_alpha", inherit_alpha)
	json_export_var_bool("inherit_color", inherit_color)
	json_export_var_bool("inherit_texture", inherit_texture)
	json_export_var_bool("inherit_visibility", inherit_visibility)
