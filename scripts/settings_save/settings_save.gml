...
json_save_object_start("checkbox_expand")
	...
	json_save_var_bool("settings_indirect", checkbox_expand_settings_indirect)
	...
	json_save_var_bool("background_volumetric_rays", checkbox_expand_background_volumetric_rays)
