...
function settings_save()
{
	...
	json_save_object_start("program")
		...
		json_save_var_bool("debug_features", setting_debug_features)
	...
	json_save_object_start("interface")
		...
		json_save_var_bool("view_main_boxes", view_main.boxes)
		json_save_var_bool("view_main_cascades", view_main.cascades)
		...
		json_save_var_bool("view_second_boxes", view_second.boxes)
		json_save_var_bool("view_second_cascades", view_second.cascades)
