...
else
{
	...
	if (action_tl_select_single(null, e_tl_type.BACKGROUND))
	{
		...
		tl_value_set(e_value.BG_LEAVES_DARK_OAK_COLOR, col, false)
		tl_value_set_done()
		return 0
	}
	history_set_var(action_background_leaves_dark_oak_color, background_leaves_dark_oak_color, col, true)
}

background_leaves_dark_oak_color = col
