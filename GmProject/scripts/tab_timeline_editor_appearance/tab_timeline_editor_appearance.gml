...
function tab_timeline_editor_appearance()
{
	...
	// Enchantment glint
	tab_control_switch()
	draw_button_collapse("tl_glint", collapse_map[?"tl_glint"], action_tl_glint_enabled, tl_edit.glint_enabled, "timelineeditorglint")
	tab_next()
	
	if (tl_edit.glint_enabled && collapse_map[?"tl_glint"])
	{
		tab_collapse_start()
