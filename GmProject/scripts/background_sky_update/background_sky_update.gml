...
function background_sky_update()
{
	if (!background_fog_color_custom) // Fog color
	{
		...
		if (!background_image_show)
		{
			...
			background_fog_color_final = merge_color(background_fog_color_final, c_fog_bright, (1 - background_night_alpha) * 0.470588)
			background_fog_color_final = merge_color(background_fog_color_final, c_fog_night, background_night_alpha)
