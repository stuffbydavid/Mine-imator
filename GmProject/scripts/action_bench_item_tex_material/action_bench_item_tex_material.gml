/// action_bench_item_tex_material(resource)
/// @arg resource

function action_bench_item_tex_material(res)
{
	if (history_undo)
	...
	else
	{
		...
		var hobj = history_set_res(action_bench_item_tex_material, fn, bench_settings.item_tex_material, res);
