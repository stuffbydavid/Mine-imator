...
function render_preset_load_settings(map)
{
	...
	if (ds_map_valid(realisticmap))
	{
		...
		set.cache_light_buffers = value_get_real(realisticmap[?"cache_light_buffers"], false)
		set.cache_data_buffers = value_get_real(realisticmap[?"cache_data_buffers"], false)
		...
		set.shadows_single_sample = value_get_real(realisticmap[?"shadows_single_sample"], false)
