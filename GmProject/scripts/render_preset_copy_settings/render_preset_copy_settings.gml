/// render_preset_copy_settings(obj, all)

function render_preset_copy_settings(obj, all = false)
{
	if (obj.has_standard || all)
	{
	...
	if (obj.has_realistic || all)
	{
		has_realistic = obj.has_realistic
