/// render_preset_copy_settings(obj, renderer)

function render_preset_copy_settings(obj, renderer)
{
	if (renderer == e_renderer.STANDARD && obj.has_standard)
	{
		has_standard = true
	...
	if (renderer == e_renderer.REALISTIC && obj.has_realistic)
	{
		has_realistic = true
