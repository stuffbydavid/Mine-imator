...
function shader_high_reflections_resolve_set(surf)
{
	...
	render_set_uniform_vec2("uRayDataSize", surface_get_width(render_surface_reflections_raydata), surface_get_height(render_surface_reflections_raydata))
	...
	render_set_uniform_int("uSampleAmount", app.project_render_reflections_resolution < 1 ? array_length(render_raytrace_kernel) / 2 : 1)
