...
function interface_update_instant()
{
	...
	c_info = theme.toast_color[e_toast.INFO]
	c_success = theme.toast_color[e_toast.POSITIVE]
	c_warning = theme.toast_color[e_toast.WARNING]
	c_error = theme.toast_color[e_toast.NEGATIVE]
