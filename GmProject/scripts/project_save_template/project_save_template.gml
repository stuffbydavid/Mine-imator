	...
	json_save_object_start()
		...
		else if (type = e_temp_type.TEXT)
		{
			json_save_object_start("text")
				...
				json_save_var_bool("aa", text_aa)
				json_save_var_bool("outline", text_outline)
				json_save_var_color("outline_color", text_outline_color)
				json_save_var("outline_size", text_outline_size)
				json_save_var("halign", text_halign)
				json_save_var("valign", text_valign)
			json_save_object_done()
		}
