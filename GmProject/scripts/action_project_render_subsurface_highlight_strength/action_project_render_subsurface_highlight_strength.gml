...
function action_project_render_subsurface_highlight_strength(val, add)
{
	if (!history_undo && !history_redo)
		history_set_var(action_project_render_subsurface_highlight_strength, project_render_subsurface_highlight_strength, project_render_subsurface_highlight_strength * add + val / 100, true)
	else
		val *= 100
