...
function settings_save()
{
	...
	json_save_object_start("interface")
		...
		json_save_var("transform_mode", setting_transform_mode)
	...
	json_save_object_start("export")
		...
		json_save_var("exportmovie_renderer", popup_exportmovie.renderer)
		...
		json_save_var("exportimage_renderer", popup_exportimage.renderer)
