...
function settings_load()
{
	...
	if (ds_map_valid(exportmap))
	{
		...
		setting_export_movie_renderer = value_get_real(map[?"exportmovie_renderer"], setting_export_movie_renderer)
		...
		setting_export_image_renderer = value_get_real(map[?"exportimage_renderer"], setting_export_image_renderer)
