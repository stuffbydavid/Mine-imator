...
function settings_load()
{
	...
	{
		setting_export_movie_format = value_get_string(exportmap[?"exportmovie_format"], setting_export_movie_format)
		setting_export_movie_frame_rate = value_get_real(exportmap[?"exportmovie_frame_rate"], setting_export_movie_frame_rate)
		setting_export_movie_framespersecond = value_get_real(exportmap[?"exportmovie_framespersecond"], setting_export_movie_framespersecond)
		setting_export_movie_renderer = value_get_real(exportmap[?"exportmovie_renderer"], setting_export_movie_renderer)
		setting_export_movie_include_audio = value_get_real(exportmap[?"exportmovie_include_audio"], setting_export_movie_include_audio)
		setting_export_movie_remove_background = value_get_real(exportmap[?"exportmovie_remove_background"], setting_export_movie_remove_background)
		setting_export_movie_include_hidden = value_get_real(exportmap[?"exportmovie_include_hidden"], setting_export_movie_include_hidden)
		setting_export_movie_watermark = value_get_real(exportmap[?"exportmovie_watermark"], setting_export_movie_watermark)
		setting_export_image_remove_background = value_get_real(exportmap[?"exportimage_remove_background"], setting_export_image_remove_background)
		setting_export_image_include_hidden = value_get_real(exportmap[?"exportimage_include_hidden"], setting_export_image_include_hidden)
		setting_export_image_renderer = value_get_real(exportmap[?"exportimage_renderer"], setting_export_image_renderer)
		setting_export_image_watermark = value_get_real(exportmap[?"exportimage_watermark"], setting_export_image_watermark)
	}
