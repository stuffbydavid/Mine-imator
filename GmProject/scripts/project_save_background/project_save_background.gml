...
function project_save_background()
{
	json_save_object_start("background")
		...
		json_save_var("sky_clouds_offset_y", background_sky_clouds_offset_y)
		json_save_var("sky_clouds_offset_z", background_sky_clouds_offset_z)
		json_save_var("sky_clouds_size_xy", background_sky_clouds_size_xy)
		json_save_var("sky_clouds_size_z", background_sky_clouds_size_z)
