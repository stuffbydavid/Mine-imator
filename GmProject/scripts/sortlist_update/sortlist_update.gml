...
function sortlist_update(slist)
{
	...
	var modellist = (slist = bench_settings.char_list || slist = bench_settings.special_block_list || slist = bench_settings.armor_list || slist = bench_settings.bodypart_model_list ||
					slist = template_editor.char_list || slist = template_editor.armor_list || slist = template_editor.special_block_list || slist = template_editor.bodypart_model_list);
