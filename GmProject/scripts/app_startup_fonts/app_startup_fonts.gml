...
function app_startup_fonts()
{
	...
	font_credits = font_add(fonts_directory + "noto_regular.ttf", 8, false, false, 32, 1024)
	
	// Special-case fonts
	font_upgrade = font_add(fonts_directory + "noto_regular.ttf", 18, false, false, 32, 1024)
	font_value_bold = font_add(fonts_directory + "noto_bold.ttf", 9, false, false, 32, 1024)
	...
	font_label_big = font_add(fonts_directory + "rubik_medium.ttf", 13, false, false, 32, 1024)
}
