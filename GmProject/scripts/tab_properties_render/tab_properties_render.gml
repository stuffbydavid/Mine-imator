...
function tab_properties_render()
{
	...
	tab_control_switch()
	draw_button_collapse("preset_special_effects", collapse_map[?"preset_special_effects"], null, true, "renderspecialeffects")
	tab_next()
	...
	tab_control_switch()
	draw_button_collapse("preset_graphics", collapse_map[?"preset_graphics"], null, true, "rendergraphics")
	tab_next()
	
	if (collapse_map[?"preset_graphics"])
	{
		tab_collapse_start()
	...
	tab_control_switch()
	draw_button_collapse("preset_materials", collapse_map[?"preset_materials"], null, true, "rendermaterials")
	tab_next()
	
	if (collapse_map[?"preset_materials"])
	{
		tab_collapse_start()
