...
function shader_high_dof_set(blurbuffer)
{
	...
	render_generate_dof_samples(render_camera.value[e_value.CAM_BLADE_AMOUNT], render_camera.value[e_value.CAM_BLADE_ANGLE], render_camera.value[e_value.CAM_DOF_BLUR_RATIO], render_camera.value[e_value.CAM_DOF_BLADE_CURVATURE], render_camera.value[e_value.CAM_BLADE_STRETCH])
	...
	render_set_uniform("uBladeCurvature", render_camera.value[e_value.CAM_DOF_BLADE_CURVATURE])
