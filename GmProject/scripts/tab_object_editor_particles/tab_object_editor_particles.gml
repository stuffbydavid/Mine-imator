...
function tab_object_editor_particles()
{
	...
	togglebutton_add("particleeditorspawnconstant", null, 1, obj_edit.pc_spawn_constant, action_lib_pc_spawn_constant)
	togglebutton_add("particleeditorspawnburst", null, 0, !obj_edit.pc_spawn_constant, action_lib_pc_spawn_constant)
	...
	tab_control_dragger()
	draw_dragger("particleeditorspawnamount", dx, dy, 64, obj_edit.pc_spawn_amount, obj_edit.pc_spawn_constant ? 2 : 0.2, 1, no_limit, 100, 1, tab.tbx_spawn_amount, action_lib_pc_spawn_amount, string_width(text_get("particleeditorspawnamount")) + 8)
	...
	// Spawn region
	tab_control_switch()
	draw_switch("particleeditorspawnregion", dx, dy, obj_edit.pc_spawn_region_use, action_lib_pc_spawn_region_use)
	tab_next()
	...
	if (obj_edit.pc_spawn_region_use)
	{
		...
		tab_control_menu()
		draw_button_menu("particleeditorspawnregiontype", e_menu.LIST, dx, dy, dw, 24, obj_edit.pc_spawn_region_type, text_get("particleeditorspawnregiontype" + obj_edit.pc_spawn_region_type), action_lib_pc_spawn_region_type, false, null, icon)
		tab_next()
		...
		switch (obj_edit.pc_spawn_region_type)
		{
			...
			{
				tab_control_dragger()
				draw_dragger("particleeditorspawnregionsphereradius", dx, dy, 64, obj_edit.pc_spawn_region_sphere_radius, obj_edit.pc_spawn_region_sphere_radius / 100, 0, no_limit, 100, 0, tab.tbx_spawn_region_sphere_radius, action_lib_pc_spawn_region_sphere_radius)
				tab_next()
			...
			{
				tab_control_dragger()
				draw_dragger("particleeditorspawnregioncubesize", dx, dy, 64, obj_edit.pc_spawn_region_cube_size, obj_edit.pc_spawn_region_cube_size / 100, 0, no_limit, 100, 0, tab.tbx_spawn_region_cube_size, action_lib_pc_spawn_region_cube_size)
				tab_next()
			...
			{	
				axis_edit = X
				textfield_group_add("particleeditorspawnregionboxxsize", obj_edit.pc_spawn_region_box_size[axis_edit], 200, action_lib_pc_spawn_region_box_size, axis_edit, tab.tbx_spawn_region_box_xsize, null, obj_edit.pc_spawn_region_box_size[axis_edit] / 100)
				axis_edit = sn
				textfield_group_add("particleeditorspawnregionboxysize", obj_edit.pc_spawn_region_box_size[axis_edit], 200, action_lib_pc_spawn_region_box_size, axis_edit, tab.tbx_spawn_region_box_ysize, null, obj_edit.pc_spawn_region_box_size[axis_edit] / 100)
				axis_edit = ud
				textfield_group_add("particleeditorspawnregionboxzsize", obj_edit.pc_spawn_region_box_size[axis_edit], 200, action_lib_pc_spawn_region_box_size, axis_edit, tab.tbx_spawn_region_box_zsize, null, obj_edit.pc_spawn_region_box_size[axis_edit] / 100)
			...
			case "path":
			{
				...
				tab_control_dragger()
				draw_dragger("particleeditorspawnregionpathradius", dx, dy, 64, obj_edit.pc_spawn_region_path_radius, obj_edit.pc_spawn_region_path_radius / 100, 0, no_limit, 100, 0, tab.tbx_spawn_region_path_radius, action_lib_pc_spawn_region_path_radius)
				tab_next()
	...
	// Bounding box
	tab_control_menu()
	draw_button_menu("particleeditorboundingbox", e_menu.LIST, dx, dy, dw, 24, obj_edit.pc_bounding_box_type, text_get("particleeditorboundingboxtype" + obj_edit.pc_bounding_box_type), action_lib_pc_bounding_box_type)
	tab_next()
	
	if (obj_edit.pc_bounding_box_type = "ground")
	{
		tab_control_dragger()
		draw_dragger("particleeditorboundingboxground" + (setting_z_is_up ? "z" : "y"), dx, dy, 64, obj_edit.pc_bounding_box_ground_z, 0.1, -no_limit, no_limit, 0, 0, tab.tbx_bounding_box_ground_z, action_lib_pc_bounding_box_ground_z)
		tab_next()
	}
	else if (obj_edit.pc_bounding_box_type = "custom")
	{
		// "From" position
		axis_edit = X
		textfield_group_add("particleeditorboundingboxfromx", obj_edit.pc_bounding_box_custom_start[axis_edit], -100, action_lib_pc_bounding_box_custom_start, axis_edit, tab.tbx_bounding_box_custom_xstart, null, 1, -no_limit, obj_edit.pc_bounding_box_custom_end[axis_edit])
		axis_edit = sn
		textfield_group_add("particleeditorboundingboxfromy", obj_edit.pc_bounding_box_custom_start[axis_edit], -100, action_lib_pc_bounding_box_custom_start, axis_edit, tab.tbx_bounding_box_custom_ystart, null, 1, -no_limit, obj_edit.pc_bounding_box_custom_end[axis_edit])
		axis_edit = ud
		textfield_group_add("particleeditorboundingboxfromz", obj_edit.pc_bounding_box_custom_start[axis_edit], -100, action_lib_pc_bounding_box_custom_start, axis_edit, tab.tbx_bounding_box_custom_zstart, null, 1, -no_limit, obj_edit.pc_bounding_box_custom_end[axis_edit])
		...
		// "To" position
		axis_edit = X
		textfield_group_add("particleeditorboundingboxtox", obj_edit.pc_bounding_box_custom_end[axis_edit], 100, action_lib_pc_bounding_box_custom_end, axis_edit, tab.tbx_bounding_box_custom_xend, null, 1, obj_edit.pc_bounding_box_custom_start[axis_edit], no_limit)
		axis_edit = sn
		textfield_group_add("particleeditorboundingboxtoy", obj_edit.pc_bounding_box_custom_end[axis_edit], 100, action_lib_pc_bounding_box_custom_end, axis_edit, tab.tbx_bounding_box_custom_yend, null, 1, obj_edit.pc_bounding_box_custom_start[axis_edit], no_limit)
		axis_edit = ud
		textfield_group_add("particleeditorboundingboxtoz", obj_edit.pc_bounding_box_custom_end[axis_edit], 100, action_lib_pc_bounding_box_custom_end, axis_edit, tab.tbx_bounding_box_custom_zend, null, 1, obj_edit.pc_bounding_box_custom_start[axis_edit], no_limit)
		...
		tab_control_switch()
		draw_switch("particleeditorboundingboxrelative", dx, dy, obj_edit.pc_bounding_box_relative, action_lib_pc_bounding_box_relative)
		tab_next()
	}
	...
	draw_checkbox("particleeditordestroyanimationfinish", dx, dy, obj_edit.pc_destroy_at_animation_finish, action_lib_pc_destroy_at_animation_finish)
	tab_next(false)
	
	// Destroy at bounding box
	tab_control_checkbox()
	draw_checkbox("particleeditordestroyboundingboxtoggle", dx, dy, obj_edit.pc_destroy_at_bounding_box, action_lib_pc_destroy_at_bounding_box)
	tab_next(false)
	
	// Destroy at amount
	tab_control_checkbox()
	draw_checkbox("particleeditordestroyamount", dx, dy, obj_edit.pc_destroy_at_amount, action_lib_pc_destroy_at_amount)
	...
	draw_dragger("particleeditordestroyamountval", dx + wid, dy, 64, obj_edit.pc_destroy_at_amount_val, 0.25, 0, no_limit, 200, 1, tab.tbx_destroy_at_amount_val, action_lib_pc_destroy_at_amount_val, wid, false)
	
	tab_next(wid = 0)
	
	// Destroy at a time
	tab_control_checkbox()
	draw_checkbox("particleeditordestroytime", dx, dy, obj_edit.pc_destroy_at_time, action_lib_pc_destroy_at_time)
	...
	{
		tab_control_meter()
		draw_meter("particleeditortypespawnrate", dx, dy, dw, ptype_edit.spawn_rate * 100, 0, 100, 100 / ds_list_size(obj_edit.pc_type_list), 1, tab.tbx_type_spawn_rate, action_lib_pc_type_spawn_rate)
		tab_next()
	}
